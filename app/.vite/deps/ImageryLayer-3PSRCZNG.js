...
function T(e4, t8) {
  ...
  const c23 = "arithmetic" === e4.rotationType ? 1 : 2, f12 = "flow-from" === e4.flowRepresentation ? 0 : 1, p25 = e4.visualVariables ? e4.visualVariables.find((e5) => "Magnitude" === e5.field) : new b4(), g5 = { magnitudeBandID: s11, directionBandID: u7, isUVComponents: i13, referenceSystem: c23, massFlowAngleRepresentation: f12, symbolTileSize: 50, symbolTileSizeUnits: 100, calculationMethod: "Vector Average", symbologyName: m4[e4.style.toLowerCase().replace("-", "_")], minimumMagnitude: p25.minDataValue, maximumMagnitude: p25.maxDataValue, minimumSymbolSize: p25.minSize, maximumSymbolSize: p25.maxSize };
...
function S4(e4, t8) {
  ...
  const l15 = R2[n3.toJSON(e4.stretchType)], c23 = "u8", m14 = (_a = e4.customStatistics) == null ? void 0 : _a.map((e5) => [e5.min, e5.max, e5.avg ?? 0, e5.stddev ?? 1]), f12 = { StretchType: l15, Statistics: m14, DRA: e4.dynamicRangeAdjustment, UseGamma: e4.useGamma, Gamma: e4.gamma, ComputeGamma: e4.computeGamma };
...
function x2(e4, n12) {
  const r4 = c7.has(n12) ? s7(n12) : null;
...
r([m({ type: j, json: { read: true } })], i4.prototype, "fromGeometry", void 0), r([m({ type: j, json: { read: true, write: true } })], i4.prototype, "toGeometry", void 0), r([m({ json: { write: true } })], i4.prototype, "objectIds", void 0), r([m({ type: String, json: { write: true } })], i4.prototype, "where", void 0), r([m({ type: Number, json: { write: true } })], i4.prototype, "maxCount", void 0), i4 = r([a3("esri.rest.support.FindImagesParameters")], i4);
var m5 = i4;
...
r([m({ json: { write: true } })], n6.prototype, "id", void 0), r([m({ json: { name: "uri", write: true } })], n6.prototype, "referenceUri", void 0), r([m({ type: Date, json: { write: true } })], n6.prototype, "acquisitionDate", void 0), r([r2("acquisitionDate")], n6.prototype, "writeAcquisitionDate", null), r([m({ json: { write: true } })], n6.prototype, "cameraID", void 0), r([m({ type: j, json: { write: true } })], n6.prototype, "center", void 0), r([m({ type: j, json: { write: true } })], n6.prototype, "perspectiveCenter", void 0), r([m({ json: { write: true } })], n6.prototype, "orientation", void 0), n6 = r([a3("esri.rest.support.ImageInspectionInfo")], n6);
var c8 = n6;
...
r([m({ type: [c8], json: { write: true } })], p9.prototype, "images", void 0), p9 = r([a3("esri.rest.support.FindImagesResult")], p9);
var c9 = p9;
...
r([m({ type: [String], json: { name: "angleName", write: true } })], l7.prototype, "angleNames", void 0), r([m({ type: j, json: { write: true } })], l7.prototype, "point", void 0), r([m({ type: g, json: { write: true } })], l7.prototype, "spatialReference", void 0), r([m({ type: x, json: { write: true } })], l7.prototype, "rasterId", void 0), l7 = n7 = r([a3("esri.rest.support.ImageAngleParameters")], l7);
var m6 = l7;
...
r([m({ type: Number, json: { write: true } })], p10.prototype, "north", void 0), r([m({ type: Number, json: { write: true } })], p10.prototype, "up", void 0), r([m({ type: g, json: { write: true } })], p10.prototype, "spatialReference", void 0), p10 = r([a3("esri.rest.support.ImageAngleResult")], p10);
var i5 = p10;
...
r([m({ type: Number, json: { read: true, write: true } })], p11.prototype, "value", void 0), r([m({ type: String, json: { read: true, write: true } })], p11.prototype, "displayValue", void 0), r([m({ type: Number, json: { read: true, write: true } })], p11.prototype, "uncertainty", void 0), p11 = r([a3("esri.rest.support.imageMeasureUtils.BaseImageMeasureResultValue")], p11);
var d8 = class extends p11 {
  constructor() {
    super(...arguments), this.unit = null;
  }
};
r([m({ type: String, json: { read: Ue.read, write: Ue.write } })], d8.prototype, "unit", void 0), d8 = r([a3("esri.rest.support.imageMeasureUtils.ImageMeasureResultLengthValue")], d8);
var l8 = class extends p11 {
  constructor() {
    super(...arguments), this.unit = null;
  }
};
r([m({ type: String, json: { read: de.read, write: de.write } })], l8.prototype, "unit", void 0), l8 = r([a3("esri.rest.support.imageMeasureUtils.ImageMeasureResultAreaValue")], l8);
var c10 = class extends p11 {
  constructor() {
    super(...arguments), this.unit = null;
  }
};
r([m({ type: String, json: { read: Be.read, write: Be.write } })], c10.prototype, "unit", void 0), c10 = r([a3("esri.rest.support.imageMeasureUtils.ImageMeasureResultAngleValue")], c10);
...
r([m({ type: String, json: { read: true, write: true } })], t6.prototype, "name", void 0), r([m({ type: String, json: { read: true, write: true } })], t6.prototype, "sensorName", void 0), t6 = r([a3("esri.rest.support.BaseImageMeasureResult")], t6);
var p12 = t6;
...
r([m({ type: l8, json: { read: true, write: true } })], a9.prototype, "area", void 0), r([m({ type: d8, json: { read: true, write: true } })], a9.prototype, "perimeter", void 0), a9 = r([a3("esri.rest.support.ImageAreaResult")], a9);
var i6 = a9;
...
r([m({ type: g, json: { name: "outSR", write: true } })], a10.prototype, "outSpatialReference", void 0), a10 = r([a3("esri.rest.support.ImageBoundaryParameters")], a10);
var c12 = a10;
...
r([m({ type: Number, json: { write: true } })], c13.prototype, "area", void 0), r([m({ types: l, json: { name: "shape", write: true } })], c13.prototype, "geometry", void 0), r([o2("geometry")], c13.prototype, "readGeometry", null), c13 = r([a3("esri.rest.support.ImageBoundaryResult")], c13);
var i7 = c13;
...
r([m({ type: d8, json: { read: true, write: true } })], a11.prototype, "distance", void 0), r([m({ type: c10, json: { read: true, write: true } })], a11.prototype, "azimuthAngle", void 0), r([m({ type: c10, json: { read: true, write: true } })], a11.prototype, "elevationAngle", void 0), a11 = r([a3("esri.rest.support.ImageDistanceResult")], a11);
var p13 = a11;
...
r([m({ types: l, json: { read: f, write: true } })], j5.prototype, "geometry", void 0), r([r2("geometry")], j5.prototype, "writeGeometry", null), r([m({ json: { write: true } })], j5.prototype, "objectIds", void 0), r([r3(s3, { ignoreUnknown: false, name: "spatialRel" })], j5.prototype, "spatialRelationship", void 0), r([m({ type: p, json: { name: "time", write: true } })], j5.prototype, "timeExtent", void 0), r([m({ type: String, json: { write: true } })], j5.prototype, "where", void 0), j5 = r([a3("esri.rest.support.ImageGPSInfoParameters")], j5);
var y6 = j5;
...
r([m({ json: { write: true } })], p14.prototype, "id", void 0), p14 = r([a3("esri.rest.support.CameraInfo")], p14);
var c15 = p14;
...
r([m({ type: [n8], json: { write: true } })], m8.prototype, "images", void 0), r([m({ type: [c15], json: { write: true } })], m8.prototype, "cameras", void 0), m8 = r([a3("esri.rest.support.ImageGPSInfoResult")], m8);
var a12 = m8;
...
r([m({ type: j, json: { read: true } })], l9.prototype, "fromGeometry", void 0), r([r2("fromGeometry")], l9.prototype, "writeFromGeometry", null), r([m({ type: j, json: { read: true, write: true } })], l9.prototype, "toGeometry", void 0), r([m({ type: u2.apiValues, json: { write: u2.write } })], l9.prototype, "measureOperation", null), r([m({ json: { read: true } })], l9.prototype, "operationType", void 0), r([m({ type: String, json: { read: Ue.read, write: Ue.write } })], l9.prototype, "linearUnit", void 0), l9 = y7 = r([a3("esri.rest.support.ImageHeightParameters")], l9);
var c16 = l9;
...
r([m({ type: d8, json: { read: true, write: true } })], p16.prototype, "height", void 0), p16 = r([a3("esri.rest.support.ImageHeightResult")], p16);
var a13 = p16;
...
r([m({ types: l, json: { write: true } })], y8.prototype, "geometry", void 0), r([r2("geometry")], y8.prototype, "writeGeometry", null), r([m({ type: f6, json: { write: true } })], y8.prototype, "mosaicRule", null), r([r2("mosaicRule")], y8.prototype, "writeMosaicRule", null), r([m({ type: w2, json: { write: true, name: "renderingRule" } })], y8.prototype, "rasterFunction", null), r([r2("rasterFunction")], y8.prototype, "writeRasterFunction", null), r([m({ type: [w2], json: { write: true, name: "renderingRules" } })], y8.prototype, "rasterFunctions", void 0), r([r2("rasterFunctions")], y8.prototype, "writeRasterFunctions", null), r([m({ type: j, json: { write: true } })], y8.prototype, "pixelSize", void 0), r([r2("pixelSize")], y8.prototype, "writePixelSize", null), r([m({ type: Boolean, json: { write: true } })], y8.prototype, "returnGeometry", void 0), r([m({ type: Boolean, json: { write: true } })], y8.prototype, "returnCatalogItems", void 0), r([m({ type: Boolean, json: { write: true } })], y8.prototype, "returnPixelValues", void 0), r([m({ type: Number, json: { write: true } })], y8.prototype, "maxItemCount", void 0), r([m({ type: p, json: { write: { target: "time" } } })], y8.prototype, "timeExtent", void 0), r([r2("timeExtent")], y8.prototype, "writeTimeExtent", null), r([m({ json: { write: true } })], y8.prototype, "raster", void 0), r([m({ json: { write: true } })], y8.prototype, "viewId", void 0), r([m({ type: Boolean, json: { write: true } })], y8.prototype, "processAsMultidimensional", void 0), y8 = c17 = r([a3("esri.rest.support.ImageIdentifyParameters")], y8);
var d9 = y8;
...
r([m({ json: { write: true } })], p17.prototype, "catalogItemVisibilities", void 0), r([m({ type: d3, json: { write: true } })], p17.prototype, "catalogItems", void 0), r([m({ type: j, json: { write: true } })], p17.prototype, "location", void 0), r([m({ json: { write: true } })], p17.prototype, "name", void 0), r([m({ json: { write: true } })], p17.prototype, "objectId", void 0), r([m({ json: { write: true } })], p17.prototype, "processedValues", void 0), r([m({ json: { write: true } })], p17.prototype, "properties", void 0), r([m({ json: { write: true } })], p17.prototype, "value", void 0), p17 = r([a3("esri.rest.support.ImageIdentifyResult")], p17);
var l10 = p17;
...
r([m({ type: [j], json: { write: true } })], c18.prototype, "geometries", void 0), r([r2("geometries")], c18.prototype, "writeGeometry", null), r([m({ type: x, json: { write: true } })], c18.prototype, "rasterId", void 0), c18 = m9 = r([a3("esri.rest.support.ImagePixelLocationParameters")], c18);
var a14 = c18;
...
r([m({ json: { write: true } })], t7.prototype, "geometries", void 0), t7 = r([a3("esri.rest.support.ImagePixelLocationResult")], t7);
var p18 = t7;
...
r([m({ types: l, json: { name: "fromGeometry", read: f } })], u5.prototype, "geometry", void 0), r([r2("geometry")], u5.prototype, "writeGeometry", null), r([m({ type: u2.apiValues, json: { read: u2.read, write: u2.write } })], u5.prototype, "measureOperation", null), r([m({ json: { read: true } })], u5.prototype, "is3D", void 0), u5 = c19 = r([a3("esri.rest.support.ImagePointParameters")], u5);
var l11 = u5;
...
r([m({ type: j, json: { name: "point.value", read: true, write: true } })], p19.prototype, "point", void 0), p19 = r([a3("esri.rest.support.ImagePointResult")], p19);
var a15 = p19;
...
r([m({ types: l, json: { read: f } })], h4.prototype, "geometry", void 0), r([r2("geometry")], h4.prototype, "writeGeometry", null), r([m({ type: [j] })], h4.prototype, "locations", null), r([m({ type: String, json: { type: a6.jsonValues, read: a6.read, write: a6.write } })], h4.prototype, "interpolation", void 0), r([m({ type: f6, json: { write: true } })], h4.prototype, "mosaicRule", void 0), r([m({ type: [String], json: { write: true } })], h4.prototype, "outFields", void 0), r([m({ type: j, json: { write: true } })], h4.prototype, "pixelSize", void 0), r([m({ type: String, json: { write: true } })], h4.prototype, "raster", void 0), r([m({ type: Boolean, json: { write: true } })], h4.prototype, "returnFirstValueOnly", void 0), r([m({ type: Number, json: { write: true } })], h4.prototype, "sampleDistance", void 0), r([m({ type: Number, json: { write: true } })], h4.prototype, "sampleCount", void 0), r([m({ type: Number, json: { write: true } })], h4.prototype, "sliceId", void 0), r([m({ type: p, json: { read: { source: "time" }, write: { target: "time" } } })], h4.prototype, "timeExtent", void 0), h4 = d10 = r([a3("esri.rest.support.ImageSampleParameters")], h4);
var j6 = h4;
...
r([m({ json: { write: true } })], i8.prototype, "attributes", void 0), r([m({ type: j, json: { write: true } })], i8.prototype, "location", void 0), r([m({ json: { write: true } })], i8.prototype, "locationId", void 0), r([m({ json: { write: true } })], i8.prototype, "rasterId", void 0), r([m({ json: { write: true } })], i8.prototype, "resolution", void 0), r([m({ json: { write: true } })], i8.prototype, "pixelValue", void 0), i8 = r([a3("esri.rest.support.ImageSample")], i8);
var p20 = i8;
...
r([m({ type: [p20], json: { write: true } })], p21.prototype, "samples", void 0), p21 = r([a3("esri.rest.support.ImageSampleResult")], p21);
var m10 = p21;
...
r([m({ types: [l] })], l12.prototype, "geometries", void 0), r([r2("geometries")], l12.prototype, "writeGeometries", null), r([m({ type: [x], json: { write: true } })], l12.prototype, "rasterIds", void 0), r([m({ type: g, json: { name: "outSR", write: true } })], l12.prototype, "outSpatialReference", void 0), l12 = r([a3("esri.rest.support.ImageToMapMultirayParameters")], l12);
var n9 = l12;
...
r([m({ types: l, json: { read: f, write: true } })], c20.prototype, "geometry", void 0), r([r2("geometry")], c20.prototype, "writeGeometry", null), r([m({ json: { write: true } })], c20.prototype, "rasterId", void 0), r([m({ type: g, json: { name: "outSR", write: true } })], c20.prototype, "outSpatialReference", void 0), r([m({ json: { name: "options.DOff", write: true } })], c20.prototype, "depthOffset", void 0), r([m({ json: { name: "options.Adjust", write: true } })], c20.prototype, "adjust", void 0), c20 = r([a3("esri.rest.support.ImageToMapParameters")], c20);
var l13 = c20;
...
r([m({ type: String, json: { name: "uri", write: true } })], p22.prototype, "referenceUri", void 0), r([m({ type: Number, json: { write: true } })], p22.prototype, "rasterId", void 0), p22 = r([a3("esri.rest.support.ImageUrlParameters")], p22);
var i9 = p22;
...
r([m({ json: { write: true } })], s10.prototype, "area", void 0), r([m({ json: { write: true } })], s10.prototype, "cut", void 0), r([m({ json: { write: true } })], s10.prototype, "fill", void 0), r([m({ json: { name: "maxz", write: true } })], s10.prototype, "maxZ", void 0), r([m({ json: { name: "minz", write: true } })], s10.prototype, "minZ", void 0), r([m({ json: { name: "meanz", write: true } })], s10.prototype, "meanZ", void 0), r([m({ json: { write: true } })], s10.prototype, "cutCellCount", void 0), r([m({ json: { write: true } })], s10.prototype, "fillCellCount", void 0), s10 = r([a3("esri.rest.support.ImageVolume")], s10);
var i10 = s10;
...
r([m({ type: [i10], json: { write: true } })], p24.prototype, "volumes", void 0), p24 = r([a3("esri.rest.support.ImageVolumeResult")], p24);
var m11 = p24;
...
r([m({ types: l, json: { read: f, write: true } })], a16.prototype, "geometry", void 0), r([r2("geometry")], a16.prototype, "writeGeometry", null), r([m({ json: { write: true } })], a16.prototype, "rasterId", void 0), r([m({ json: { name: "options.VisibleOnly", write: true } })], a16.prototype, "visibleOnly", void 0), a16 = r([a3("esri.rest.support.MapToImageParameters")], a16);
var c21 = a16;
...
r([m({ types: l, json: { name: "fromGeometry", read: f, write: true } })], y10.prototype, "geometry", void 0), r([r2("geometry")], y10.prototype, "writeGeometry", null), r([m({ json: { write: true } })], y10.prototype, "rasterId", void 0), y10 = c22 = r([a3("esri.rest.support.MeasureFromImageParameters")], y10);
var n10 = y10;
...
r([m({ types: l, json: { name: "Shape", read: f, write: true } })], m13.prototype, "geometry", void 0), r([m({ json: { name: "Length", write: true } })], m13.prototype, "length", void 0), m13 = r([a3("esri.rest.support.MeasureLengthFromImageResult")], m13);
var i12 = m13;
...
async function n11(n12, m14, p25) {
  ...
  const S5 = w.fromJSON(y11.extent), j7 = Math.ceil(S5.width / y11.pixelSizeX - 0.1), w4 = Math.ceil(S5.height / y11.pixelSizeY - 0.1), b7 = S5.spatialReference, k3 = new j({ x: y11.pixelSizeX, y: y11.pixelSizeY, spatialReference: b7 }), z2 = ((_b = y11.histograms) == null ? void 0 : _b.length) ? y11.histograms : null, L2 = new n5({ origin: y11.origin, blockWidth: y11.blockWidth, blockHeight: y11.blockHeight, firstPyramidLevel: y11.firstPyramidLevel, maximumPyramidLevel: y11.maxPyramidLevel });
  return new d5({ width: j7, height: w4, bandCount: y11.bandCount, extent: S5, spatialReference: b7, pixelSize: k3, pixelType: y11.pixelType.toLowerCase(), statistics: P3, histograms: z2, keyProperties: v5, storageInfo: L2 });
}
...
var ze = (c23) => {
  let m14 = class extends c23 {
    ...
    writeMosaicRule(e4, t8, i13) {
      ...
      r4 ? s11 && s11 !== r4.where && (r4 = r4.clone(), r4.where = s11) : s11 && (r4 = new f6({ where: s11 })), this._isValidCustomizedMosaicRule(r4) && (t8[i13] = r4.toJSON());
    }
    ...
    get rasterFields() {
      ...
      if (this._isVectorDataSet()) {
        const i14 = (_d = (_c = t8 == null ? void 0 : t8.multidimensionalInfo) == null ? void 0 : _c.variables[0].unit) == null ? void 0 : _d.trim(), r4 = d4(i14), s11 = $();
        e4.push(r4, s11);
      }
    ...
    fetchRasterAttributeTable(e4) {
      return this.version < 10.1 ? Promise.reject(new s("#fetchRasterAttributeTable()", "Failed to get rasterAttributeTable")) : P(ze2(this.parsedUrl) + "/rasterAttributeTable", { query: this._getQueryParams({ renderingRule: this.version >= 10.3 ? e4 == null ? void 0 : e4.rasterFunction : null }) }).then((e5) => d3.fromJSON(e5.data));
    }
    ...
    async getCatalogItemICSInfo(e4, t8) {
      ...
      const a17 = this.version >= 10.7 ? P(ze2(this.parsedUrl) + "/" + e4 + "/info/icstopixel", { query: this._getQueryParams(), ...t8 }).then((e5) => e5.data).catch(() => ({})) : {}, o5 = n12.spatialReference, l15 = { geometries: JSON.stringify({ geometryType: "esriGeometryEnvelope", geometries: [n12] }), inSR: c(o5), outSR: "0:" + e4 }, u7 = P(ze2(this.parsedUrl) + "/project", { query: this._getQueryParams(l15), ...t8 }).then((e5) => e5.data).catch(() => ({})), p25 = 5, c24 = (n12.xmin + n12.xmax) / 2, m15 = (n12.ymax - n12.ymin) / (p25 + 1), h5 = n12.ymin + m15, d11 = [];
      for (let i13 = 0; i13 < p25; i13++) d11.push({ x: c24, y: h5 + m15 * i13 });
      const f12 = { geometries: JSON.stringify({ geometryType: "esriGeometryPoint", geometries: d11 }), inSR: c(o5), outSR: "0:" + e4 }, g5 = P(ze2(this.parsedUrl) + "/project", { query: this._getQueryParams(f12), ...t8 }).then((e5) => e5.data).catch(() => ({})), w4 = await Promise.all([a17, u7, g5]);
      let I2 = w4[0].ipxf;
      if (null == I2) {
        const e5 = (_a = s11.geodataXform) == null ? void 0 : _a.xf_0;
        "topup" === ((_b = e5 == null ? void 0 : e5.name) == null ? void 0 : _b.toLowerCase()) && 6 === ((_c = e5 == null ? void 0 : e5.coefficients) == null ? void 0 : _c.length) && (I2 = { affine: { name: "ics [sensor: Frame] to pixel (column, row) transformation", coefficients: e5.coefficients, cellsizeRatio: 0, type: "GeometricXform" } });
      }
      const v5 = w.fromJSON((_e = (_d = w4[1]) == null ? void 0 : _d.geometries) == null ? void 0 : _e[0]);
      v5 && (v5.spatialReference = new g({ wkid: 0, imageCoordinateSystem: s11 }));
      const S5 = w4[2].geometries ? w4[2].geometries.filter((e5) => null != (e5 == null ? void 0 : e5.x) && null != e5.y && "NaN" !== e5.x && "NaN" !== e5.y) : [], _4 = S5.length;
      if (_4 < 3) return { ics: s11, icsToPixelTransform: I2, icsExtent: v5, northDirection: null };
      ...
      return O === 1 / 0 ? C3 = N2 ? 90 : 270 : 0 === O ? C3 = M ? 0 : 180 : O > 0 ? C3 = M ? 180 * Math.atan(O) / Math.PI : 180 * Math.atan(O) / Math.PI + 180 : O < 0 && (C3 = N2 ? 180 + 180 * Math.atan(O) / Math.PI : 360 + 180 * Math.atan(O) / Math.PI), { ics: s11, icsToPixelTransform: I2, icsExtent: v5, northDirection: C3 };
    }
    ...
    getExportImageServiceParameters(e4, t8, i13, r4) {
      ...
      if (null != r4) {
        ...
        e5 && t9 && e5 === t9 ? h5.time = "" + e5 : null == e5 && null == t9 || (h5.time = `${e5 ?? "null"},${t9 ?? "null"}`);
      }
      return { bbox: e4.xmin + "," + e4.ymin + "," + e4.xmax + "," + e4.ymax, bboxSR: s11, imageSR: s11, size: t8 + "," + i13, ...n12, ...h5 };
    }
    ...
    async queryObjectIds(e4, t8) {
      return { query: e4, requestOptions: t8 } = await this._prepareForQuery(e4, t8), s5(this.url, e4, t8);
    }
    ...
    async queryRasterCount(e4, t8) {
      return { query: e4, requestOptions: t8 } = await this._prepareForQuery(e4, t8), s4(this.url, e4, t8);
    }
    async queryVisibleRasters(e4, t8) {
      ...
      const m15 = null == e4.outSpatialReference || e4.outSpatialReference.equals(this.spatialReference), { multidimensionalSubset: h5 } = this;
      let d11 = e4.timeExtent || this.timeExtent;
      if (h5) {
        const { isOutside: t9, intersection: i14 } = m3(h5, { geometry: e4.geometry, timeExtent: e4.timeExtent, multidimensionalDefinition: (_a = this.exportImageServiceParameters.mosaicRule) == null ? void 0 : _a.multidimensionalDefinition });
        ...
        null != (i14 == null ? void 0 : i14.timeExtent) && (d11 = i14.timeExtent);
      }
      const f12 = this._combineMosaicRuleWithTimeExtent(this.exportImageServiceParameters.mosaicRule, d11);
      let y11 = e4.geometry;
      this.version < 10.91 && "extent" === (y11 == null ? void 0 : y11.type) && (y11 = j2.fromExtent(y11));
      const R3 = this._getQueryParams({ geometry: y11, timeExtent: d11, mosaicRule: f12, rasterFunction: this.version < 10.4 ? this.rasterFunction : null, rasterFunctions: l15, pixelSize: i13, returnCatalogItems: o5, returnGeometry: m15, raster: this.raster, maxItemCount: n12 ? 1 : null });
      delete R3.f;
      const b7 = new d9(R3);
      try {
        await this._generateRasterInfo(this.rasterFunction);
        const i14 = await W(this.url, b7, { signal: t8 == null ? void 0 : t8.signal, query: { ...this.customParameters } }), r4 = e4.outFields, n13 = null != i14.value && i14.value.toLowerCase().includes("nodata"), l16 = o5 && !m15 && ((_b = i14 == null ? void 0 : i14.catalogItems) == null ? void 0 : _b.features.length) && (a17 || !n13), p26 = this.multidimensionalInfo && "raster-dataset" === this.sourceType ? f8({ rasterInfo: this.rasterInfo, multidimensionalDefinition: f12 == null ? void 0 : f12.multidimensionalDefinition, timeExtent: d11, multidimensionalSubset: this.multidimensionalSubset }) : null;
        ...
        const c25 = this.objectIdField || "ObjectId", h6 = ((_c = i14.catalogItems) == null ? void 0 : _c.features) ?? [], y12 = h6.map((e5) => {
          var _a2;
          return (_a2 = e5.attributes) == null ? void 0 : _a2[c25];
        }), g5 = new b3({ objectIds: y12, returnGeometry: true, outSpatialReference: e4.outSpatialReference, outFields: [c25] }), R4 = await this.queryRasters(g5);
    ...
    async createFlowMesh(e4, t8) {
      ...
      return i13 ? i13.createFlowMesh(e4, t8) : s8(e4.meshType, e4.simulationSettings, e4.flowData, null != t8.signal ? t8.signal : new AbortController().signal);
    }
    ...
    async _prepareForQuery(e4, t8) {
      ...
      return e4 = null != e4 ? h(b3, e4) : this.createQuery(), t8 = this._getRequestOptions(t8), this.raster && (t8.query = { ...t8.query, raster: this.raster }), { query: e4, requestOptions: t8 };
    }
    ...
    _configRenderer(e4) {
      ...
      if (!t8 && !this.pixelFilter || this._isVectorDataSet()) {
        ...
        e4 || (e4 = (r4 == null ? void 0 : r4.renderer) ?? q2(i13, { bandIds: this.bandIds, variableName: this.rasterFunction ? null : t9 }));
    ...
    async _requestArrayBuffer(e4) {
      ...
      const m15 = { signal: a17 }, h5 = "gif" === p25 || "bmp" === p25 || p25.includes("png") && ("png" === c24 || "jpg" === c24) ? j4(u7, { useCanvas: true, ...t8 }, m15) : this._decodePixelBlock(u7, { width: t8.width, height: t8.height, planes: null, pixelType: null, noDataValue: null, format: p25 }, m15);
      return { pixelData: { pixelBlock: await h5, extent: t8.extent }, params: t8 };
    }
    ...
    _processVisibleRastersResponse(e4, i13) {
      ...
      const c24 = this.objectIdField || "ObjectId", m15 = "string" == typeof r4 && r4.toLowerCase().includes("nodata"), h5 = [];
      if (r4 && !u7 && !m15) {
        const e5 = {};
        e5[c24] = 0;
        p25 = [r4], u7 = [new b2({ geometry: this.fullExtent, attributes: e5 })], this.multidimensionalInfo && "raster-dataset" === this.sourceType && V(this.rasterFields, e5, i13.effectiveMultidimensionalDefinition);
      }
      if (!u7) return [];
      this._updateResponseFieldNames(u7, o5), m15 && !n12 && (u7 = []);
      const { itemPixelValue: d11, servicePixelValue: f12 } = t4, y11 = this.rasterFields.some((e5) => e5.name === d11);
      for (let t8 = 0; t8 < u7.length; t8++) {
        ...
        if (null != r4) {
          ...
          y11 && (e5.attributes[d11] = i14), e5.attributes[f12] = a18, this._updateFeatureWithMagDirValues(e5, i14);
    ...
    _updateFeatureWithMagDirValues(e4, t8) {
      ...
      const a17 = "esriImageServiceDataTypeVector-MagDir" === this.serviceDataType ? [n12.pixels[0][0], n12.pixels[1][0]] : l5([n12.pixels[0][0], n12.pixels[1][0]]);
...
var _3 = class extends p2(l4(t(b(j3(o4(ze(f4(e(l3(S2(a5.ClonableMixin(f3)))))))))))) {
  constructor(...e4) {
    super(...e4), this.isReference = null, this.operationalLayerType = "ArcGISImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.type = "imagery", this._debouncedSaveOperations = k(async (e5, r4, t8) => {
      const { save: o5, saveAs: s11 } = await import("./imageryUtils-3VRB2QCB.js");
      switch (e5) {
        case A.SAVE:
          return o5(this, r4);
        case A.SAVE_AS:
  ...
  createPopupTemplate(e4) {
    ...
    return (p25 == null ? void 0 : p25.fieldInfos) && n12 && b5(p25.fieldInfos, n12), p25;
  }
  queryFeatures(e4, r4) {
...
r([m(d2)], _3.prototype, "legendEnabled", null), r([m({ type: ["show", "hide"] })], _3.prototype, "listMode", null), r([m({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], _3.prototype, "isReference", void 0), r([m({ type: ["ArcGISImageServiceLayer"], json: { origins: { "web-map": { type: ["ArcGISImageServiceLayer", "ArcGISImageServiceVectorLayer"], read: false, write: { target: "layerType", ignoreOrigin: true } } } } })], _3.prototype, "operationalLayerType", void 0), r([r2("web-map", "operationalLayerType")], _3.prototype, "writeOperationalLayerType", null), r([m(l2)], _3.prototype, "popupEnabled", void 0), r([m({ type: q, json: { read: { source: "popupInfo" }, write: { target: "popupInfo" } } })], _3.prototype, "popupTemplate", void 0), r([m({ readOnly: true })], _3.prototype, "defaultPopupTemplate", null), r([m({ readOnly: true, json: { read: false } })], _3.prototype, "type", void 0), r([m({ readOnly: true })], _3.prototype, "_isPreviewLayer", null), _3 = r([a3("esri.layers.ImageryLayer")], _3);
var C2 = _3;
export {
  C2 as default
};
//# sourceMappingURL=ImageryLayer-3PSRCZNG.js.map
