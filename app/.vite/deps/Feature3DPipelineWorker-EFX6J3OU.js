...
var m7 = class extends u5 {
  ...
  initializeRenderContext(e9, r6) {
    this._glMaterials = new t6(this.material, e9.materials), this._vaoCache = e9.renderContext.rctx.getVaoCache(this.material.vertexAttributeLocations, t5(this._bufferWriter.vertexBufferLayout));
  }
...
var l4 = class {
  ...
  async doLoad(e9, s11, n11) {
    has("enable-feature:objectAndLayerId-rendering") && this._optionalFields.push(e5.OBJECTANDLAYERIDCOLOR);
...
function R2(e9, r6) {
  const t9 = { anchorPosition: s8.center, occlusionTest: true, hasSlicePlane: false, color: [1, 0, 0, 1], outlineColor: [0, 0, 0, 1], outlineSize: 1, distanceFieldBoundingBox: c3 }, s11 = null;
  if (null != e9) {
...
function v(e9, r6, t9) {
  const s11 = { usePBR: r6.physicalBasedRenderingEnabled, isSchematic: true, mrrFactors: o6, ambient: s5, diffuse: s5, hasSlicePlane: r6.slicePlaneEnabled, castShadows: r6.castShadows, offsetTransparentBackfaces: !r6.isPrimitive };
...
function b5(e9) {
  ...
  return e9.transparent = t9, e9.opacity = r6, e9.cullFace = t9 ? e4.None : e4.Back, e9;
}
...
var o7 = class {
  ...
  createLodRenderer(r6) {
    const t9 = this._context.generateId("lod-renderer"), s11 = { levels: r6.levels.map((r7) => ({ components: r7.components.map((r8) => {
      const t10 = r8.attributes.get(e5.POSITION);
      if (!t10 || 0 === t10.indices.length) throw new Error("positions attribute expected");
      const s12 = 3, o9 = o4(t10.indices.length / s12), d4 = new o5(o9, s12, t10), i8 = this._context.getRenderGeometryBufferWriter(r8.materialId);
...
function a11(e9) {
  const t9 = e9, n11 = t9.get(e5.POSITION).data, r6 = t9.get(e5.NORMAL).data;
  if (r6) {
    const t10 = o8(e9, e5.NORMAL).data;
  ...
  if (n11) {
    const t10 = o8(e9, e5.POSITION).data;
...
var f6 = class {
  ...
  async createAddCommand(t9) {
    ...
    if (0 === r6) return e9;
    const i8 = true, n11 = u3(c2(this._primitive)), c7 = u4(b2(n11)), p4 = u4(t2(c7, { isPrimitive: i8, width: 100, depth: null, height: null })), f7 = new Float64Array(16 * r6), u12 = new Float64Array(16 * r6), g5 = a10(t9, this._context);
...
var i7 = class {
  ...
  async createAddCommand(i8) {
    ...
    const C = new t4(m8, f7, 3, true), I = new t4(h7, x2, 3, true), b6 = new t4(y, x2, 2, true), g5 = new t4(w3, x2, 4, true), p4 = new t4(_3, x2, 1, true), E2 = new t4(u12, x2, 2, true), F = new t4(A2, x2, 4, true), O2 = [[e5.POSITION, C], [e5.NORMAL, I], [e5.UV0, b6], [e5.COLOR, g5], [e5.ROTATION, p4], [e5.SIZE, E2], [e5.CENTEROFFSETANDDISTANCE, F]], R3 = { attributes: e8(O2), objectAndLayerIdColor: void 0, transformation: e3(), materialId: this.materialId };
...
//# sourceMappingURL=Feature3DPipelineWorker-EFX6J3OU.js.map
