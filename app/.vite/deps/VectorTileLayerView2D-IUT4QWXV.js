...
var n3 = class {
  ...
  bind(t8, e9, n8, o6 = 0) {
    if (!this._textures[n8]) {
      const e10 = new p2();
      e10.pixelFormat = G.ALPHA, e10.wrapMode = D.CLAMP_TO_EDGE, e10.width = this.width, e10.height = this.height, this._textures[n8] = new w(t8, e10, new Uint8Array(this.width * this.height));
    }
...
var o3 = class _o {
  ...
  bind(t8, i9, s7 = 0, r13 = 0) {
    ...
    if (!this._textures[s7]) {
      const i10 = new p2();
      i10.wrapMode = D.CLAMP_TO_EDGE, i10.width = this._size[s7][0], i10.height = this._size[s7][1], this._textures[s7] = new w(t8, i10, new Uint8Array(this._mosaicsData[s7].buffer));
    }
...
var p5 = class {
  ...
  _requestSprite(t8) {
    ...
    this._spriteSourcePromise = this._layer.loadSpriteSource(this.devicePixelRatio, o6), this._spriteSourcePromise.then((t9) => {
      a3(i9), this._spriteMosaic = new o3(1024, 1024, 250), this._spriteMosaic.setSpriteSource(t9);
    });
  }
...
function c3(t8, s7, o6, i9) {
  ...
  let r13, n8, c7, a9;
  for (const h7 of l6) {
    if (t8.unique.show && t8.unique.parts[h7.partIndex].show && (r13 = h7.xScreen - i9[0] + h7.dxScreen, n8 = h7.yScreen - i9[1] + h7.dyScreen, c7 = r13 + h7.width, a9 = n8 + h7.height, w2(o6, s7.x, s7.y, r13, n8, c7, a9))) return true;
  }
  return false;
}
...
//# sourceMappingURL=VectorTileLayerView2D-IUT4QWXV.js.map
