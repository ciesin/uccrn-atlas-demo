...
import "./chunk-OMCJ6PCE.js";
import "./chunk-HDT7YPJI.js";
import {
  Jt
} from "./chunk-OJ5IBYG7.js";
import {
  t as t6
...
import {
  $
} from "./chunk-57VINKNP.js";
import "./chunk-YG5V2HGZ.js";
import "./chunk-WPOAQZKK.js";
...
var g4 = class {
  constructor(e13, s20, i19, r17, n14 = 0) {
    this.tileKey = e13, this._bufferingEnabled = s20, this._sizeHint = n14, this._meshes = { self: new n5(this.id, this._sizeHint), neighbors: new Array() }, this._currentRecordOverlaps = 0, this._currentEntityOverlaps = 0;
    const h8 = r17 ? 1 : 0;
  ...
  serialize(s20) {
    ...
    return t20.message.push({ tileId: this.tileKey.id, ...i19.message }), t20.transferList.push(...i19.transferList), this._meshes.neighbors.forEach((i20, r17) => {
      const n14 = i20.serialize(), h8 = 1 << r17, o13 = f3(h8), c10 = u8(h8), a16 = new e5(this.tileKey).getNormalizedNeighbor(o13, c10, s20);
      t20.message.push({ tileId: a16.id, ...n14.message }), t20.transferList.push(...n14.transferList);
    }), t20;
  }
  _addOverlap(e13, t20, i19, r17) {
    const n14 = Math.min(a7 / 2, i19), h8 = Math.min(a7 / 2, r17), o13 = 255 ^ ((e13 < 0 + n14 ? _3 : e13 >= a7 - n14 ? d5 : _3 | d5) | (t20 < 0 + h8 ? p4 : t20 >= a7 - h8 ? m3 : p4 | m3));
    ...
    for (let e13 = 0; e13 < 8; e13++) {
      ...
      if (!!(this._currentRecordOverlaps & i19)) {
        if (this._copyBufferedDataIntoSelf) {
          const e14 = -f3(i19) * a7, t20 = -u8(i19) * a7;
          if (0 !== t20) continue;
        ...
        if (!this._meshes.neighbors[e13]) {
          ...
          this._meshes.neighbors[e13] = new n5(i19, s20);
        }
        const r17 = this._meshes.neighbors[e13], n14 = -f3(i19) * a7, h8 = -u8(i19) * a7;
...
var i11 = class extends e9 {
  constructor(r17, t20, s20, n14, i19) {
    ...
    for (const e13 of n14) n4(this._arcadeDependencies, e13.computed);
  }
  ...
  async *_update(e13, t20) {
    ...
    for (const c10 of i19.values()) {
      ...
      if (e14) e14.attributes = c10.getAttributes();
        ...
        e14 = new s5(t21, c10.getAttributes(), null, c10.id), t21 || (e14.centroid = c10.getGeometricCentroid(this.spatialReference, d11)), e14.displayId = this._attributeStore.createDisplayIdForObjectId(`${e14.objectId}.${u13}`), o13.set(c10.id, e14);
      }
      l10.push(e14);
    }
  ...
  _insertFeature(e13, r17, o13, s20) {
    ...
    if ("esriGeometryPoint" === e13.geometryType) n14 = e13.readXWorldSpace(), c10 = e13.readYWorldSpace();
      ...
      if (s20) {
        ...
        if (o14 < 0 || o14 > a7 || s21 < 0 || s21 > a7) return;
      }
...
var S2 = class {
  ...
  *aggregatesWorldSpace() {
    for (const e13 of this._clusters.values()) {
      const s20 = e13.inner.getCentroid(null), i19 = new s5(s20, e13.inner.getAttributes(), null, e13.inner.id, e13.displayId);
      yield i19;
    }
  }
  clusters() {
  ...
  createAggregateFeatures(e13, i19) {
    ...
    for (const o13 of this._clusters.values()) {
      ...
      if (null != u13) if (1 === u13) {
        const n15 = new e([], [e14, i20]), l11 = new s5(n15, o13.inner.getAttributes(), null, c10, h8);
        l11.geometry.coords[0] -= a7, a16.push(l11);
        const d12 = new e([], [e14, i20]), u14 = new s5(d12, o13.inner.getAttributes(), null, c10, h8);
        u14.geometry.coords[0] += a7, a16.push(u14);
      } else e14 > a7 + a7 / 2 ? e14 -= u13 * a7 : e14 < -256 && (e14 += u13 * a7);
      if (e14 < a7 + m4 && e14 >= -128 && i20 < a7 + m4 && i20 >= -128) {
        const r17 = new e([], [e14, i20]), n15 = new s5(r17, o13.inner.getAttributes(), null, c10, h8);
        a16.push(n15);
      }
    }
...
function A(o13, n14, s20, c10) {
  if (c10.isWebMercator) {
    const r17 = M(o13 / t4.radius), c11 = r17 - 360 * Math.floor((r17 + 180) / 360), i19 = [0, 0];
    return z2(i19, 0, M(Math.PI / 2 - 2 * Math.atan(Math.exp(-n14 / t4.radius))), c11, s20), i19;
  }
...
var d6 = class _d extends M2 {
  ...
  setTransformForDisplay(r17) {
    ...
    if (null == t20) return void (this._displayTransform = u4(r17));
    const s20 = u4(t20), a16 = u4(r17), [i19, d11] = s20.scale, [n14, o13] = s20.translate, [h8, u13] = a16.scale, [_5, l10] = a16.translate, y7 = i19 / h8, c10 = d11 / u13, p8 = (n14 - _5) / h8, m11 = (o13 - l10) / u13;
  ...
  readCentroidForDisplay() {
    ...
    if (r17) {
      ...
      this._displayTransform ? (r17.coords[0] = i4(this._displayTransform, e13), r17.coords[1] = a3(this._displayTransform, a16)) : (r17.coords[0] = e13, r17.coords[1] = a16);
    }
    return r17;
  }
  get geometryType() {
  ...
  *previousObservations() {
  ...
  commitObservations(t20, e13) {
    ...
    if (null != l10) {
      ...
      const o14 = new s5(a17.readGeometryWorldSpace(), { ...a17.readAttributes(), [r5]: s8.LatestObservation }, null, r18, i20);
  ...
  getLatestObservationFeatureForTile(t20) {
    ...
    if (!R(o13, a2(0, 0, a7, a7))) return null;
    return new s5(a16, i19, null, e13, s20);
  }
  getTrackLineFeatureForTile(t20) {
    ...
    return new s5(e13, this._trackLineAttributes, null, this.objectId, this.displayId);
  }
...
var q = class _q extends i11 {
  static async create(t20, e13, s20, a16, o13, n14) {
    ...
    return e13.isWrappable || s6() || await Promise.all([import("./apiConverter-FWDHR6ZO.js"), import("./jsonConverter-YDNMYFIF.js"), i5()]).then(([t21, e14, s21]) => {
...
function E(t20, e13, s20) {
  ...
  if (s20.isWrappable) {
    ...
    if (r18) {
      const r19 = a6({ paths: [e13], spatialReference: s20 });
  ...
  if (null != i19) {
    const e14 = u6(r17, 1e6, i19, e2.geodesic);
    if (null != e14) {
...
r([m()], o7.prototype, "_strategy", void 0), o7 = r([a("esri.views.2d.layers.features.sources.StreamMessenger")], o7);
...
function f4(r17) {
  try {
    const e13 = 2, t20 = new a5(new Uint8Array(r17), new DataView(r17));
    for (; t20.next(); ) {
...
var x4 = class _x extends M2 {
  ...
  _readAttributeAtIndex(e13) {
    ...
    if (t20 || (t20 = new a8(this.getSize()), this._parseCaches[e13] = t20), t20.has(this._featureIndex)) return t20.get(this._featureIndex);
...
var f5 = class extends c9 {
  async executeQuery(t20, s20) {
    ...
    if (null != t20.quantizationParameters && !u13.supportsQuantization) {
      const u14 = t20.clone(), c11 = s3(u14.quantizationParameters);
      u14.quantizationParameters = null;
      const { data: m11 } = await c4(i19, u14, this._metadata.spatialReference, s20), p8 = ft(m11, this._metadata.objectIdField);
      return ht(c11, p8), u7.fromOptimizedFeatureSet(p8, this._metadata);
    }
    const { data: c10 } = await c4(i19, t20, this._metadata.spatialReference, s20);
...
var y5 = class extends c9 {
  async executeQuery(t20, r17) {
    if (t20.quantizationParameters && !this.service.queryMetadata.supportsQuantization) {
      const i20 = t20.clone(), o13 = s3(i20.quantizationParameters);
...
var l8 = class {
  constructor(e13, o13) {
    this.subscription = e13, this._tileIdToResult = /* @__PURE__ */ new Map(), this._controller = new AbortController(), this._handles = t2([m2(e13.signal, () => this._controller.abort()), m2(o13, () => this._controller.abort())]);
  }
  destroy() {
...
var l9 = class {
  constructor(e13, s20) {
    this.subscription = e13, this._pages = /* @__PURE__ */ new Set(), this._controller = new AbortController(), this._done = false, this._handles = t2([m2(e13.signal, () => this._controller.abort()), m2(s20, () => this._controller.abort())]);
  }
  destroy() {
    this._controller.abort(), this._handles.remove();
  }
...
var d10 = class {
  ...
  add(s20) {
    ...
    if (!this._trackIdToObservations.has(r17)) {
      const s21 = null != ((_a = this._purgeOptions) == null ? void 0 : _a.maxObservations) ? this._purgeOptions.maxObservations : o11, i20 = r3(s21, 0, o11);
  ...
  checkForUpdates() {
    ...
    if (null != t20) {
      ...
      for (const e14 of t20) o14.has(e14.objectId) || (e14.attributes[e4] = s20, e14.attributes[i6] = d11, this.store.add(e14), n14.push(e14));
    }
  ...
  _purgeByAgeReceived(t20, e13) {
    ...
    this.store.forEach((t21) => {
      t21.attributes[e4] < s20 && this._removed.push(t21.objectId);
    });
  }
  _purgeTracks() {
...
var m9 = class extends r15 {
  ...
  connect() {
    ...
    this._connection = r6(this._service.source, s20, this._streamOptions.outSR, e13, a16, r17, n14, o13, c10), this._handlesGroup = t2([this._connection.on("data-received", (e14) => this._onFeature(e14)), this._connection.on("message-received", (e14) => this._onWebSocketMessage(e14))]), this._connectionState.connection = this._connection;
  }
  clear() {
...
var o12 = class {
  constructor(s20) {
    this._metadata = s20, this._chunks = /* @__PURE__ */ new Map(), this._chunksToRemove = [], this._overrides = new a11(), this.events = new i3(), this.featureAdapter = new r8();
  }
  destroy() {
    this.clear();
  }
...
var v = class {
  ...
  async update(e13, t20) {
    ...
    if (!n14) return false;
    if (has("esri-2d-update-debug") && console.debug(`Version[${t20}] FeatureSource.update`, { changes: n14 }), this._schema = s20, (_b = this._queryEngine) == null ? void 0 : _b.destroy(), this._queryEngine = null, "feature-service" === this.service.type && null != this.service.queryMetadata.lastEditDate && (this._lastEditDate = this.service.queryMetadata.lastEditDate), null == this._streamMessenger && "stream" === this._schema.type && this._initStreamMessenger(), a4(n14, "sourceRefreshVersion") && ((_c = this._strategy) == null ? void 0 : _c.refresh)) return await this._strategy.refresh(), true;
    if (("feature" === s20.type || "parquet" === s20.type) && a4(n14, "availableFields")) {
  ...
  async normalizeOverrides(e13) {
    const t20 = { historicMoment: e13.historicMoment, commands: { updateWeak: e13.commands.updateWeak.map(s5.fromJSON), removeWeak: e13.commands.removeWeak, update: e13.commands.update.map(s5.fromJSON), remove: e13.commands.remove, release: e13.commands.release } }, s20 = e13.commands.updateByIdWeak, r17 = await this._queryOptimizedFeatures(s20);
...
var y6 = class {
  ...
  async queryHeatmapStatistics(e13) {
    const t20 = Math.round(u3(e13.radius));
    let s20 = Number.POSITIVE_INFINITY, i19 = Number.NEGATIVE_INFINITY;
    const r17 = "string" == typeof e13.fieldOffset, o13 = e13.fieldOffset ?? 0, n14 = Array.from(this._subscriptions.values()), u13 = this._source.chunks(), d11 = t20 ** 2, c10 = 3 / (Math.PI * d11), h8 = 2 * t20, l10 = Math.ceil(a7 / h8);
...
//# sourceMappingURL=FeaturePipelineWorker-OJV4AYZ4.js.map
