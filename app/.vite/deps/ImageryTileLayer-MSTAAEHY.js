...
import {
  ...
  u as u2,
  u2 as u3
} from "./chunk-X3CD4QSJ.js";
import "./chunk-C5H6RRX5.js";
import {
  T as T3,
  w as w3
} from "./chunk-I34S26RP.js";
import "./chunk-LHHFTRIL.js";
import {
  c as c2,
  f as f3,
  o as o2
...
var f5 = class extends X {
  ...
  async _open(t5) {
    ...
    const v4 = new d5({ width: h6, height: d9, pixelType: f6, extent: g5, nativeExtent: c6, attributeTable: i3, transform: p8, pixelSize: y5, spatialReference: g5.spatialReference, bandCount: u7.pixels.length, keyProperties: b4, multidimensionalInfo: e3.multidimensionalInfo, statistics: r6, isPseudoSpatialReference: x2, histograms: l4 });
  ...
  async _buildMDimStats(t5, e3, s3) {
    for (let i3 = 0; i3 < e3.variables.length; i3++) {
      ...
      }), a4 = N(o5, e3), n7 = null == a4 ? null : t5[a4];
      if (null == n7) continue;
...
r([m({ type: String, json: { write: true } })], f5.prototype, "datasetFormat", void 0), r([m()], f5.prototype, "source", void 0), r([m()], f5.prototype, "url", null), f5 = r([a("esri.layers.support.rasterDatasets.InMemoryRaster")], f5);
var g3 = f5;
...
var m4 = class extends X {
  ...
  async _open(e3) {
    const { extent: t5, pixelBlocks: r6, multidimensionalInfo: s3, attributeTable: a4, bandNames: o5 } = await this._fetchData(e3), { statistics: i3, histograms: n7 } = m2(r6[0]), m6 = o5 == null ? void 0 : o5.map((e4) => ({ BandName: e4 })), h6 = { DataType: a4 ? "Thematic" : s3 ? "Scientific" : "Generic", BandProperties: m6 }, d9 = new g3({ source: { extent: t5, pixelBlocks: r6, attributeTable: a4 ? d3.fromJSON(a4) : null, multidimensionalInfo: s3, statistics: i3, histograms: n7, keyProperties: h6, isPseudoSpatialReference: false } });
...
r([m({ type: String, json: { write: true } })], m4.prototype, "datasetFormat", void 0), r([m({ constructOnly: true })], m4.prototype, "source", void 0), m4 = r([a("esri.layers.support.rasterDatasets.CovJSONRaster")], m4);
var h4 = m4;
...
var h5 = class extends X {
  ...
  async _open(t5) {
    ...
    const l4 = !e3;
    l4 && (e3 = new g({ wkid: 3857 })), (a4 == null ? void 0 : a4.length) && null == r6 && (r6 = p5(a4));
...
r([m({ type: String, json: { write: true } })], h5.prototype, "datasetFormat", void 0), h5 = r([a("esri.layers.support.rasterDatasets.ImageAuxRaster")], h5);
var d8 = h5;
...
var g4 = class extends X {
  ...
  async fetchRawTile(e3, t5, i3, s3 = {}) {
    ...
    return T2(f6, { x: b4, y: T4 }, { width: _2 - b4, height: O - T4 }), f6;
  }
  getSliceIndex(e3) {
  ...
  async _fetchRasterInfo(e3) {
    ...
    if ("Map" === this.tileType) {
      ...
      return new d5({ width: i4, height: s4, bandCount: 3, extent: w.fromJSON(e4), spatialReference: r7, pixelSize: a5, pixelType: "u8", statistics: null, keyProperties: { DataType: "processed" } });
    }
...
function S3(e3) {
  ...
  t5.xmin > -1 && t5.xmax > 181 && (i3 == null ? void 0 : i3.wkid) && i3.isGeographic && (e3.nativeExtent = e3.extent, e3.transform = new c3(), e3.extent = e3.transform.forwardTransform(t5));
}
r([m({ type: String, json: { write: true } })], g4.prototype, "datasetFormat", void 0), r([m()], g4.prototype, "tileType", void 0), g4 = r([a("esri.layers.support.rasterDatasets.ImageServerRaster")], g4);
var I2 = g4;
...
var w4 = class extends X {
  ...
  async _open(t5) {
    ...
    if (!i3.includes("aux.xml") && !a4) {
      ...
      null != e4 && (s3.statistics = e4.statistics ?? s3.statistics, s3.histograms = e4.histograms, e4.histograms && null == s3.statistics && (s3.statistics = p5(e4.histograms)));
    }
  ...
  _parseHeader(t5) {
    ...
    const C = e2(t5, "MRF_META/Rsets"), T4 = parseInt((C == null ? void 0 : C.getAttribute("scale")) || "2", 10), L2 = M.spatialReference, U2 = new n3({ origin: new j({ x: M.xmin, y: M.ymax, spatialReference: L2 }), blockWidth: b4, blockHeight: R2, pyramidBlockWidth: b4, pyramidBlockHeight: R2, compression: g5, pyramidScalingFactor: T4 }), B3 = new j({ x: M.width / n7, y: M.height / c6, spatialReference: L2 }), E2 = new d5({ width: n7, height: c6, extent: M, isPseudoSpatialReference: j3, spatialReference: L2, bandCount: m6, pixelType: w5, pixelSize: B3, noDataValue: F3, storageInfo: U2 }), P3 = t3(t5, "datafile"), W2 = t3(t5, "IndexFile");
...
var v3 = class extends X {
  ...
  async _open(e3) {
    ...
    const { imageInfo: l4, rasterInfo: u7 } = k3(f6), p8 = N2(f6), c6 = U(f6);
  ...
  async _readIFDs(e3, t5, r6, i3, s3, a4 = 4, n7) {
    ...
    const o5 = await this._readIFD(t5, r6, i3, s3, n4.tiffTags, a4, n7);
    if (e3.push(o5.ifd), !o5.nextIFD) return null;
    await this._readIFDs(e3, t5, r6, o5.nextIFD - s3, s3, a4, n7);
  }
  async _readIFD(e3, r6, i3, s3, a4 = n4.tiffTags, n7 = 4, o5) {
    var _a, _b;
    if (!e3) return null;
    ...
    if (f6.success) {
      ...
      if ((_b = f6.ifd) == null ? void 0 : _b.has("GEOKEYDIRECTORY")) {
        ...
        if (i5 && i5.length > 4) {
          const a5 = i5[0] + "." + i5[1] + "." + i5[2], n8 = await this._readIFD(e3, r6, t5.valueOffset + 6 - s3, s3, n4.geoKeys, 2, o5);
    ...
    if (f6.requiredBufferSize && f6.requiredBufferSize !== e3.byteLength) {
      ...
      return (e3 = t5.data).byteLength < f6.requiredBufferSize ? null : this._readIFD(e3, r6, 0, s3, n4.tiffTags, 4, o5);
    }
  }
...
function k3(e3) {
  ...
  const C = new d5({ width: r6, height: i3, bandCount: p8, pixelType: c6, pixelSize: L2, storageInfo: O, spatialReference: v4, isPseudoSpatialReference: k4, keyProperties: B3, extent: P3, colormap: j3, statistics: b4 ? b4.statistics : null });
...
function P2(e3, t5) {
  if (t5.statistics = e3.statistics ?? t5.statistics, t5.histograms = e3.histograms, e3.histograms && null == t5.statistics && (t5.statistics = p5(e3.histograms)), e3.transform && null == t5.transform) {
...
r([m()], v3.prototype, "_files", void 0), r([m()], v3.prototype, "_headerInfo", void 0), r([m()], v3.prototype, "_bufferSize", void 0), r([m({ type: String, json: { write: true } })], v3.prototype, "datasetFormat", void 0), v3 = r([a("esri.layers.support.rasterDatasets.TIFFRaster")], v3);
var D2 = v3;
...
var V = class extends p(t(b(j2(o2(e(K(l2(l(f2(S(a3.ClonableMixin(f)))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.fields = null, this.source = void 0, this._debouncedSaveOperations = k(async (e4, t5, r6) => {
      const { save: s3, saveAs: i3 } = await import("./imageryUtils-3VRB2QCB.js");
      switch (e4) {
        case A.SAVE:
          return s3(this, t5);
        case A.SAVE_AS:
  ...
  get rasterFields() {
    var _a, _b;
    const e3 = [o("Pixel Value"), c("Raw Pixel Value")], t5 = ((_a = this.raster) == null ? void 0 : _a.rasterInfo) ?? this.serviceRasterInfo, r6 = t5 == null ? void 0 : t5.attributeTable;
    if (r6) {
      const t6 = v(r6);
      e3.push(...t6);
    }
    ...
    if (("vector-magdir" === s3 || "vector-uv" === s3) && null != i3) {
      const t6 = (_b = i3.variables[0].unit) == null ? void 0 : _b.trim(), r7 = d4(t6), s4 = $();
      e3.push(r7, s4);
    }
    if (i3) {
      const t6 = p4(i3);
  ...
  createPopupTemplate(e3) {
    const { rasterFields: t5 } = this, r6 = (e3 == null ? void 0 : e3.visibleFieldNames) ?? new Set(t5.map(({ name: e4 }) => e4).filter((e4) => e4 !== t2.rawServicePixelValue)), s3 = p2({ fields: t5, title: this.title }, { ...e3, visibleFieldNames: r6 }), { rasterInfo: i3 } = this.raster;
    return (s3 == null ? void 0 : s3.fieldInfos) && i3 && b2(s3.fieldInfos, i3), s3;
  }
  async generateRasterInfo(e3, t5) {
    var _a;
    if (e3 = h(w2, e3), await this.load(), !e3 || "none" === ((_a = e3.functionName) == null ? void 0 : _a.toLowerCase())) return this.serviceRasterInfo;
    try {
  ...
  async _openFunctionRaster(e3, t5) {
    ...
    const s3 = T3(((_a = e3.functionDefinition) == null ? void 0 : _a.toJSON()) ?? e3.toJSON(), r6), i3 = new u2({ rasterFunction: s3 });
...
r([m({ clonable: false })], V.prototype, "_primaryRasters", void 0), r([m(d2)], V.prototype, "legendEnabled", void 0), r([m({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], V.prototype, "isReference", void 0), r([m({ type: ["show", "hide"] })], V.prototype, "listMode", void 0), r([m({ json: { read: true, write: true } })], V.prototype, "blendMode", void 0), r([m({ type: w2, json: { name: "renderingRule", write: true } })], V.prototype, "rasterFunction", void 0), r([m()], V.prototype, "sourceJSON", void 0), r([m({ readOnly: true, json: { origins: { service: { read: { source: "currentVersion" } } } } })], V.prototype, "version", void 0), r([m({ readOnly: true, json: { read: false } })], V.prototype, "type", void 0), r([m({ type: ["ArcGISTiledImageServiceLayer"] })], V.prototype, "operationalLayerType", void 0), r([m({ type: Boolean, value: true, json: { read: { source: "disablePopup", reader: (e3, t5) => !t5.disablePopup }, write: { target: "disablePopup", overridePolicy() {
  ...
  return { enabled: !this.loaded || "Raster" === this.raster.tileType };
} } } })], V.prototype, "popupTemplate", void 0), r([m({ readOnly: true })], V.prototype, "defaultPopupTemplate", null), r([m({ readOnly: true, type: [y2] })], V.prototype, "fields", void 0), r([m({ readOnly: true, type: [y2] })], V.prototype, "rasterFields", null), r([m({ constructOnly: true })], V.prototype, "source", void 0), V = r([a("esri.layers.ImageryTileLayer")], V);
var B2 = V;
export {
  B2 as default
};
//# sourceMappingURL=ImageryTileLayer-MSTAAEHY.js.map
