...
} } } })], K.prototype, "sublayers", void 0), r([o2(["web-document", "portal-item"], "sublayers", ["layers", "visibleLayers"])], K.prototype, "readSublayersFromItemOrMap", null), r([o2("service", "sublayers", ["layers"])], K.prototype, "readSublayers", null), r([r2("sublayers", { layers: { type: [f3] }, visibleLayers: { type: [String] } })], K.prototype, "writeSublayers", null), r([m({ json: { read: false }, readOnly: true, value: "wms" })], K.prototype, "type", void 0), r([m(y)], K.prototype, "url", null), r([m({ type: String, json: { write: { ignoreOrigin: true } } })], K.prototype, "version", void 0), K = r([a2("esri.layers.WMSLayer")], K);
var Z = K;
export {
  Z as default
};
//# sourceMappingURL=WMSLayer-TQZIDTDP.js.map
