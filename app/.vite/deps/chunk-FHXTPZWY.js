...
var r7 = null;
function a6() {
  return t5 || (t5 = import("./lclayout-EJ7PYUAX.js").then((e6) => e6.l).then(({ default: t8 }) => t8({ locateFile: (t9) => n2(`esri/libs/linkchartlayout/${t9}`) })).then((e6) => {
    s5(e6);
  }), t5);
}
function s5(e6) {
      ...
      const e7 = new Set(h6), l9 = new Promise((d11, l10) => {
        const c6 = async () => {
          ...
          for (; ; ) {
            ...
            r10.forEach((e8) => {
              var _a3, _b3;
              d13 == null ? void 0 : d13.set(e8.attributes[_], e8), a8 && !((_a3 = this.inclusionModeDefinition) == null ? void 0 : _a3.namedTypeDefinitions.get(s7).members.has(e8.attributes[_])) && ((_b3 = this.inclusionModeDefinition) == null ? void 0 : _b3.namedTypeDefinitions.get(s7).members.set(e8.attributes[_], { id: e8.attributes[_] }), r2(this.memberIdTypeLookup, e8.attributes[_], () => /* @__PURE__ */ new Set()).add(s7));
            });
          }
...
var Ie = class extends p12(a3(d4(c(p(p6(l4(t(f4(S(f3)))))))))) {
  ...
  async queryFeatures(e6, t8) {
    await this.load();
    const { resolvedQuery: r9, queryEngine: o6 } = await this._setupQueryObjects(e6), i6 = d3.fromJSON(await o6.executeQuery(r9.toJSON(), t8 == null ? void 0 : t8.signal));
...
//# sourceMappingURL=chunk-FHXTPZWY.js.map
