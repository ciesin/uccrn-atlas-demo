...
import "./chunk-BFWSC7OC.js";
import "./chunk-OLVQKB2U.js";
import "./chunk-MYUL4ERJ.js";
import "./chunk-CEFHUHE4.js";
import "./chunk-RDJPXK25.js";
import "./chunk-JLP3FR5H.js";
...
import {
  I as I2
} from "./chunk-UY3XX3DT.js";
import "./chunk-WRD6NYYH.js";
import "./chunk-M36OMIGP.js";
...
var q = class extends b2(p(t2(S(f)))) {
      ...
      I2(this.url).then(async (n2) => {
        ...
        if ((r3 == null ? void 0 : r3.originIdOf("entitiesUrl")) === e.LINK_CHART && (this.membershipModified = false, this._originalInclusionList = await D.fetchAndConvertSerializedLinkChart({ entitiesUrl: r3 == null ? void 0 : r3.entitiesUrl, relationshipsUrl: r3 == null ? void 0 : r3.relationshipsUrl }), this._alignLayersDataModelAndInclusionDefinition(n2.dataModel), this.initializationLinkChartConfig = { layoutSettings: (r3 == null ? void 0 : r3.layoutSettings) ?? void 0, layoutMode: C2(r3.layoutType) }), this._initializeLayerProperties({ knowledgeGraph: n2, inclusionModeDefinition: this._originalInclusionList }), ((_e = (_d = this.dataManager.inclusionModeDefinition) == null ? void 0 : _d.namedTypeDefinitions) == null ? void 0 : _e.size) || (this.dataManager.inclusionModeDefinition = { generateAllSublayers: false, namedTypeDefinitions: /* @__PURE__ */ new Map() }, (_f = this.dataManager.knowledgeGraph.dataModel.entityTypes) == null ? void 0 : _f.forEach((e4) => {
          ...
          for (const [t4, a4] of ((_h = this.dataManager.inclusionModeDefinition) == null ? void 0 : _h.namedTypeDefinitions) ?? []) for (const i4 of ((_i = a4.members) == null ? void 0 : _i.values()) ?? []) {
            ...
            if (a5) {
              r2(this.dataManager.sublayerCaches, t4, () => /* @__PURE__ */ new Map()).set(i4.id, a5);
            }
          }
          await a3();
        } else {
  ...
  loadLayerAssumingLocalCache() {
    ...
    this.originIdOf("layers") === e.DEFAULTS ? this._createSublayers(e3, this.layers, (e4) => !!e4.geometryType) : this._updateSublayers(e3, this.layers), this.originIdOf("tables") === e.DEFAULTS ? this._createSublayers(e3, this.tables, (e4) => !e4.geometryType) : this._updateSublayers(e3, this.tables), (_b = (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.forEach((e4, t4) => {
      var _a2;
      const a3 = r2(this.sublayerIdsCache, t4, () => /* @__PURE__ */ new Set());
  ...
  async calculateLinkChartLayout(e3 = "organic-standard", t4) {
    ...
    for (let i3 = 0; i3 < _3.length; i3++) {
      ...
      const t5 = r2(this.dataManager.inclusionModeDefinition.namedTypeDefinitions, _3[i3].typeName, () => ({ useAllData: false, members: /* @__PURE__ */ new Map() }));
      r2(t5.members, _3[i3].feature.attributes[_], () => ({ id: _3[i3].feature.attributes[_], linkChartLocation: void 0 })).linkChartLocation = _3[i3].feature.attributes[S2], _3[i3].feature.attributes[S2].x < A2.xmin && (A2.xmin = _3[i3].feature.attributes[S2].x), _3[i3].feature.attributes[S2].x > A2.xmax && (A2.xmax = _3[i3].feature.attributes[S2].x), _3[i3].feature.attributes[S2].y < A2.ymin && (A2.ymin = _3[i3].feature.attributes[S2].y), _3[i3].feature.attributes[S2].y > A2.ymax && (A2.ymax = _3[i3].feature.attributes[S2].y);
    }
    ...
    for (let i3 = 0; i3 < l.length; i3++) {
      ...
      const x2 = r2(this.dataManager.inclusionModeDefinition.namedTypeDefinitions, r4.typeName, () => ({ useAllData: false, members: /* @__PURE__ */ new Map() }));
      r2(x2.members, r4.feature.attributes[_], () => ({ id: r4.feature.attributes[_], linkChartLocation: void 0 })).linkChartLocation = D3;
    }
...
r([m(y)], q.prototype, "url", void 0), r([m()], q.prototype, "dataPreloadedInLocalCache", void 0), r([m()], q.prototype, "initializationLinkChartConfig", void 0), r([m()], q.prototype, "membershipModified", void 0), r([m()], q.prototype, "dataManager", void 0), r([m()], q.prototype, "initializationInclusionModeDefinition", null), r([m()], q.prototype, "knowledgeGraph", void 0), r([m({ type: V.ofType(Se), json: { write: { ignoreOrigin: true } } })], q.prototype, "layers", void 0), r([m({ readOnly: true })], q.prototype, "linkChart", null), r([m()], q.prototype, "entityLinkChartDiagramLookup", void 0), r([m()], q.prototype, "relationshipLinkChartDiagramLookup", void 0), r([m()], q.prototype, "linkChartExtent", void 0), r([m()], q.prototype, "memberEntityTypes", void 0), r([m()], q.prototype, "memberRelationshipTypes", void 0), r([m({ type: ["LinkChartLayer"] })], q.prototype, "operationalLayerType", void 0), r([m()], q.prototype, "sublayerIdsCache", void 0), r([m({ type: V.ofType(Se), json: { write: { ignoreOrigin: true } } })], q.prototype, "tables", void 0), r([m({ json: { read: false } })], q.prototype, "type", void 0), r([m({ json: { read: false } })], q.prototype, "chronologicalAuxiliaryGraphics", void 0), q = r([a("esri.layers.LinkChartLayer")], q);
var J = q;
export {
  J as default
};
//# sourceMappingURL=LinkChartLayer-LYQT2TCU.js.map
