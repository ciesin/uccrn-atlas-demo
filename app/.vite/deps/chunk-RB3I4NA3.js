...
(function() {
  if (m()) {
    ...
    platform.getOffsetParent = (n) => e(n, offsetParent);
  }
})();
function U(t) {
...
var O = (
  ...
  async (t, {
    ...
    const m2 = bt(n) === "rtl", {
      ...
      strategy: k,
      middlewareData: p
    } = await computePosition2(e, n, {
      strategy: i,
      placement: a === "auto" || a === "auto-start" || a === "auto-end" ? void 0 : M2(a, m2),
      middleware: J({
        placement: a,
        flipDisabled: s,
        flipPlacements: o == null ? void 0 : o.map((c) => M2(c, m2)),
        offsetDistance: l,
        offsetSkidding: r,
        arrowEl: g,
        type: D
...
function J({
  ...
  if (o === "popover" || o === "tooltip") {
    ...
    ) : e || r.push(flip2(n ? { fallbackPlacements: n } : {})), s && r.push(
      arrow2({
        element: s
      })
    ), r;
...
function Y(t) {
  ...
  if (!e || !n)
    return;
  const i = f.get(t);
  (i == null ? void 0 : i.state) === "active" && i.cleanUp(), f.delete(t), (_a = d.get(t)) == null ? void 0 : _a.cancel(), d.delete(t);
}
var x = 4;
var ut = Math.ceil(Math.hypot(x, x));
...
@esri/calcite-components/dist/chunks/floating-ui.js:
  ...
  v3.0.3 *)
*/
//# sourceMappingURL=chunk-RB3I4NA3.js.map
