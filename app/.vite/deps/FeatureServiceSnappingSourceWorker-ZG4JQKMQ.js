...
var j = class extends g {
  ...
  async handleEdits(e3) {
    ...
    const t3 = { ...e3, deletedFeatures: e3.deletedFeatures.map(({ objectId: e4, globalId: t4 }) => e4 && -1 !== e4 ? e4 : this._lookupObjectIdByGlobalId(t4)) }, i5 = d(async (e4) => {
      try {
        ...
        a2(i6), n.getLogger(this).warn("Failed to apply edits", i6);
      }
    });
  ...
  async _queryFeaturesPBF(e3, t3) {
    const { sourceSpatialReference: i5 } = this, { data: s3 } = await f3(this.url, e3, new a3({ sourceSpatialReference: i5 }), { query: this._configuration.customParameters, timeout: x2, signal: t3 });
    return at(s3);
  }
...
r([m({ constructOnly: true })], g4.prototype, "featureStore", void 0), r([m()], g4.prototype, "tileInfo", void 0), r([m()], g4.prototype, "extent", void 0), r([m()], g4.prototype, "maximumByteSize", void 0), g4 = r([a("esri.views.interactive.snapping.featureSources.featureServiceSource.FeatureServiceTileStore")], g4);
var v = class {
...
r([m({ readOnly: true })], I.prototype, "updating", null), r([m()], I.prototype, "_isInitializing", void 0), I = r([a("esri.views.interactive.snapping.featureSources.featureServiceSource.FeatureServiceSnappingSourceWorker")], I);
var j2 = I;
function b3(e3) {
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-ZG4JQKMQ.js.map
