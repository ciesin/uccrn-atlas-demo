...
var B = class extends p(t(f2(p3(l(b3(j3(e2(i(S(f)))))))))) {
  ...
  load(e4) {
    const r5 = this.loadFromPortal({ supportedTypes: ["Vector Tile Service"], supportsData: false }, e4).catch(a3).then(async () => {
      var _a;
...
//# sourceMappingURL=VectorTileLayer-B4ITCVFW.js.map
