...
async function m7(t3, r5, e2, n7) {
  ...
  if (!d4(t3, s7) || null == s7 || !r5.assetMaps || !((_a = r5.features) == null ? void 0 : _a.length)) return d.fromJSON(r5);
  const { meshFeatureSetFromJSON: a5 } = await h(import("./meshFeatureSet-QFBIVPKY.js"), n7);
  return a5(t3, s7, r5);
}
function p5(o5, s7) {
  let a5 = b2.from(o5);
...
async function l3(t3, i5, a5, s7) {
  const l5 = f(t3), { source: r5, checkValueRange: u7 } = i5, { classificationDefinition: c7 } = a5, f4 = { ...a5.toJSON(), f: "json" };
  let m10 = null;
...
function o2(e2, t3) {
  ...
  const c7 = new m4({ statisticType: "min", onStatisticField: n7 }), f4 = new m4({ statisticType: "max", onStatisticField: n7 }), m10 = new b2({ outStatistics: [c7, f4] });
...
async function L(e2, n7) {
  ...
  for (const t3 of l5) {
    ...
    let c8 = l6;
    o5 && (c8 = `${m5(c8)}${r5}${m5(s8)}`, a5 && (c8 = `${c8}${r5}${m5(u8)}`)), null == p9[c8] ? p9[c8] = { count: n8, data: c8 } : p9[c8].count = p9[c8].count + n8;
  }
  if (i5 && d7) {
    const e3 = i5 + " is NULL";
    try {
...
function J(e2, t3) {
  const n7 = "countOF" + (e2 || "Expr"), l5 = new m4();
...
async function g2(e2, t3, a5, o5, d7) {
  ...
  if ("defined-interval" === z4) return new c3({ field: p9, expression: f4, normalizationField: c7, normalizationTotal: d7, normalizationType: v2, interval: e2.definedInterval ?? Math.ceil((o5 - a5) / B2), start: v2 ? null : a5, end: v2 ? null : o5, normalizationMinValue: v2 ? a5 : null, normalizationMaxValue: v2 ? o5 : null });
  ...
  if ("natural-breaks" === z4 || "quantile" === z4 || "standard-deviation" === z4) {
    ...
    return new m6({ field: v2 ? null : p9, expression: v2 ? n7 : f4, boundaries: l5 });
  }
  return new c2({ field: p9, normalizationField: c7, normalizationTotal: d7, normalizationType: v2, expression: f4, numBins: B2, start: v2 ? null : a5, end: v2 ? null : o5, normalizationMinValue: v2 ? a5 : null, normalizationMaxValue: v2 ? o5 : null });
}
...
async function b5(i5, n7, r5, l5) {
  ...
  const T6 = new m4({ statisticType: "count", outStatisticFieldName: V2, onStatisticField: "1" }), F4 = U2(l5, v2.sqlWhere), B2 = "lowerBoundary", j6 = "upperBoundary", q4 = new T2({ binParameters: await g2(i5, n7, x, w3, r5), outStatistics: [T6], binOrder: i5.sortOrder, where: F4, lowerBoundaryAlias: B2, upperBoundaryAlias: j6, outTimeZone: (f4 == null ? void 0 : f4.timeZone) && z4 ? F(f4.timeZone) : null });
...
var R3 = class extends s6 {
  ...
  async _getNormalizationTotalFromMemory(e2, t3, a5) {
    const { featuresJSON: i5, graphics: s7, layerView: o5, query: n7 } = t3, l5 = { include: ["sum"] }, u7 = (!i5 && !s7 && o5 && "querySummaryStatistics" in o5 ? await o5.querySummaryStatistics(n7, { field: e2 }, { signal: a5 }) : i5 ? await this.workerClient.summaryStatistics({ field: e2, outStatisticTypes: l5 }, i5) : await d3({ attribute: { field: e2, outStatisticTypes: l5 }, features: s7 ?? [] })).sum;
  ...
  async _uvFromClientQuery(e2, t3) {
    const { view: r5, signal: a5 } = e2, i5 = H(this, e2), s7 = await this._fetchFeatureSetFromMemory(i5, r5, a5), o5 = await L(s7, { layer: this, field: e2.field, field2: e2.field2, field3: e2.field3, fieldDelimiter: f2, view: e2.view, signal: e2.signal });
    return $2(o5, t3, e2.returnAllCodedValues, f2);
  }
  async _uvFromMemory(e2, t3) {
    const { view: r5, field: a5, valueExpression: i5, returnAllCodedValues: s7, signal: o5 } = e2, { featuresJSON: n7, graphics: l5, layerView: u7, query: m10, fieldInfos: p9 } = await this._processStatsFromMemoryParams({ ...e2, layerViewFunc: "queryUniqueValues" }), y2 = { field: a5, field2: e2.field2, field3: e2.field3, fieldDelimiter: f2, valueExpression: i5, domains: t3, returnAllCodedValues: s7 };
  ...
  async _heatmapStatsFromMemory(e2) {
    ...
    const { featuresJSON: n7, graphics: l5 } = await this._processStatsFromMemoryParams({ ...e2, returnGeometry: true }), u7 = new m3({ extent: t3.extent, tolerance: "2d" === t3.type ? t3.state.resolution : (_a = t3.pixelSizeAt) == null ? void 0 : _a.call(t3, t3.center) }), p9 = { field: r5, radius: a5, transform: s3(u7), spatialReference: (_b = t3.spatialReference) == null ? void 0 : _b.toJSON(), size: t3.size };
...
var Z2 = class extends D3 {
  ...
  async _uvFromServiceQuery(e2, t3) {
    return this._isStatsSupportedOnService().then(() => this.layer.queryFeatures(H(this, e2), { signal: e2.signal })).then((t4) => L(t4, { layer: this, field: e2.field, field2: e2.field2, field3: e2.field3, fieldDelimiter: f2, view: e2.view, signal: e2.signal })).then((r5) => $2(r5, t3, e2.returnAllCodedValues, f2));
  }
  ...
  _histogramForExpr(e2) {
    return this._getNormalizationTotal(e2.field, e2.normalizationType, e2.filter, e2.signal).then((t3) => {
      ...
      return E2(r5, this, e2.minValue, e2.maxValue).then((i5) => {
        ...
        const o5 = e2.numBins || S2, n7 = j2(s7, a5, o5), l5 = K(r5.sqlExpression, n7, null != e2.minValue && null != e2.maxValue), u7 = new m4({ statisticType: "count", outStatisticFieldName: "countOFExpr", onStatisticField: "1" }), m10 = this.layer.createQuery();
    ...
    if (a5) try {
      ...
      if (f4 = !z3(this, o5, s7).length, f4) {
        if (m10 >= 1 && !e2.filter && "getSampleFeatures" in s7) {
          ...
          if (null != e3) return p9 ? e3 : e3.map((e4) => b.fromJSON(e4));
        }
...
var m8 = class extends X {
  ...
  async _createGenerateRendererResult(e2, r5, i5, n7, l5) {
    ...
    if ("class-breaks-definition" === (l5 == null ? void 0 : l5.type)) {
      const e3 = (await b3({ field: r5, normalizationType: n7, normalizationField: i5, normalizationTotal: d7 }, m10)).filter((e4) => Number.isFinite(e4));
      return a3({ definition: l5, values: e3, normalizationTotal: d7 });
    }
    const f4 = (await b3({ field: r5 }, m10)).filter((e3) => null != e3 && "string" == typeof e3 && "" !== e3.trim());
    return n3(f4);
  }
...
var N3 = class extends X {
  ...
  async _getNormalizationTotalFromMemory(e2, t3, r5) {
    const { featuresJSON: i5, graphics: s7, layerView: o5, query: n7 } = t3, l5 = { include: ["sum"] }, m10 = (!i5 && !s7 && o5 && "queryAggregateSummaryStatistics" in o5 ? await o5.queryAggregateSummaryStatistics(n7, { field: e2, outStatisticTypes: l5 }, { signal: r5 }) : i5 ? await this.workerClient.summaryStatistics({ field: e2 }, i5) : await d3({ attribute: { field: e2, outStatisticTypes: l5 }, features: s7 })).sum;
  ...
  async _summaryStatsFromMemory(e2, t3) {
    ...
    return i5 && a5 && (m10 || p9) && (l5.fieldType = (t3 == null ? void 0 : t3.type) ? i.toJSON(t3.type) : null, l5.viewInfoParams = B(a5), l5.timeZone = a5.timeZone, l5.fieldInfos = y2), "percent-of-total" === s7 && null == e2.normalizationTotal && (l5.normalizationTotal = await this._getNormalizationTotalFromMemory(r5, { featuresJSON: m10, graphics: p9, layerView: g4, query: d7 }, n7)), !m10 && !p9 && g4 && "queryAggregateSummaryStatistics" in g4 ? g4.queryAggregateSummaryStatistics(d7, l5, { signal: n7 }) : m10 ? this.workerClient.summaryStatistics(l5, m10) : d3({ attribute: l5, features: p9 });
  }
  async _uvFromMemory(e2, t3) {
    const { view: a5, field: r5, valueExpression: i5, returnAllCodedValues: s7, signal: o5 } = e2, { featuresJSON: n7, graphics: l5, layerView: u7, query: p9, fieldInfos: g4 } = await this._processStatsFromMemoryParams({ ...e2, layerViewFunc: "queryAggregateUniqueValues" }), d7 = { field: r5, field2: e2.field2, field3: e2.field3, fieldDelimiter: f2, valueExpression: i5, domains: t3, returnAllCodedValues: s7 };
...
var A2 = class extends s6 {
  ...
  async _getNormalizationTotal(e2, t3, r5) {
    const s7 = { include: ["sum"] }, i5 = (t3 ? await this.workerClient.summaryStatistics({ field: e2, outStatisticTypes: s7 }, t3) : await d3({ attribute: { field: e2, outStatisticTypes: s7 }, features: r5 })).sum;
  ...
  async _getSummaryStatisticsFromMemory(e2, t3) {
    ...
    return e2.valueExpression && r5 && o5 && (l5.fieldType = (t3 == null ? void 0 : t3.type) ? i.toJSON(t3.type) : null, l5.viewInfoParams = B(r5), l5.timeZone = r5.timeZone), "percent-of-total" === e2.normalizationType && null == e2.normalizationTotal && (l5.normalizationTotal = await this._getNormalizationTotal(a5, o5, n7)), o5 ? this.workerClient.summaryStatistics(l5, o5) : d3({ attribute: l5, features: n7 });
  }
  ...
  async _getUniqueValuesFromMemory(e2, t3) {
    const { view: r5, field: a5, field2: s7, field3: i5, valueExpression: o5, returnAllCodedValues: n7 } = e2, l5 = { field: a5, field2: s7, field3: i5, fieldDelimiter: f2, valueExpression: o5, domains: t3, returnAllCodedValues: n7 }, { featuresJSON: u7, graphics: p9 } = await this._processStatsFromMemoryParams(e2);
  ...
  async _getClassBreaksFromMemory(e2) {
    ...
    return e2.valueExpression && t3 && i5 && (n7.viewInfoParams = B(t3), n7.timeZone = t3.timeZone), "percent-of-total" === e2.normalizationType && null == e2.normalizationTotal && (n7.normalizationTotal = await this._getNormalizationTotal(r5, i5, o5)), i5 ? this.workerClient.classBreaks(n7, i5) : c4({ attribute: n7, features: o5 });
  }
...
async function u6(u7) {
  ...
  await w3.load(q4);
  const x = await U({ field: c7.field, field2: c7.field2, field3: c7.field3, valueExpression: c7.valueExpression }), y2 = T3(w3, x, "unique-values:invalid-parameters");
  if (y2) throw y2;
...
//# sourceMappingURL=uniqueValues-G6E2MQXC.js.map
