...
import {
  ...
  n as n4,
  t as t2
} from "./chunk-WCU7DDWC.js";
import "./chunk-SA7DV5I6.js";
import "./chunk-DMO5AKFB.js";
import "./chunk-2O3Y66HW.js";
import "./chunk-VRFYHG34.js";
import "./chunk-EZQWXU2P.js";
import "./chunk-ZNVYE3UB.js";
import "./chunk-Y27EMLXK.js";
import "./chunk-DVZSVGIW.js";
...
var u = class extends O {
  ...
  loadDependencies() {
    return c2({ action: () => import("./calcite-action-QKCY7YP2.js"), "action-bar": () => import("./calcite-action-bar-ATYDSER2.js"), "action-group": () => import("./calcite-action-group-N4KWV256.js"), "flow-item": () => import("./calcite-flow-item-57QIZJUT.js") });
  }
  render() {
...
async function R2(e13, t8) {
  ...
  const { getColor: f4, getOpacity: p7, getAllSizes: y3, getRotationAngle: h6 } = await import("./visualVariableUtils-ZEYVTAMY.js"), m5 = [], b4 = [], d4 = [], g6 = [];
  ...
  constructor(e13) {
    super(e13), this._pendingPromises = new t3(), this._fetchFeaturesController = null, this._highlightPromises = { "highlight-active-feature": null, "highlight-selected-feature": null }, this._selectedClusterFeature = null, this.actions = new i4(), this.activeFeature = null, this.autoCloseEnabled = false, this.browseClusterEnabled = false, this.content = null, this.defaultPopupTemplateEnabled = false, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = false, this.featureMenuTitle = null, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = true, this.includeDefaultActions = true, this.initialDisplayMode = "feature", this.selectedClusterBoundaryFeature = new b2({ symbol: new S({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = false, this.view = null, this.visible = false, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = k(async (e14) => {
      ...
      if (i6 && "mesh" !== i6 && t8 && s4 && this.selectedFeature) if ("point" !== i6) try {
        ...
        if (i7 = O2(i7, t8), U || (U = await import("./geometryEngineAsync-KKCD4JUK.js")), !await U.intersects(i7, s4)) {
...
var S3 = class extends n4(O) {
  constructor(e13, i6) {
    super(e13, i6), this._featureMenuIntersectionObserverCallback = ([e14]) => {
      ...
      this._rootNode = e14;
    }, this._displaySpinnerThrottled = e6(() => this._displaySpinner(), L2), this._addSelectedFeatureIndexHandle(), this.addHandles([this._displaySpinnerThrottled, d2(() => {
      var _a;
  ...
  loadDependencies() {
    return c2({ action: () => import("./calcite-action-QKCY7YP2.js"), "action-bar": () => import("./calcite-action-bar-ATYDSER2.js"), "action-group": () => import("./calcite-action-group-N4KWV256.js"), button: () => import("./calcite-button-JBDKJEJZ.js"), icon: () => import("./calcite-icon-6QWLC3AJ.js"), flow: () => import("./calcite-flow-5YGDSUYX.js"), "flow-item": () => import("./calcite-flow-item-57QIZJUT.js"), list: () => import("./calcite-list-EYDTM3R4.js"), "list-item": () => import("./calcite-list-item-I75MSBTM.js"), "list-item-group": () => import("./calcite-list-item-group-66UW7DCS.js"), loader: () => import("./calcite-loader-QX4G267A.js") });
  }
  destroy() {
    var _a, _b, _c;
  ...
  render() {
    return n2("div", { afterCreate: this._storeRootNode, bind: this, class: this.classes(n7.base, e3.widget, e3.panel), onkeydown: this._onMainKeydown }, this._renderHeader(), this._renderContentContainer());
  }
  ...
  _renderContentFeature() {
    ...
    return n2("calcite-flow-item", { afterCreate: this._storeRootFlowItemNode, bind: this, class: this.classes({ [n7.contentFeature]: true, [n7.flowItemCollapsed]: i6 }), closable: t8.closeButton, closed: !c9, collapsed: i6, collapseDirection: s4 ? "down" : "up", collapsible: o4, headingLevel: e13, key: "root-flow-item", selected: h6, onCalciteFlowItemBack: this._handleFeatureBack, onCalciteFlowItemClose: this.close, onCalciteFlowItemToggle: this._handleCollapseToggle }, u5 ? n2(e4, { class: this.classes(n7.featuresHeading, e3.heading), innerHTML: u5, key: "header-content", level: this.headingLevel, slot: "header-content" }) : null, this._renderHeaderActions(), this._renderActionBar(), n2("div", { class: this.classes(n7.container, n7.contentContainer) }, this._renderContent()), this._renderFooter());
  }
  ...
  _renderContent() {
    ...
    return e13 ? "string" == typeof e13 ? n2("div", { class: t2.contentNode, innerHTML: e13, key: e13 }) : this.renderNodeContent(e13) : null;
  }
...
var D4 = class extends O {
  ...
  initialize() {
    ...
    }, () => this._handleDockEnabled(), P), d2(() => this.dockOptions, (t8) => {
      const { _dockAction: e13 } = this, i6 = this._featuresWidget.headerActions;
      i6.remove(e13), t8.buttonEnabled && i6.add(e13);
    }, P), d2(() => {
      var _a;
      return (_a = this.viewModel) == null ? void 0 : _a.screenLocation;
    ...
    }, (t8, e13) => this._updateDockEnabledForViewSize(t8, e13)), d2(() => {
      var _a;
      return (_a = this.viewModel) == null ? void 0 : _a.view;
    }, (t8, e13) => this._viewChange(t8, e13)), d2(() => {
      var _a, _b;
      return (_b = (_a = this.viewModel) == null ? void 0 : _a.view) == null ? void 0 : _b.ready;
    }, (t8, e13) => this._viewReadyChange(t8 ?? false, e13 ?? false)), d2(() => this.viewModel, () => this._featuresWidget.viewModel = this.viewModel, P), d2(() => this._featureNavigationTop, (t8) => this._featuresWidget.featureNavigationTop = t8, P), d2(() => this.headingLevel, (t8) => this._featuresWidget.headingLevel = t8, P), d2(() => this.visibleElements.actionBar, (t8) => this._featuresWidget.visibleElements.actionBar = !!t8, P), d2(() => this.visibleElements.closeButton, (t8) => this._featuresWidget.visibleElements.closeButton = !!t8, P), d2(() => this.visibleElements.collapseButton, (t8) => this._featuresWidget.visibleElements.collapseButton = !!t8, P), d2(() => this.visibleElements.heading, (t8) => this._featuresWidget.visibleElements.heading = !!t8, P), d2(() => this.visibleElements.spinner, (t8) => this._featuresWidget.visibleElements.spinner = !!t8, P), d2(() => this.visibleElements.featureNavigation, (t8) => this._featuresWidget.visibleElements.featureNavigation = !!t8, P), d2(() => this.visibleElements.featureListLayerTitle, (t8) => this._featuresWidget.visibleElements.featureListLayerTitle = !!t8, P), v(() => this._featuresWidget, "trigger-header-action", (t8) => {
      t8.action === this._dockAction && (this.dockEnabled = !this.dockEnabled);
    })]);
  }
  destroy() {
    var _a;
  ...
  get _featureNavigationTop() {
    const { currentAlignment: t8, currentDockPosition: e13 } = this;
    return "bottom-left" === t8 || "bottom-center" === t8 || "bottom-right" === t8 || "top-left" === e13 || "top-center" === e13 || "top-right" === e13;
  }
  get actions() {
    return this.viewModel.actions;
  }
  set actions(t8) {
    this.viewModel.actions = t8;
  }
  get active() {
    return this.viewModel.active;
  }
  ...
  set autoCloseEnabled(t8) {
    this.viewModel.autoCloseEnabled = t8;
  }
  get defaultPopupTemplateEnabled() {
    return this.viewModel.defaultPopupTemplateEnabled;
  }
  set defaultPopupTemplateEnabled(t8) {
    this.viewModel.defaultPopupTemplateEnabled = t8;
  }
  get content() {
    return this.viewModel.content;
  }
  set content(t8) {
    this.viewModel.content = t8;
  }
  get collapsed() {
    return this._featuresWidget.collapsed;
  }
  set collapsed(t8) {
    this._featuresWidget.collapsed = t8;
  }
  ...
  set dockOptions(t8) {
    var _a, _b;
    const e13 = { ...C2 }, i6 = (_b = (_a = this.viewModel) == null ? void 0 : _a.view) == null ? void 0 : _b.breakpoints, o4 = {};
    i6 && (o4.width = i6.xsmall, o4.height = i6.xsmall);
    const s4 = { ...e13, ...t8 }, n9 = { ...e13.breakpoint, ...o4 }, { breakpoint: r3 } = s4;
  ...
  set featureMenuOpen(t8) {
    this.viewModel.featureMenuOpen = t8;
  }
  get features() {
    return this.viewModel.features;
  }
  set features(t8) {
    this.viewModel.features = t8;
  }
  get goToOverride() {
    return this.viewModel.goToOverride;
  }
  set goToOverride(t8) {
    this.viewModel.goToOverride = t8;
  }
  get highlightEnabled() {
    return this.viewModel.highlightEnabled;
  }
  set highlightEnabled(t8) {
    this.viewModel.highlightEnabled = t8;
  }
  get icon() {
    return "popup";
  }
  set icon(t8) {
    this._overrideIfSome("icon", t8);
  }
  get initialDisplayMode() {
    return this.viewModel.initialDisplayMode;
  }
  set initialDisplayMode(t8) {
    this.viewModel.initialDisplayMode = t8;
  }
  get location() {
    return this.viewModel.location;
  }
  set location(t8) {
    this.viewModel.location = t8;
  }
  get label() {
    var _a;
    return ((_a = this.messages) == null ? void 0 : _a.widgetLabel) ?? "";
  ...
  set label(t8) {
    this._overrideIfSome("label", t8);
  }
  get promises() {
    return this.viewModel.promises;
  }
  set promises(t8) {
    this.viewModel.promises = t8;
  }
  get selectedFeature() {
    return this.viewModel.selectedFeature;
  }
  ...
  set selectedFeatureIndex(t8) {
    this.viewModel.selectedFeatureIndex = t8;
  }
  get selectedFeatureWidget() {
  ...
  set title(t8) {
    this.viewModel.title = t8;
  }
  get updateLocationEnabled() {
    return this.viewModel.updateLocationEnabled;
  }
  set updateLocationEnabled(t8) {
    this.viewModel.updateLocationEnabled = t8;
  }
  get view() {
    return this.viewModel.view;
  }
  set view(t8) {
    this.viewModel.view = t8;
  }
  get visible() {
    return this.viewModel.visible;
  }
  set visible(t8) {
    this.viewModel.visible = t8;
  }
  blur() {
    const { active: t8 } = this.viewModel;
    t8 || n.getLogger(this).warn("Popup can only be blurred when currently active."), this._featuresWidget.blur();
  }
  clear() {
    return this.viewModel.clear();
  }
  ...
  fetchFeatures(t8, e13) {
    return this.viewModel.fetchFeatures(t8, e13);
  }
  focus() {
    const { active: t8 } = this.viewModel;
    t8 || n.getLogger(this).warn("Popup can only be focused when currently active."), this._handleFocus();
  }
  next() {
    return this.viewModel.next();
  }
  open(t8) {
    const e13 = !!t8 && !!t8.featureMenuOpen, i6 = { collapsed: !!t8 && !!t8.collapsed, featureMenuOpen: e13 };
    this.set(i6), this.viewModel.open(t8), (t8 == null ? void 0 : t8.shouldFocus) && this._handleFocus(true);
  }
  previous() {
    return this.viewModel.previous();
  }
  ...
  triggerAction(t8) {
    return this.viewModel.triggerAction(t8);
  }
  render() {
    var _a, _b, _c, _d;
    const { dockEnabled: t8, currentAlignment: e13, currentDockPosition: i6 } = this, { active: o4, screenLocation: s4 } = this.viewModel, n9 = o4 && t8, r3 = o4 && !t8, l7 = (_b = (_a = this.selectedFeature) == null ? void 0 : _a.layer) == null ? void 0 : _b.title, a7 = (_d = (_c = this.selectedFeature) == null ? void 0 : _c.layer) == null ? void 0 : _d.id, c9 = { [e11.alignTopCenter]: "top-center" === e13, [e11.alignBottomCenter]: "bottom-center" === e13, [e11.alignTopLeft]: "top-left" === e13, [e11.alignBottomLeft]: "bottom-left" === e13, [e11.alignTopRight]: "top-right" === e13, [e11.alignBottomRight]: "bottom-right" === e13, [e11.isDocked]: n9, [e11.shadow]: r3, [e11.isDockedTopLeft]: "top-left" === i6, [e11.isDockedTopCenter]: "top-center" === i6, [e11.isDockedTopRight]: "top-right" === i6, [e11.isDockedBottomLeft]: "bottom-left" === i6, [e11.isDockedBottomCenter]: "bottom-center" === i6, [e11.isDockedBottomRight]: "bottom-right" === i6 };
    return n2("div", { afterCreate: this._positionContainer, afterUpdate: this._positionContainer, "aria-hidden": (!o4).toString(), "aria-label": c(this.title ?? ""), "aria-modal": "false", bind: this, class: this.classes(e11.base, c9, { [e11.baseHidden]: !s4 && !t8 }), "data-layer-id": a7, "data-layer-title": l7, role: "dialog" }, o4 ? [this._renderMainContainer(), this._renderPointer()] : null);
  }
  _renderPointer() {
  ...
  _renderMainContainer() {
    const { dockEnabled: t8 } = this, e13 = { [e11.shadow]: t8 };
    return n2("div", { afterCreate: this._setMainContainerNode, afterUpdate: this._setMainContainerNode, bind: this, class: this.classes(e11.main, e3.widget, e13) }, this._featuresWidget.render());
  }
  _getAnimationDurationMS() {
    const { _containerNode: t8 } = this;
    return t8 ? 1e3 * parseFloat(window.getComputedStyle(t8).animationDuration) : E2;
  }
  async _handleFocus(t8 = false) {
    var _a;
    (_a = this._focusAbortController) == null ? void 0 : _a.abort(), this._focusAbortController = new AbortController();
    const e13 = this._focusAbortController.signal;
    t8 && await w(() => {
    ...
    }, { signal: e13 }), await d(R(e13)), await d(A(this._getAnimationDurationMS(), e13)), this._featuresWidget.focus();
  }
  _isOutsideView(t8) {
    const { popupHeight: e13, popupWidth: i6, screenLocation: o4, side: s4, view: n9 } = t8;
    if (isNaN(i6) || isNaN(e13) || !n9 || !o4) return false;
    const r3 = n9.padding;
    return "right" === s4 && o4.x + i6 / 2 > n9.width - r3.right || ("left" === s4 && o4.x - i6 / 2 < r3.left || ("top" === s4 && o4.y - e13 < r3.top || "bottom" === s4 && o4.y + e13 > n9.height - r3.bottom));
  }
  _calculateAutoAlignment(t8) {
    if ("auto" !== t8) return t8;
    const { _pointerOffsetInPx: e13, _containerNode: i6, _mainContainerNode: o4, viewModel: s4 } = this, { screenLocation: n9, view: r3 } = s4;
    if (null == n9 || !r3 || !i6) return "top-center";
    function l7(t9) {
      return parseInt(t9.replaceAll(/[^-\d.]/g, ""), 10);
    }
    const a7 = o4 ? window.getComputedStyle(o4, null) : null, d4 = a7 ? l7(a7.getPropertyValue("max-height")) : 0, c9 = a7 ? l7(a7.getPropertyValue("height")) : 0, { height: h6, width: u5 } = i6.getBoundingClientRect(), p7 = u5 + e13, g6 = Math.max(h6, d4, c9) + e13, v5 = this._isOutsideView({ popupHeight: g6, popupWidth: p7, screenLocation: n9, side: "right", view: r3 }), m5 = this._isOutsideView({ popupHeight: g6, popupWidth: p7, screenLocation: n9, side: "left", view: r3 }), f4 = this._isOutsideView({ popupHeight: g6, popupWidth: p7, screenLocation: n9, side: "top", view: r3 }), w5 = this._isOutsideView({ popupHeight: g6, popupWidth: p7, screenLocation: n9, side: "bottom", view: r3 });
    return m5 ? f4 ? "bottom-right" : "top-right" : v5 ? f4 ? "bottom-left" : "top-left" : f4 ? w5 ? "top-center" : "bottom-center" : "top-center";
  }
  _callCurrentAlignment(t8) {
    return "function" == typeof t8 ? t8.call(this) : t8;
  }
  _getCurrentAlignment() {
    const { alignment: t8, dockEnabled: e13 } = this;
    return e13 || !this.viewModel.active ? null : this._calculatePositionResult(this._calculateAutoAlignment(this._callCurrentAlignment(t8)));
  }
  ...
  _calculatePositionResult(t8) {
    const e13 = ["left", "right"];
    return g2(this.container) && e13.reverse(), t8 == null ? void 0 : t8.replace(/leading/gi, e13[0]).replaceAll(/trailing/gi, e13[1]);
  }
  _callDockPosition(t8) {
    return "function" == typeof t8 ? t8.call(this) : t8;
  }
  _getDockPosition() {
    var _a;
  ...
  _calculateAutoDockPosition(t8) {
    var _a;
    if ("auto" !== t8) return t8;
    const e13 = (_a = this.viewModel) == null ? void 0 : _a.view, i6 = g2(this.container) ? "top-left" : "top-right";
    if (!e13) return i6;
    const o4 = e13.padding || { left: 0, right: 0, top: 0, bottom: 0 }, s4 = e13.width - o4.left - o4.right, { breakpoints: n9 } = e13;
    return n9 && s4 <= n9.xsmall ? "bottom-center" : i6;
  }
  _getDockIcon() {
    const t8 = this._getDockPosition();
  ...
  _setMainContainerNode(t8) {
    this._mainContainerNode = t8;
  }
  _positionContainer(t8 = this._containerNode) {
    if (t8 && (this._containerNode = t8), !this._containerNode) return;
    const { screenLocation: e13 } = this.viewModel, { width: i6 } = this._containerNode.getBoundingClientRect(), o4 = this._calculatePositionStyle(e13, i6);
    o4 && Object.assign(this._containerNode.style, o4);
  }
  _calculateFullWidth(t8) {
    const { currentAlignment: e13, _pointerOffsetInPx: i6 } = this;
    return "top-left" === e13 || "bottom-left" === e13 || "top-right" === e13 || "bottom-right" === e13 ? t8 + i6 : t8;
  }
  _calculateAlignmentPosition(t8, e13, i6, o4) {
    const { currentAlignment: s4, _pointerOffsetInPx: n9 } = this;
    if (!i6) return;
    const { padding: r3 } = i6, l7 = o4 / 2, a7 = i6.height - e13, d4 = i6.width - t8;
    return "bottom-center" === s4 ? { top: e13 + n9 - r3.top, left: t8 - l7 - r3.left } : "top-left" === s4 ? { bottom: a7 + n9 - r3.bottom, right: d4 + n9 - r3.right } : "bottom-left" === s4 ? { top: e13 + n9 - r3.top, right: d4 + n9 - r3.right } : "top-right" === s4 ? { bottom: a7 + n9 - r3.bottom, left: t8 + n9 - r3.left } : "bottom-right" === s4 ? { top: e13 + n9 - r3.top, left: t8 + n9 - r3.left } : "top-center" === s4 ? { bottom: a7 + n9 - r3.bottom, left: t8 - l7 - r3.left } : void 0;
  }
  _calculatePositionStyle(t8, e13) {
    const { dockEnabled: i6, view: o4 } = this;
    if (!o4) return;
    if (i6) return { left: "", top: "", right: "", bottom: "" };
    if (null == t8 || !e13) return;
    const s4 = this._calculateFullWidth(e13), n9 = this._calculateAlignmentPosition(t8.x, t8.y, o4, s4);
  ...
  _viewChange(t8, e13) {
    t8 && e13 && (this.close(), this.clear());
  }
  _viewReadyChange(t8, e13) {
    t8 ? this._wireUpView() : e13 && (this.close(), this.clear());
  }
  _wireUpView() {
    this._setDockEnabledForViewSize(this.dockOptions);
  }
  _dockingThresholdCrossed(t8, e13, i6) {
    const [o4, s4] = t8, [n9, r3] = e13, { width: l7 = 0, height: a7 = 0 } = i6 ?? {};
    return o4 <= l7 && n9 > l7 || o4 > l7 && n9 <= l7 || s4 <= a7 && r3 > a7 || s4 > a7 && r3 <= a7;
  }
  _updateDockEnabledForViewSize(t8, e13) {
    var _a, _b;
    if (!t8 || !e13) return;
    ...
    n9[0] = t8[0] - o4, n9[1] = t8[1] - s4, r3[0] = e13[0] - o4, r3[1] = e13[1] - s4;
