...
import {
  h as h4
} from "./chunk-Y7GJJB6G.js";
import {
  c as c8
} from "./chunk-ZUSEVN4R.js";
import {
  g as g3,
  n as n12
} from "./chunk-IIYRXULY.js";
import {
  a as a9,
  m as m3
} from "./chunk-6O55CGUT.js";
import {
  E as E6,
  d as d4,
  m as m4
} from "./chunk-R7NU4UJM.js";
import {
  m as m5
} from "./chunk-OSUBKL4S.js";
import {
  c as c7
} from "./chunk-TMVF72SV.js";
import {
  c as c6,
  s as s6,
  u as u6
...
var i8 = class {
  constructor(r10) {
    this.targets = [new s7(r10, "overlay color", n8.Color, o9.Color), new s7(r10, "overlay IM color", n8.Color, o9.ColorNoRasterImage), new s7(r10, "overlay highlight", n8.Highlight, o9.Highlight, R.RG), new s7(r10, "overlay water", n8.Normal, o9.WaterNormal), new s7(r10, "overlay occluded", n8.Color, o9.Occluded)], e9() && this.targets.push(new s7(r10, "overlay olid", n8.ObjectAndLayerIdColor, o9.ObjectAndLayerIdColor, R.RGBA));
  }
  getTexture(e17) {
    var _a;
...
var t14 = class extends l5 {
  constructor(r10, o16) {
    super(r10, o16, new t5(c7, () => import("./HighlightApply.glsl-SXIJJTOI.js")));
  }
  initializePipeline() {
    return B2({ blending: c4, colorWrite: g });
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/effects/highlight/HighlightDownsampleTechnique.js
var l6 = class extends l5 {
  constructor(r10, s15) {
    super(r10, s15, new t5(s6, () => import("./HighlightDownsample.glsl-CWNPR25F.js")));
  }
  initializePipeline() {
    return B2({ colorWrite: g });
  }
};
...
var l7 = class extends l5 {
  constructor(r10, o16) {
    super(r10, o16, new t5(h4, () => import("./HighlightToSingle.glsl-C7DLMOX5.js")));
  }
  initializePipeline() {
    return B2({ colorWrite: g });
  }
...
var t15 = class extends l5 {
  constructor(r10, l10) {
    super(r10, l10, new t5(c8, () => import("./SingleHighlightApply.glsl-3ZFLA6IL.js")));
  }
  initializePipeline() {
    return B2({ blending: c4, colorWrite: g });
  }
...
var s11 = class extends l5 {
  constructor(r10, l10) {
    super(r10, l10, new t5(g3, () => import("./SingleHighlightBlur.glsl-2KBCGX3R.js")));
  }
  initializePipeline() {
    return B2({ colorWrite: g });
  }
...
var O2 = [];
var o12 = [new t9(e7.POSITION, 3, C.FLOAT, 0, 12)];
var m7 = [new t9(e7.POSITION, 2, C.FLOAT, 0, 8)];
var n16 = [new t9(e7.POSITION, 2, C.FLOAT, 0, 16), new t9(e7.UV0, 2, C.FLOAT, 8, 16)];
...
var I2 = class extends h3 {
  ...
  _updateOptionsTexture() {
    ...
    this._passParameters.highlightOptionsTexture.setData(U2(this.view.state.highlights)), this.requestRender(a4.UPDATE);
  }
  precompile() {
  ...
  render(e17) {
    ...
    const h7 = i11.get(l6);
    if (!h7.compiled) return this.requestRender(a4.UPDATE), t19;
    const l10 = e17.find(({ name: e18 }) => "highlights" === e18).getTexture(), n19 = () => {
      ...
      o16.bindVAO(e18.vao), o16.drawElementsInstanced(E2.TRIANGLES, 6, C.UNSIGNED_BYTE, 0, t20);
    }, { camera: c11 } = r10, u8 = () => {
  ...
  _renderMultiple(e17, t19, i11, r10) {
    ...
    if (!n19.compiled) return void this.requestRender(a4.UPDATE);
    const a15 = t19();
  ...
  _renderSingle(e17, t19, i11, r10) {
    ...
    if (!m8.compiled || !u8.compiled || !c11.compiled) return void this.requestRender(a4.UPDATE);
  ...
  _gridUpdateResources(e17) {
    ...
    const s15 = this.renderingContext, o16 = E5.createIndex(s15, F.STATIC_DRAW, F2);
    t19.vao = new r6(s15, O, /* @__PURE__ */ new Map([["geometry", O2]]), /* @__PURE__ */ new Map([["geometry", E5.createVertex(s15, F.STATIC_DRAW)]]), o16);
  }
...
r([m()], I2.prototype, "produces", void 0), r([m()], I2.prototype, "consumes", void 0), I2 = r([a("esri.views.3d.webgl-engine.effects.highlight.Highlight")], I2);
var M3 = class {
  constructor() {
...
function V(e17, t19, i11, r10, s15, o16 = 0) {
  ...
  r10.highlightMixTexture = c11, o5(r10.highlightMixOrigin, o16, 0), h7.forEach((t20, h8) => {
...
var s12 = class {
  constructor(e17, t19, i11, s15) {
    this._textures = e17, this._techniques = t19, this.materialChanged = i11, this.requestRender = s15, this._id2glMaterialRef = new t4();
  }
  dispose() {
  ...
  release(e17, r10) {
    ...
    null != i11 && (i11.unref(), i11.referenced || (r2(i11.glMaterial), this._id2glMaterialRef.delete(r10, e17.id)));
  }
  _ownMaterial(t19) {
...
var a12 = class {
  constructor(r10, i11) {
    this.rctx = r10, this.lastFrameCamera = new it(), this.output = n8.Color, this.renderOccludedMask = o14, this.bind = new o13(i11), this.bind.alignPixelEnabled = true;
  }
};
var o14 = p3.Occlude | p3.OccludeAndTransparent | p3.OccludeAndTransparentStencil;
...
r([m()], i10.prototype, "_projectionMatrix", void 0), r([m({ readOnly: true })], i10.prototype, "projectionMatrix", null), i10 = r([a("esri.views.3d.webgl-engine.lib.CascadeCamera")], i10);
...
var q2 = class {
  constructor() {
    this.camera = new i10(), this.lightMat = e3();
  }
};
var G4 = class {
  constructor() {
...
var X2 = class {
  constructor(t19, s15) {
    this._fbos = t19, this._viewingMode = s15, this._enabled = false, this._snapshots = new Array(), this._textureHeight = 0, this._numCascades = 1, this.settings = new G4(), this._projectionView = e3(), this._projectionViewInverse = e3(), this._modelViewLight = e3(), this._cascadeDistances = [0, 0, 0, 0, 0], this._usedCascadeDistances = n6(), this._cascades = [new q2(), new q2(), new q2(), new q2()], this._lastOrigin = null, this._maxTextureWidth = Math.min(has("esri-mobile") ? 4096 : 16384, t19.rctx.parameters.maxTextureSize);
  }
  dispose() {
  ...
  set maxCascades(s15) {
    this.settings.maxNumCascadesHighQuality = r4(Math.floor(s15), 1, 4);
  }
  get maxCascades() {
  ...
  _computeTextureHeight(t19, s15, e17) {
    const i11 = Math.min(window.devicePixelRatio, s15) / t19.pixelRatio, a15 = e17 ? this.settings.textureSizeModHighQuality : this.settings.textureSizeModLowQuality, r10 = n10(Math.floor(Math.max(t19.fullWidth, t19.fullHeight) * i11 * a15)), h7 = Math.min(this._maxTextureWidth, this._numCascades * r10);
    return i4(h7 / this._numCascades);
  }
  _ensureFbo() {
    var _a, _b, _c, _d, _e;
  ...
  _setupMatrices(t19, s15) {
    ...
    const e17 = this._viewingMode === l3.Global ? t19.eye : o3(et, 0, 0, 1);
  ...
  _computeCascadeDistances(t19, e17, i11) {
    ...
    this._numCascades = Math.min(1 + Math.floor(u4(e17 / t19, 4)), a15);
...
function gt(t19, s15, e17, i11, a15, r10, h7, o16) {
  ...
  e5(ct, nt[n19], t19[n19 + 4]);
  const l10 = ct[0];
  let M4, C6;
  ct[0] = -ct[1], ct[1] = l10, e5(lt, ot, ht), j(lt, ct) < 0 && x(ct, ct), _(ct, ct, lt, e17), v2(ct, ct), M4 = C6 = j(e5(dt, t19[0], ht), ct);
  for (let d7 = 1; d7 < 8; ++d7) {
    const s16 = j(e5(dt, t19[d7], ht), ct);
    s16 < M4 ? M4 = s16 : s16 > C6 && (C6 = s16);
  }
  r5(i11, ht), l(dt, ct, M4 - s15), u2(i11, i11, dt);
  let j3 = -1, T3 = 1, y4 = 0, D2 = 0;
  for (let d7 = 0; d7 < 8; ++d7) {
    e5(mt, t19[d7], i11), v2(mt, mt);
  ...
  const H3 = f2(i11, t19[D2], _t, u2(dt, _t, ft), 1, a15), v3 = f2(i11, t19[y4], _t, dt, 1, r10), S3 = f2(i11, t19[y4], ut, u2(dt, ut, ft), 1, h7), R2 = f2(i11, t19[D2], ut, dt, 1, o16);
...
var xt = n7();
function bt(t19, s15) {
  return o5(xt, t19[s15], t19[s15 + 3]), xt;
}
var wt = n7();
var Mt = e4();
function Ct(t19, s15, e17, i11, a15) {
  e5(wt, e17, i11), l(wt, wt, 0.5), Mt[0] = wt[0], Mt[1] = wt[1], Mt[2] = 0, Mt[3] = wt[1], Mt[4] = -wt[0], Mt[5] = 0, Mt[6] = wt[0] * wt[0] + wt[1] * wt[1], Mt[7] = wt[0] * wt[1] - wt[1] * wt[0], Mt[8] = 1, Mt[pt(0, 2)] = -j(bt(Mt, 0), t19), Mt[pt(1, 2)] = -j(bt(Mt, 1), t19);
...
var t16 = class extends l5 {
  constructor(o16, i11) {
    super(o16, i11, new t5(m3, () => import("./TextureOnly.glsl-LLSO7KOW.js")));
  }
  initializePipeline(e17) {
    return e17.hasAlpha ? B2({ blending: c4, colorWrite: g }) : B2({ colorWrite: g });
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/lib/TextureTechniqueConfiguration.js
var r8 = class extends a6 {
  constructor() {
    super(...arguments), this.hasAlpha = false;
  }
};
r([i7()], r8.prototype, "hasAlpha", void 0);

// node_modules/@arcgis/core/views/3d/webgl-engine/shaders/OverlayCompositingTechnique.js
var s13 = class extends l5 {
  constructor(r10, s15) {
    super(r10, s15, new t5(m4, () => import("./OverlayCompositing.glsl-P5QW6OMW.js")));
  }
};
...
var $2 = class extends u5 {
  constructor(e17) {
    super(e17), this._overlays = null, this._renderTargets = null, this._overlayParameters = new d4(), this.hasHighlights = false, this._hasWater = false, this._renderers = /* @__PURE__ */ new Map(), this._sortedDrapeSourceRenderersDirty = false, this._sortedRenderers = new r3(), this._passParameters = new a9(), this._materials = null, this._screenToWorldRatio = 1, this._localOriginFactory = null, this.unloadedMemory = 0, this.ignoresMemoryFactor = false, this._camera = new it(), this.events = new i(), this.longitudeCyclical = null, this.produces = /* @__PURE__ */ new Map([[A3.DRAPED_MATERIAL, (e18) => e18 !== n8.Highlight || this.hasHighlights], [A3.DRAPED_WATER, () => this._hasWater]]), this._hasTargetWithoutRasterImage = false, this._hasDrapedFeatureSource = false, this._hasDrapedRasterSource = false;
  }
  initialize() {
    ...
    }, P), e17.resourceController.scheduler.registerTask(g2.STAGE, this)]), this._materials = new s12(i11, this._techniques, () => {
    ...
    d7.near = 1, d7.far = 1e4, d7.relativeElevation = null, l10.slot = A3.DRAPED_MATERIAL, l10.mainDepth = null, l10.camera = d7, l10.oitPass = o6.NONE, l10.updateLighting([new i6(i2())], 0, 0, e15.Immediate);
  }
  destroy() {
    this._renderers.forEach((e17) => e17.destroy()), this._renderers.clear(), this._passParameters.texture = r2(this._passParameters.texture), this.disposeOverlays();
  }
  get _bindParameters() {
  ...
  processSyncDrapeSources() {
    this._processDrapeSources(C3, (e17) => e17.updatePolicy === C4.SYNC);
  }
  get isEmpty() {
    return !t6.OVERLAY_DRAW_DEBUG_TEXTURE && !n2(this._renderers, (e17) => !e17.isEmpty);
  }
  get hasWater() {
  ...
  renders(e17) {
    if (t6.OVERLAY_DRAW_DEBUG_TEXTURE && e17 !== o9.Occluded && e17 !== o9.Highlight) return true;
  ...
  updateAnimation(e17) {
    let r10 = false;
    return this._renderers.forEach((t19) => r10 = t19.updateAnimation(e17) || r10), r10 && this.parent.requestRender(a4.BACKGROUND), r10;
  }
  ...
  precompileShaders(e17) {
    if (this._renderTargets) {
      ...
      for (const e18 of this._renderTargets.targets) {
        ...
        this._renderContext.output = r10, this._bindParameters.slot = r10 === n8.Normal ? A3.DRAPED_WATER : A3.DRAPED_MATERIAL, e18.content === o9.Occluded && (this._renderContext.renderOccludedMask = se), this._sortedRenderers.forAll(({ drapeSource: r11, renderer: t19 }) => {
  ...
  _drawTarget(e17, r10) {
    ...
    if (t6.OVERLAY_DRAW_DEBUG_TEXTURE && r10.content !== o9.Occluded && r10.content !== o9.Highlight) {
  ...
  _renderAllGeometry(e17, r10) {
    ...
    this._sortedRenderers.forAll(({ drapeSource: i11, renderer: n19 }) => {
      ...
      const { fullOpacity: o16 } = i11, a15 = null != o16 && o16 < 1 && r10.output === n8.Color && this._bindTemporaryFBO();
  ...
  _ensureDebugPatternResources(e17, r10) {
    if (o3(this._passParameters.color, r10[0], r10[1], r10[2]), this._passParameters.texture) return;
...
var te = -2;
var se = p3.OccludeAndTransparent;
var ie = new r8();
ie.hasAlpha = true;
...
var g4 = class {
  constructor(r10, i11 = {}) {
    this.geometry = r10, this.screenToWorldRatio = 1, this._transformation = e3(), this._shaderTransformation = null, this._boundingSphere = null, this.id = e(), this.layerUid = i11.layerUid, this.graphicUid = i11.graphicUid, this.castShadow = i11.castShadow ?? false, i11.objectShaderTransformation && this.objectShaderTransformationChanged(i11.objectShaderTransformation);
  }
  get transformation() {
  ...
  objectShaderTransformationChanged(t19) {
    null == t19 ? this._shaderTransformation = null : (this._shaderTransformation ?? (this._shaderTransformation = e3()), c(this._shaderTransformation, t19, this.geometry.transformation)), this._boundingSphere = null;
  }
  get boundingSphere() {
    return this.boundingInfo ? (null == this._boundingSphere && (this._boundingSphere ?? (this._boundingSphere = E3()), E(U(this._boundingSphere), this.boundingInfo.center, this.shaderTransformation), this._boundingSphere[3] = this.boundingInfo.radius * m2(this.shaderTransformation)), this._boundingSphere) : C2;
  }
  get material() {
...
function b3(t19, e17, r10 = null) {
  ...
  return h6(e17, o16, l10), j2(e17, o16, l10), T(e17, o16, l10), D(e17, o16, l10), w4(e17, o16, l10), y3(e17, o16, l10), E7(e17, o16, i11), new f3(t19, o16, n19, e10.Line, r10);
}
function g5(t19, e17) {
  ...
  e17.push([e7.POSITION, new t3(l10, a15, 3, n19)]);
}
function h6(t19, e17, r10) {
  if (null != t19.attributeData.colorFeature) return;
  const n19 = t19.attributeData.color;
  e17.push([e7.COLOR, new t3(n19 ?? N, r10, 4)]);
}
function T(t19, e17, r10) {
  t19.attributeData.normal && e17.push([e7.NORMAL, new t3(t19.attributeData.normal, r10, 3)]);
}
function D(t19, e17, r10) {
  null != t19.attributeData.colorFeature && e17.push([e7.COLORFEATUREATTRIBUTE, new t3([t19.attributeData.colorFeature], r10, 1, true)]);
}
function j2(t19, e17, r10) {
  null == t19.attributeData.sizeFeature && e17.push([e7.SIZE, new t3([t19.attributeData.size ?? 1], r10, 1, true)]);
}
function w4(t19, e17, r10) {
  null != t19.attributeData.sizeFeature && e17.push([e7.SIZEFEATUREATTRIBUTE, new t3([t19.attributeData.sizeFeature], r10, 1, true)]);
}
function y3(t19, e17, r10) {
  null != t19.attributeData.opacityFeature && e17.push([e7.OPACITYFEATUREATTRIBUTE, new t3([t19.attributeData.opacityFeature], r10, 1, true)]);
}
function E7(r10, o16, u8) {
  if (null == r10.overlayInfo || r10.overlayInfo.renderCoordsHelper.viewingMode !== l3.Global || !r10.overlayInfo.spatialReference.isGeographic) return;
  const p6 = t2(u8.length), f9 = s(r10.overlayInfo.spatialReference);
  for (let t19 = 0; t19 < p6.length; t19 += 3) h(u8, t19, p6, t19, f9);
  const b4 = u8.length / 3, g6 = n9(b4 + 1);
  let h7 = I3, T3 = F3, D2 = 0, j3 = 0;
  o5(h7, p6[j3++], p6[j3++]), j3++, g6[0] = 0;
  for (let n19 = 1; n19 < b4 + 1; ++n19) n19 === b4 && (j3 = 0), o5(T3, p6[j3++], p6[j3++]), j3++, D2 += G(h7, T3), g6[n19] = D2, [h7, T3] = [T3, h7];
  o16.push([e7.DISTANCETOSTART, new t3(g6, o16[0][1].indices, 1, true)]);
}
function A4(t19) {
...
function p5(o16, t19, s15, p6) {
  const l10 = "polygon" === o16.type ? p.CCW_IS_HOLE : p.NONE, a15 = "polygon" === o16.type ? o16.rings : o16.paths, { position: u8, outlines: f9 } = a3(a15, !!o16.hasZ, l10, o16.spatialReference), m8 = t2(u8.length), g6 = u7(u8, o16.spatialReference, 0, m8, 0, u8, 0, u8.length / 3, t19, s15, p6), y4 = null != g6;
  return { lines: y4 ? c10(f9, u8, m8) : [], projectionSuccess: y4, sampledElevation: g6 };
}
function l9(e17, t19) {
  const i11 = "polygon" === e17.type ? p.CCW_IS_HOLE : p.NONE, p6 = "polygon" === e17.type ? e17.rings : e17.paths, { position: l10, outlines: a15 } = a3(p6, false, i11), u8 = o2(l10, e17.spatialReference, 0, l10, t19, 0);
...
var e16 = class extends n11 {
  intersect(r10, e17, i11, s15, o16, n19) {
    return p4(r10, i11, s15, o16, void 0, n19);
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/shaders/ColorMaterialTechnique.js
var S2 = class extends l5 {
  constructor(e17, r10) {
    super(e17, r10, new t5(m5, () => import("./ColorMaterial.glsl-GCUOCHWB.js")));
  }
  _createPipeline(e17, s15) {
    ...
    return B2({ blending: u3(d7) && h7 ? a5(i11) : null, culling: f4(O3), depthTest: S3 ? null : { func: f5(i11) }, depthWrite: l4(e17), drawBuffers: d7 === n8.Depth ? { buffers: [f.NONE] } : i5(i11, d7), colorWrite: g, stencilWrite: _5 ? e12 : null, stencilTest: _5 ? s15 ? o7 : f7 : null, polygonOffset: y4 || N3 ? w5 ? T2 : null : N2(x3) });
  }
  initializePipeline(e17) {
...
r([i7({ count: e6.COUNT })], a14.prototype, "cullFace", void 0), r([i7()], a14.prototype, "hasVertexColors", void 0), r([i7()], a14.prototype, "transparent", void 0), r([i7()], a14.prototype, "discardInvisibleFragments", void 0), r([i7()], a14.prototype, "polygonOffset", void 0), r([i7()], a14.prototype, "enableOffset", void 0), r([i7()], a14.prototype, "writeDepth", void 0), r([i7()], a14.prototype, "hasOccludees", void 0), r([i7()], a14.prototype, "terrainDepthTest", void 0), r([i7()], a14.prototype, "cullAboveTerrain", void 0), r([i7()], a14.prototype, "objectAndLayerIdColorInstanced", void 0), r([i7()], a14.prototype, "vvColor", void 0), r([i7()], a14.prototype, "draped", void 0);

// node_modules/@arcgis/core/views/3d/webgl-engine/materials/ColorMaterial.js
var A5 = class extends e16 {
  constructor(t19) {
    super(t19, P3), this._configuration = new a14(), this.supportsEdges = true, this.produces = /* @__PURE__ */ new Map([[A3.OPAQUE_MATERIAL, (t20) => this._isOpaqueMaterialPass(t20)], [A3.OPAQUE_MATERIAL_WITHOUT_NORMALS, (t20) => this._isOpaqueNoSSAODepthPass(t20)], [A3.TRANSPARENT_MATERIAL, (t20) => l2(t20) && this._transparent && this.parameters.writeDepth], [A3.TRANSPARENT_MATERIAL_WITHOUT_NORMALS, (t20) => S(t20) && this._transparent && this.parameters.writeDepth], [A3.TRANSPARENT_MATERIAL_WITHOUT_DEPTH, (t20) => l2(t20) && this._transparent && !this.parameters.writeDepth], [A3.DRAPED_MATERIAL, (t20) => e8(t20)]]);
  }
  getConfiguration(t19, r10) {
    return this._configuration.output = t19, this._configuration.cullFace = this.parameters.cullFace, this._configuration.hasVertexColors = this.parameters.hasVertexColors && !this.parameters.vvColor, this._configuration.hasSlicePlane = this.parameters.hasSlicePlane, this._configuration.transparent = this._transparent, this._configuration.discardInvisibleFragments = this._transparent && !this._isOpaquePass(t19) && this.parameters.discardInvisibleFragments, this._configuration.polygonOffset = this.parameters.polygonOffset, this._configuration.writeDepth = this.parameters.writeDepth, this._configuration.hasOccludees = r10.hasOccludees, this._configuration.oitPass = r10.oitPass, this._configuration.enableOffset = r10.camera.relativeElevation < A2, this._configuration.terrainDepthTest = r10.terrainDepthTest && u3(t19), this._configuration.cullAboveTerrain = r10.cullAboveTerrain, this._configuration.vvColor = !!this.parameters.vvColor, this._configuration.draped = this.parameters.draped, this._configuration;
  }
  get visible() {
  ...
  _isOpaqueMaterialPass(t19) {
    return t19 === n8.Highlight || l2(t19) && !this._transparent;
  }
  ...
  createBufferWriter() {
    const t19 = H2().vec3f(e7.POSITION);
    return e9() && t19.vec4u8(e7.OBJECTANDLAYERIDCOLOR), this.parameters.vvColor ? t19.f32(e7.COLORFEATUREATTRIBUTE) : t19.vec4u8(e7.COLOR), new f6(t19);
  }
};
var d6 = class extends e11 {
  beginSlot(t19) {
...
var P3 = class extends t7 {
  constructor() {
    super(...arguments), this.color = s3, this.forceTransparentMode = false, this.writeDepth = true, this.hasVertexColors = false, this.polygonOffset = false, this.hasSlicePlane = false, this.cullFace = e6.None, this.draped = false, this.discardInvisibleFragments = false;
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/materials/DefaultLayouts.js
var t18 = H2().vec3f(e7.POSITION);
var f8 = H2().vec3f(e7.POSITION).vec2f(e7.UV0);
var r9 = H2().vec3f(e7.POSITION).vec4u8(e7.COLOR);
var I5 = H2().vec3f(e7.POSITION).vec2f(e7.UV0).vec4u8(e7.OBJECTANDLAYERIDCOLOR);
...
//# sourceMappingURL=chunk-NNHMCU2Q.js.map
