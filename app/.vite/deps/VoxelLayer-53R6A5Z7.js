...
function b3(r5) {
  s4(f3, r5), A(f3, f3);
  const a11 = Math.atan2(f3[1], f3[0]), s8 = b2(e3(), h2, -a11);
  Q(f3, f3, s8);
...
r([m({ type: Boolean, json: { write: true } })], m2.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], m2.prototype, "label", void 0), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a6.normalize(a2(o3), 0, true))], m2.prototype, "orientation", null), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a6.normalize(a2(o3), 0, true))], m2.prototype, "tilt", null), r([m({ type: [Number], json: { write: { isRequired: true } } })], m2.prototype, "normal", void 0), r([m({ type: [Number], json: { write: { isRequired: true } } })], m2.prototype, "point", void 0), m2 = r([a3("esri.layers.voxel.VoxelSlice")], m2);
var c3 = m2;
...
r([m({ type: Boolean, json: { default: true, write: true } })], d3.prototype, "enabled", void 0), r([m({ type: String, json: { origins: { service: { read: f }, "web-scene": { write: { isRequired: true } } }, write: true } }), v({ origins: ["web-scene"], type: "resource", prefix: "sections", compress: true })], d3.prototype, "href", void 0), r([m({ type: x, json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "id", void 0), r([m({ type: String, json: { write: true } })], d3.prototype, "label", void 0), r([m({ type: Number, clonable: false, readOnly: true, range: { min: 0, max: 360 } })], d3.prototype, "orientation", null), r([m({ type: Number, clonable: false, readOnly: true, range: { min: 0, max: 360 } })], d3.prototype, "tilt", null), r([m({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "normal", void 0), r([m({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "point", void 0), r([m({ type: [x], json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "sizeInPixel", void 0), r([m({ type: [c3], json: { write: true } })], d3.prototype, "slices", void 0), r([m({ type: x, json: { default: 0, write: true } })], d3.prototype, "timeId", void 0), r([m({ type: x, json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "variableId", void 0), d3 = r([a3("esri.layers.voxel.VoxelSection")], d3);
var u5 = d3;
...
r([m({ type: h, json: { type: [x], write: { enabled: true, isRequired: true } } })], l4.prototype, "color", void 0), r([m({ type: Number, json: { write: { enabled: true, isRequired: true } } })], l4.prototype, "value", void 0), r([m({ type: Boolean, json: { default: true, write: true } })], l4.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], l4.prototype, "label", void 0), r([m({ type: Boolean, json: { default: false, write: true } })], l4.prototype, "colorLocked", void 0), l4 = r([a3("esri.layers.voxel.VoxelIsosurface")], l4);
var a7 = l4;
...
r([m({ type: h, json: { type: [x], write: { enabled: true, isRequired: true } } })], c4.prototype, "color", void 0), r([m({ type: Number, json: { write: { enabled: true, isRequired: true } } })], c4.prototype, "position", void 0), c4 = r([a3("esri.layers.voxel.VoxelColorStop")], c4);
var l5 = c4;
...
r([m({ type: Boolean, json: { default: false, write: true } })], p8.prototype, "enabled", void 0), r([m({ type: [Number], json: { write: { isRequired: true } } })], p8.prototype, "range", void 0), p8 = r([a3("esri.layers.voxel.VoxelRangeFilter")], p8);
var a8 = p8;
...
var y4 = class extends a5.ClonableMixin(S) {
  ...
  get rasterizedTransferFunction() {
    ...
    for (let c7 = 0; c7 < this._colorMapSize; ++c7) {
      ...
      }), f6.a = r2(1 - o(a11.a, h3.a, s9) / 255, 0, 1), o3.push(f6);
    }
    return o3;
  }
...
r([m({ type: ["linear", "nearest"], json: { write: true } })], y4.prototype, "interpolation", void 0), r([m({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], y4.prototype, "stretchRange", void 0), r([m({ type: V.ofType(l5), json: { write: { enabled: true, overridePolicy() {
  return { enabled: !!this.colorStops && this.colorStops.length > 0 };
} } } })], y4.prototype, "colorStops", null), r([m({ type: V.ofType(i4), json: { read: { source: "alphaStops" }, write: { enabled: true, target: "alphaStops", overridePolicy() {
  return { enabled: !!this.opacityStops && this.opacityStops.length > 0 };
} } } })], y4.prototype, "opacityStops", null), r([m({ type: a8, json: { write: true } })], y4.prototype, "rangeFilter", void 0), r([m({ type: [h], clonable: false, json: { read: false } })], y4.prototype, "rasterizedTransferFunction", null), y4 = r([a3("esri.layers.voxel.VoxelTransferFunctionStyle")], y4);
var g3 = y4;
var S3 = ["r", "g", "b"];
...
r([m({ type: h, json: { type: [x], write: { enabled: true, isRequired: true } } })], l6.prototype, "color", void 0), r([m({ type: x, json: { write: { enabled: true, isRequired: true } } })], l6.prototype, "value", void 0), r([m({ type: Boolean, json: { default: true, write: true } })], l6.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], l6.prototype, "label", void 0), l6 = r([a3("esri.layers.voxel.VoxelUniqueValue")], l6);
var a9 = l6;
...
} } } })], c5.prototype, "transferFunction", void 0), r([m({ type: V.ofType(a9), json: { write: { enabled: true, overridePolicy() {
  return { enabled: !!this.uniqueValues && this.uniqueValues.length > 0 };
} } } })], c5.prototype, "uniqueValues", void 0), r([m({ type: V.ofType(a7), json: { write: { enabled: true, overridePolicy() {
...
r([m({ type: p10, json: { write: true } })], a10.prototype, "irregularSpacing", void 0), r([m({ type: Boolean, json: { write: true } })], a10.prototype, "isPositiveUp", void 0), r([m({ type: Boolean, json: { write: true } })], a10.prototype, "isWrappedDateLine", void 0), r([m({ type: String, json: { write: true } })], a10.prototype, "label", void 0), r([m({ type: String, json: { write: true } })], a10.prototype, "name", void 0), r([m({ type: String, json: { write: true } })], a10.prototype, "quantity", void 0), r([m({ type: p11, json: { write: true } })], a10.prototype, "regularSpacing", void 0), r([m({ type: Number, json: { write: true } })], a10.prototype, "size", void 0), r([m({ type: String, json: { write: true } })], a10.prototype, "unit", void 0), r([m({ type: Boolean, json: { read: false } })], a10.prototype, "isRegular", null), a10 = r([a3("esri.layers.voxel.VoxelDimension")], a10);
var p12 = a10;
...
var f5 = class extends S {
  ...
  computeVoxelSpaceLocation(e4) {
    ...
    c2(i5, i5, this.originInLayerSpace3D), i3(i5, i5, this.voxelSizeInLayerSpaceSigned);
  ...
  computeLayerSpaceLocation(e4) {
    ...
    const i5 = u(e4);
    if (e2(i5, i5, this.voxelSizeInLayerSpaceSigned), u3(i5, i5, this.originInLayerSpace3D), "xyt" === this.volumeType) return new j({ x: i5[0], y: i5[1], spatialReference: this.spatialReference });
...
r([m({ type: Number, json: { write: { enabled: true, isRequired: true } } })], f5.prototype, "id", void 0), r([m({ type: [p12], json: { write: { enabled: true, isRequired: true } } })], f5.prototype, "dimensions", void 0), r([m({ type: g, json: { read: { enabled: false } } })], f5.prototype, "spatialReference", void 0), r([m({ type: Number, json: { read: false } })], f5.prototype, "zDimension", null), r([m({ type: [Boolean], json: { read: false } })], f5.prototype, "isValid", null), r([m({ type: [Number], json: { read: false } })], f5.prototype, "originInLayerSpace3D", null), r([m({ type: [Number], json: { read: false } })], f5.prototype, "voxelSizeInLayerSpaceSigned", null), r([m({ type: ["xyz", "xyzt", "xyt"], json: { read: { enabled: false } } })], f5.prototype, "volumeType", null), r([m({ type: [Number], json: { read: false } })], f5.prototype, "sizeInVoxels", null), r([m({ type: [Date], json: { read: false, write: false } })], f5.prototype, "timeStops", null), f5 = r([a3("esri.layers.voxel.VoxelVolume")], f5);
var S4 = f5;
...
r([m({ type: Boolean, json: { default: true, write: true } })], m3.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], m3.prototype, "label", void 0), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a6.normalize(a2(o3), 0, true))], m3.prototype, "orientation", null), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a6.normalize(a2(o3), 0, true))], m3.prototype, "tilt", null), r([m({ type: [Number], json: { write: { isRequired: true } } })], m3.prototype, "normal", void 0), r([m({ type: [Number], json: { write: { isRequired: true } } })], m3.prototype, "point", void 0), m3 = r([a3("esri.layers.voxel.VoxelDynamicSection")], m3);
var c6 = m3;
...
var z = class extends R(l(b(j2(t(S2(e(i2(f2)))))))) {
  constructor(e4) {
  ...
  load(e4) {
    const t6 = null != e4 ? e4.signal : null, i5 = this.loadFromPortal({ supportedTypes: ["Scene Service"] }, e4).catch(a4).then(() => this._fetchService(t6)).then(() => this.serviceRoot = this.url);
...
r([m({ type: ["Voxel"] })], z.prototype, "operationalLayerType", void 0), r([m(d)], z.prototype, "legendEnabled", void 0), r([m({ json: { write: true } })], z.prototype, "title", void 0), r([m(y3)], z.prototype, "url", null), r([m({ type: V.ofType(u5), json: { origins: { "web-scene": { name: "layerDefinition.sections", write: true } } } })], z.prototype, "sections", void 0), r([m({ type: x, json: { origins: { "web-scene": { name: "layerDefinition.style.currentVariableId", write: { enabled: true, isRequired: true, ignoreOrigin: true } }, service: { name: "style.currentVariableId" } } } })], z.prototype, "currentVariableId", void 0), r([m({ type: V.ofType(d5), json: { origins: { "web-scene": { name: "layerDefinition.style.volumeStyles", write: true }, service: { name: "style.volumeStyles" } } } })], z.prototype, "volumeStyles", void 0), r([m({ type: ["volume", "surfaces"], json: { origins: { "web-scene": { name: "layerDefinition.style.renderMode", write: true }, service: { name: "style.renderMode" } } } })], z.prototype, "renderMode", void 0), r([m({ type: V.ofType(f4), json: { origins: { "web-scene": { name: "layerDefinition.style.variableStyles", write: true }, service: { name: "style.variableStyles" } } } })], z.prototype, "variableStyles", void 0), r([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSlices", write: true }, service: { name: "style.enableSlices" } } } })], z.prototype, "enableSlices", void 0), r([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSections", write: true }, service: { name: "style.enableSections" } } } })], z.prototype, "enableSections", void 0), r([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableDynamicSections", write: true }, service: { name: "style.enableDynamicSections" } } } })], z.prototype, "enableDynamicSections", void 0), r([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableIsosurfaces", write: true }, service: { name: "style.enableIsosurfaces" } } } })], z.prototype, "enableIsosurfaces", void 0), r([m({ type: p4, json: { origins: { "web-scene": { name: "layerDefinition.style.shading", write: true }, service: { name: "style.shading" } } } })], z.prototype, "shading", void 0), r([m({ type: ["show", "hide"] })], z.prototype, "listMode", void 0), r([m({ type: Number, range: { min: 0, max: 1 }, nonNullable: true, json: { read: false, write: false, origins: { "web-scene": { read: false, write: false }, "portal-item": { read: false, write: false } } } })], z.prototype, "opacity", void 0), r([m({ type: V.ofType(p6) })], z.prototype, "variables", void 0), r([m({ type: V.ofType(S4) })], z.prototype, "volumes", void 0), r([m({ type: d4 })], z.prototype, "index", void 0), r([m({ type: Number, json: { name: "layerDefinition.minScale", write: true, origins: { service: { read: false, write: false } } } })], z.prototype, "minScale", void 0), r([m({ type: Number, json: { name: "layerDefinition.maxScale", write: true, origins: { service: { read: false, write: false } } } })], z.prototype, "maxScale", void 0), r([m({ json: { read: false }, readOnly: true })], z.prototype, "type", void 0), r([m({ readOnly: true, json: { name: "serviceVersion" } })], z.prototype, "version", void 0), r([o2("service", "version")], z.prototype, "readVersion", null), r([m({ type: w })], z.prototype, "fullExtent", void 0), r([o2("service", "fullExtent", ["fullExtent"])], z.prototype, "readFullExtent", null), r([m({ readOnly: true, clonable: false, json: { read: false } })], z.prototype, "fields", null), r([m({ readOnly: true })], z.prototype, "fieldsIndex", null), r([m({ type: Boolean, json: { name: "disablePopup", read: { reader: (e4, t6) => !t6.disablePopup }, write: { enabled: true, ignoreOrigin: true, writer(e4, t6, i5) {
  t6[i5] = !e4;
} }, origins: { "portal-item": { default: true }, "web-scene": { default: true } } } })], z.prototype, "popupEnabled", void 0), r([m({ type: q, json: { name: "popupInfo", write: true } })], z.prototype, "popupTemplate", void 0), r([m({ readOnly: true, json: { read: false } })], z.prototype, "defaultPopupTemplate", null), r([m({ type: d2, readOnly: true, json: { read: false } })], z.prototype, "timeInfo", null), r([m({ type: p, json: { read: false } })], z.prototype, "timeExtent", void 0), r([m({ type: l2, json: { read: false } })], z.prototype, "timeOffset", void 0), r([m({ type: Boolean, nonNullable: true, json: { origins: { "web-scene": { name: "timeAnimation", write: true }, service: { read: false } } } })], z.prototype, "useViewTime", void 0), z = r([a3("esri.layers.VoxelLayer")], z);
var _ = z;
export {
  _ as default
};
//# sourceMappingURL=VoxelLayer-53R6A5Z7.js.map
