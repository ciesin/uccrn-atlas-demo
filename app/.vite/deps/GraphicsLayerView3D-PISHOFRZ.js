...
import {
  a as a5
} from "./chunk-36DO6Z4S.js";
import "./chunk-PYT5YQEQ.js";
import {
  S,
  T as T2,
  b as b8
} from "./chunk-IHQU26IU.js";
import "./chunk-C2G4BZ5N.js";
import {
  c as c4
...
var l10 = (l16) => {
  let n10 = class extends l16 {
    ...
    async _validateHeightModelInfo() {
      ...
      this.addHandles(e(() => o13.abort())), await w2(() => {
        var _a;
...
async function l11(l16, m10, d14, j5, u19) {
  ...
  s2(u19);
  const S4 = [], b15 = /* @__PURE__ */ new Set(), z2 = /* @__PURE__ */ new Set(), E4 = new o10(), P6 = e10(0, 0, 0, g2.WGS84), U3 = new R3(), C6 = n3();
  ...
  for (const { objectId: e25, points: o13 } of x6) {
    ...
    E4.setFromElevationInfo(s8(i14, I2)), E4.updateFeatureExpressionInfoContext(R4, t14.graphic, m10);
    for (const { x: e26, y: n10, z: a14 } of o13) P6.x = e26, P6.y = n10, P6.z = a14 ?? 0, await i3(P6, C6, F5, 0, { signal: u19 }), c5(C6, v8, E4, g10, U3), S4.push(U3.z);
  }
...
function a10(r15, e25) {
  const s18 = { ...g3, ...e25, cimFallbackEnabled: true };
  return l12(r15, u5(r15.symbol, s18).error);
}
function u10(e25, s18) {
  var _a;
  const t14 = { ...g3, ...s18, cimFallbackEnabled: true }, a14 = (_a = e25.uniqueValueInfos) == null ? void 0 : _a.map((r15) => u5(r15.symbol, t14).error).filter(G), u19 = u5(e25.defaultSymbol, t14);
  return u19.error && (a14 == null ? void 0 : a14.unshift(u19.error)), l12(e25, a14);
}
function i7(e25, s18) {
  const t14 = { ...g3, ...s18, cimFallbackEnabled: true }, a14 = e25.classBreakInfos.map((r15) => u5(r15.symbol, t14).error).filter(G), u19 = u5(e25.defaultSymbol, t14);
...
var l14 = class extends g {
  constructor(t14) {
    super(t14), this.events = new i(), this.hasZ = null, this.hasM = null, this.objectIdField = null, this.featureAdapter = { getAttribute: (t15, e25) => "graphic" in t15 ? t15.graphic.attributes[e25] : e14.getAttribute(t15, e25), getAttributes: (t15) => "graphic" in t15 ? t15.graphic.attributes : e14.getAttributes(t15), getObjectId: (t15) => "graphic" in t15 ? R2(t15.graphic, this.objectIdField) ?? void 0 : e14.getObjectId(t15), getGeometry: (t15) => "graphic" in t15 ? t15.getAsOptimizedGeometry(this.hasZ, this.hasM) : e14.getGeometry(t15), getCentroid: (t15, e25) => {
      if ("graphic" in t15) {
        let r15 = null;
      ...
      return e14.getCentroid(t15, e25);
    }, cloneWithGeometry: (t15, e25) => "graphic" in t15 ? new s5(e25, this.featureAdapter.getAttributes(t15), null, this.featureAdapter.getObjectId(t15)) : e14.cloneWithGeometry(t15, e25) };
  }
...
var s12 = class {
  ...
  get spherical() {
    return this.stage.view.state.viewingMode === l6.Global;
  }
...
var p9 = class extends l7 {
  constructor(r15, o13) {
    super(r15, o13, new t6(b10, () => import("./LineCallout.glsl-BQ5NHYAK.js")));
  }
  initializePipeline(e25) {
    const { hudDepth: r15, terrainDepthTest: t14 } = e25, p13 = { func: t14 ? O2.ALWAYS : O2.LESS };
...
r([i5()], i9.prototype, "screenCenterOffsetUnitsEnabled", void 0), r([i5()], i9.prototype, "occlusionTestEnabled", void 0), r([i5()], i9.prototype, "hasVerticalOffset", void 0), r([i5()], i9.prototype, "hasScreenSizePerspective", void 0), r([i5()], i9.prototype, "hudDepth", void 0), r([i5()], i9.prototype, "hudDepthAlignStart", void 0), r([i5()], i9.prototype, "terrainDepthTest", void 0);

// node_modules/@arcgis/core/views/3d/webgl-engine/materials/LineCalloutMaterial.js
var d11 = class extends n8 {
  constructor(e25, t14) {
    super(e25, T3), this.produces = /* @__PURE__ */ new Map([[A5.LINE_CALLOUTS, (e26) => u8(e26)], [A5.LINE_CALLOUTS_HUD_DEPTH, (e26) => u8(e26)]]), this._configuration = new i9(t14), this._uniqueMaterialIdentifier = O4(this.parameters);
  }
  passParameters() {
    return this.parameters;
  }
  getConfiguration(e25, t14) {
    const r15 = t14.slot === A5.LINE_CALLOUTS_HUD_DEPTH;
...
var L6 = H2().vec3f(e11.POSITION).vec3f(e11.NORMAL).vec2f(e11.UV0).vec4f(e11.CENTEROFFSETANDDISTANCE);
var _3 = [t5(0, 0), t5(1, 0), t5(0, 1), t5(1, 0), t5(1, 1), t5(0, 1)];
var b11 = class {
  constructor() {
    this.vertexBufferLayout = L6;
  }
  elementCount(e25) {
    return 6 * e25.get(e11.POSITION).indices.length;
  }
  write(e25, t14, r15, i14, s18, n10) {
    b6(r15.get(e11.POSITION), e25, s18.position, n10, 6), O3(r15.get(e11.NORMAL), t14, s18.normal, n10, 6), p6(r15.get(e11.CENTEROFFSETANDDISTANCE), s18.centerOffsetAndDistance, n10, 6);
...
var U = class _U extends y4 {
  ...
  get _materialParameters() {
    ...
    if (s18.color) {
      const t14 = h2.toUnitRGBA(s18.color);
      t14[3] *= this._getLayerOpacity(), r15.color = t14;
    } else r15.color = s6;
    if (r15.size = u3(s18.size || 0), n10.verticalOffset) {
      const { screenLength: e25, minWorldLength: i14, maxWorldLength: s19 } = n10.verticalOffset;
      r15.verticalOffset = { screenLength: u3(e25), minWorldLength: i14 || 0, maxWorldLength: null != s19 ? s19 : 1 / 0 };
    }
    r15.borderColor = null != ((_a = s18.border) == null ? void 0 : _a.color) ? h2.toUnitRGBA(s18.border.color) : null;
  ...
  createGraphics3DGraphic(e25) {
    ...
    if ("point-3d" === n10.type && n10.symbolLayers.every((e26) => "text" === e26.type && !l4(e26))) return null;
    const a14 = b8(r15.geometry);
  ...
  _createAs3DShape(e25, t14, r15, i14) {
    const n10 = this._context.layer.uid, s18 = this._context.stage.renderView.getObjectAndLayerIdColor({ graphicUid: i14, layerUid: n10 }), o13 = this._getOrCreateMaterial(r15), l16 = new f3(o13.material, w5(r15), null, e12.Point, s18), c9 = a9(this._context, e25, l16, t14, i14);
...
function w5(e25) {
  ...
  return [[e11.POSITION, i14], [e11.NORMAL, new t4([0, 0, 1], G2, 3, true)], [e11.CENTEROFFSETANDDISTANCE, n10]];
}
...
function e20(o13, l16) {
  if (!o3(o13)) return t9().error("Graphics3DCalloutSymbolLayerFactory#make", `symbol of type '${o13.type}' does not support callouts`), null;
...
var A8 = class {
  ...
  computeAttachmentOrigin() {
    ...
    return e25.render.num > 1 && g4(e25.render.origin, e25.render.origin, 1 / e25.render.num), e25.draped.num > 1 && l5(e25.draped.origin, e25.draped.origin, 1 / e25.draped.num), e25;
  }
...
var p11 = class extends r9 {
  ...
  async doLoad(e25) {
    ...
    const i14 = [], { make: n10 } = await import("./Graphics3DSymbolLayerFactory-HLKZBIAG.js");
...
var l15 = class extends r9 {
  ...
  async doLoad(r15) {
    const s18 = await this.symbol.fetchSymbol({ signal: r15, acceptedFormats: e8 });
...
var y5 = class extends i.EventedMixin(g) {
  ...
  initialize() {
    this._renderCoordsHelper = this.view.renderCoordsHelper, this._intersectLayers = [this.stageLayer], this._intersector = T2(this.view.state.viewingMode), this._intersector.options.store = e15.MIN;
  ...
  _objectChanged(e25) {
    ...
    this._expandExtent(t14, o13, s18, j4), w4(j4, b12.extent), this._zmin = Math.min(this._zmin, j4[2]), this._zmax = Math.max(this._zmax, j4[5]), b12.spatialReference = t14, this.emit("elevation-change", b12), s7(r15.min, o13), s7(r15.max, s18);
  }
...
var We = Te = class extends g {
  ...
  _getConvertedSymbol(e25) {
    ...
    const r15 = u5(t14, { geometryType: ((_a = this.layer) == null ? void 0 : _a.geometryType) ?? void 0, retainId: true, hasLabelingContext: this._hasLabelingContext(t14), cimFallbackEnabled: true }), s18 = r15.symbol || null;
  ...
  async _initializeAsync() {
    ...
    if (this.symbolCreationContext.featureExpressionInfoContext = await a7(r15, this._viewSpatialReference, e25, n2.getLogger(this)), s2(e25), this.symbolCreationContext.screenSizePerspectiveEnabled = t14.screenSizePerspectiveEnabled && !!this.layer.screenSizePerspectiveEnabled, this.symbolCreationContext.slicePlaneEnabled = !!this.owner.slicePlaneEnabled, this.symbolCreationContext.physicalBasedRenderingEnabled = !!((_b = this.owner.view.qualitySettings) == null ? void 0 : _b.physicallyBasedRenderingEnabled), this.symbolCreationContext.skipHighSymbolLods = !!((_d = (_c = this.owner.view.qualitySettings) == null ? void 0 : _c.graphics3D) == null ? void 0 : _d.skipHighSymbolLods), "drapeSourceType" in this.owner) {
      ...
      this.symbolCreationContext.drapeSourceRenderer = t14.basemapTerrain.overlayManager.registerGeometryDrapeSource(e26), this.addHandles(e(() => t14.basemapTerrain.overlayManager.unregisterDrapeSource(e26)));
    }
    ...
    }, A2)]), this._frameTaskHandle = t14.resourceController.scheduler.registerTask(g6.GRAPHICS_CORE, this), this.layer && "featureReduction" in this.layer && this.addHandles(d2(() => this.layer.featureReduction, () => {
      var _a2;
  ...
  runTask(e25) {
    if (this._dataUpdateQueue.runTask(e25), this._updateQueue.runTask(e25), this._applyPendingUpdates(e25), this.notifyChange("running"), this.running || this.notifyChange("dataUpdating"), this.notifyChange("updatingRemaining"), !e25.hasProgressed) return o7;
  }
  ...
  _graphicUpdateSymbolHandler(e25, t14) {
    ...
    if (r15.prepareSymbolPatch(l16), !d6(l16.diff)) return void this._recreateGraphic(i14);
  ...
  _addGraphic(e25, t14, i14) {
    var _a;
    if (this._graphicsWithoutSymbol.set(e25.uid, e25), null == (t14 == null ? void 0 : t14.symbol) || !b7(e25)) return;
  ...
  _hasLabelingContext(e25) {
    if (e25 instanceof b2 || e25 instanceof m3) {
  ...
  _hasValidSymbolCreationContext(e25) {
    return !(e25 instanceof b2 && !this._hasLabelingContext(e25)) || (n2.getLogger(this).error("LabelSymbol3D is only valid as part of a LabelClass. Using LabelSymbol3D as a renderer symbol is not supported."), false);
  }
  _getRenderingInfo(e25, t14) {
    ...
    if (this.owner.getRenderingInfo && (this.getRenderingInfoWithoutRenderer || null != this.currentRenderer)) s18 = this.owner.getRenderingInfo(r15, this.currentRenderer, this._arcadeOnDemand);
      ...
      const e26 = r15.symbol || d5(r15.geometry);
      s18 = new r6(null, e26);
    }
  ...
  _createGraphics3DSymbol(e25, t14) {
    ...
    if (null != t14 && "backgroundFillSymbol" in t14 && t14.backgroundFillSymbol) {
      const e26 = u5(t14.backgroundFillSymbol, { ignoreDrivers: true });
  ...
  getOrCreateGraphics3DSymbol(e25, t14) {
    ...
    if (void 0 === i14) {
      ...
      i14 = null != r15 ? r15 : e25 instanceof u6 ? new l15(e25, (e26) => this._dataUpdateQueue.push(e26, null), (e26) => this._createGraphics3DSymbol(e26, t14)) : this._createGraphics3DSymbol(e25, t14), this._symbols.set(e25.id, i14), this._symbolMaterials = null;
    }
  ...
  _createGraphics3DGraphic(e25, t14) {
    ...
    if (r15.isDraped && this._graphicsDrapedUids.add(i14.uid), r15.centroid = null, null != i14.geometry && "point" !== i14.geometry.type && (r15.centroid = b8(i14.geometry, this._viewSpatialReference)), this._updateUserVisibility(r15), null != this._scaleVisibility && this._scaleVisibility.updateVisibility(r15), null != this._filterVisibility) {
  ...
  async rendererChange(e25) {
    if (this._rendererChangeAbortController = e2(this._rendererChangeAbortController), e25 !== this.currentRenderer) if (this._validateRenderer(e25), null == e25 && this._currentRendererChange(null, false), s11(e25)) if (e25 == null ? void 0 : e25.arcadeRequired) {
  ...
  _applyRendererDiff(e25, t14, i14) {
    ...
    if (t14 instanceof A3 && i14 instanceof A3 && this._applyUniqueValueRendererDiff(e25, t14, i14) && 0 === Object.keys(e25.diff).length) return true;
  ...
  setClippingExtent(e25, t14) {
    ...
    return u16(e25, r15, t14) ? this.symbolCreationContext.clippingExtent = B(u4(), r15) : this.symbolCreationContext.clippingExtent = null, !C2(this.symbolCreationContext.clippingExtent, i14);
  }
...
function d13(t14) {
  return null == t14 ? g6.ELEVATION_ALIGNMENT : "relative-to-scene" === t14 ? g6.ELEVATION_ALIGNMENT_SCENE : g6.ELEVATION_ALIGNMENT;
}
...
function h6(r15, n10, i14, f4) {
  const l16 = b13;
  return r15 ? (i14 && f4 && (l16.len = p4(n10, i14)), s7(l16.dir, r15)) : f4 ? (l16.len = p4(n10, i14), c2(l16.dir, i14, n10), g4(l16.dir, l16.dir, 1 / l16.len)) : (c2(l16.dir, i14, n10), A4(l16.dir, l16.dir)), l16;
}
function v6(r15, t14, i14) {
  const e25 = P2(O(r15), i14.dir), c9 = -V2(r15, t14);
...
var N2 = class {
  ...
  update(t14, e25, i14, r15 = true) {
    ...
    this._toRenderBoundingExtent(t14, e25, i14), u7(this._center.origin, a14[0].origin, a14[2].origin), g4(this._center.origin, this._center.origin, 0.5), this._renderCoordsHelper.worldUpAtPosition(this._center.origin, this._center.direction), r15 || g4(this._center.direction, this._center.direction, -1);
  ...
  isVisibleInFrustum(t14, e25, i14 = false) {
    ...
    for (let n10 = 0; n10 < this._extent.length; n10++) {
      ...
      if (t14.intersectsLineSegment(b5(e26.origin, e26.cap.next, k2), e26.cap.direction)) return true;
    }
  ...
  _toRenderBoundingExtentGlobal(t14, r15, n10) {
    const o13 = 5;
    p2(t14, V3), V3[2] = n10, m4(r15, V3, v7, this._renderCoordsHelper.spatialReference), h(I, v7), q(L7);
...
var u17 = class extends g {
  ...
  initialize() {
    ...
    this.addHandles([t14.on("resize", () => this._viewChange()), d2(() => t14.state.camera, () => this._viewChange(), C), o13.registerTask(g6.FRUSTUM_VISIBILITY, this), d2(() => n10.visibleElevationBounds, () => this._elevationBoundsChange())]), "local" === t14.viewingMode ? this._isVisibleBelowSurface = true : this.addHandles([d2(() => {
      var _a, _b, _c;
...
var c7 = class extends i12 {
  constructor(s18) {
    super(s18), this.stateType = t3.MaskOccludee, this.objectStateSet = new i11();
  }
};
var h9 = class extends i12 {
  constructor(e25, i14) {
    super(i14), this.highlightName = e25, this.stateType = t3.Highlight, this.objectStateSet = new h8(e25);
  }
};
...
var u18 = class extends g {
  ...
  initialize() {
    ...
    this.addHandles(e25.registerTask(g6.SCALE_VISIBILITY, this)), this._updatingHandles.add(() => this.layer.effectiveScaleRange, () => this.layerMinMaxScaleChangeHandler());
  }
  destroy() {
  ...
  _visibleAtLayerScale(e25) {
    ...
    return !this.layerScaleEnabled || i4(e25, i14.minScale || 0, i14.maxScale || 0);
  }
  _visibleAtLabelScale(e25, i14) {
    return i4(e25, i14.minScale || 0, i14.maxScale || 0);
  }
  _graphicScale(e25) {
    let i14;
...
var x5 = class extends g {
  constructor(i14) {
    super(i14), this.type = "graphics-3d", this.graphicsCore = null, this.drapeSourceType = e16.Features, this.scaleVisibilityEnabled = false, this.frustumVisibilityEnabled = false, this._suspendResumeExtent = null, this._updatingHandles = new h4();
  }
  initialize() {
  ...
  highlight(i14, e25) {
    ...
    if (!r15) return O5;
    if (i14 instanceof b4) return O5;
    const s18 = e24(i14);
    if (0 === s18.length) return O5;
    if (s18[0] instanceof b3) {
...
//# sourceMappingURL=GraphicsLayerView3D-PISHOFRZ.js.map
