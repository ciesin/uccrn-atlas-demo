import {
  g as g6,
  l as l5
} from "./chunk-F66ZIDCZ.js";
import "./chunk-KVJG2Z2D.js";
import {
  i as i6,
  n as n14,
  o as o10,
...
var l6 = { widthBreakpoint: { getValue(e28) {
  const i25 = e28.viewSize[0], s31 = e28.breakpoints, a25 = this.values;
  return i25 <= s31.xsmall ? a25.xsmall : i25 <= s31.small ? a25.small : i25 <= s31.medium ? a25.medium : i25 <= s31.large ? a25.large : a25.xlarge;
  ...
  const i25 = e28.viewSize[1], s31 = e28.breakpoints, a25 = this.values;
  return i25 <= s31.xsmall ? a25.xsmall : i25 <= s31.small ? a25.small : i25 <= s31.medium ? a25.medium : i25 <= s31.large ? a25.large : a25.xlarge;
  ...
  const i25 = e28.viewSize, s31 = i25[0], a25 = i25[1], t30 = this.values;
  return a25 >= s31 ? t30.portrait : t30.landscape;
...
var o11 = (o29) => {
  let g16 = class extends o29 {
    ...
    _updateClassNames() {
      ...
      let a25, t30 = false;
      for (a25 in l6) {
        const i25 = this[a25], r33 = l6[a25].getValue({ viewSize: this.size, breakpoints: this.breakpoints });
        i25 !== r33 && (t30 = true, this[a25] = r33, m10(a25, i25).forEach((e29) => s31.push(e29)), m10(a25, r33).forEach((i26) => e28.push(i26)));
      }
    ...
    _removeActiveClassNames() {
      ...
      if (!e28) return;
      let i25;
      for (i25 in l6) m10(i25, this[i25]).forEach((i26) => e28.classList.remove(i26));
    }
  };
  return r([m()], g16.prototype, "breakpoints", null), r([m()], g16.prototype, "orientation", void 0), r([m()], g16.prototype, "widthBreakpoint", void 0), r([m()], g16.prototype, "heightBreakpoint", void 0), g16 = r([a2("esri.views.BreakpointsOwner")], g16), g16;
};

// node_modules/@arcgis/core/views/overlay/ViewOverlay.js
var a5 = class extends g2 {
  constructor() {
...
r([m({ readOnly: true })], a5.prototype, "surface", void 0), r([m({ readOnly: true })], a5.prototype, "items", void 0), r([m({ readOnly: true })], a5.prototype, "needsRender", null), r([m({ readOnly: true })], a5.prototype, "_watchUpdatingTracking", void 0), r([m({ readOnly: true })], a5.prototype, "updating", null), a5 = r([a2("esri.views.overlay.ViewOverlay")], a5);
var c10 = a5;
...
var C2 = (p30) => {
  let C7 = class extends p30 {
    ...
    set container(e28) {
      const i25 = this._get("container"), r33 = n7(e28);
      ...
      const p31 = new c10();
      l20.appendChild(p31.surface), this._set("overlay", p31), this.addHandles(d3(() => p31.needsRender, (e29) => {
...
var w4 = (a25) => {
  let w10 = class extends a25 {
    constructor() {
      super(...arguments), this._popupSetupTask = null, this.popup = {}, this.popupEnabled = true;
    }
    initialize() {
      this.addHandles([d3(() => [this.ui, this.popup], ([p30, e28], t30) => {
        const o29 = "popup", i25 = "manual";
        if (t30) {
          const [p31, e29] = t30;
          p31 && m12(e29) && (e29.view = null, f5(e29) && p31.remove(e29, o29));
        }
        p30 && m12(e28) && (e28.view = this, f5(e28) && p30.add(e28, { key: o29, position: i25, internal: true }));
      }, P), this.on("click", (p30) => {
        this.popup && this.popupEnabled && ("mouse" !== p30.pointerType || 0 === p30.button) && (m12(this.popup) ? this.popup.viewModel.handleViewClick(p30) : p30.async(async () => {
          await this.setupPopup(), m12(this.popup) && !this.destroyed && this.ready && this.popupEnabled && this.popup.viewModel.handleViewClick(p30);
        }));
      }, _2.WIDGET)]), w(() => this.ready && this.popupEnabled && !this.updating).then(() => {
        import("./Popup-XABXDQ7I.js");
      });
    }
    destroy() {
    ...
    async openPopup(p30) {
      if (m12(this.popup)) return this.popup.open(p30);
      try {
    ...
    closePopup() {
      var _a;
      (_a = this._popupSetupTask) == null ? void 0 : _a.abort(), m12(this.popup) && this.popup.close();
    }
    ...
    async setupPopup() {
      var _a;
      if ((_a = this._popupSetupTask) == null ? void 0 : _a.abort(), this.popup && !m12(this.popup)) return this._popupSetupTask = d2(async (p30) => {
        const { default: e28 } = await import("./Popup-XABXDQ7I.js");
        if (s4(p30), !this.popup || m12(this.popup)) return;
        const t30 = this.popup;
        delete t30.open, delete t30.close, this.popup = new e28(t30);
      }), this._popupSetupTask.promise;
    }
    async _popupHitsToFeatures({ location: p30, hits: e28 }, t30) {
      const o29 = [], i25 = [];
      let a26 = false;
      const u17 = E(t30, has("popup-view-fetch-timeout") ?? P3), n33 = (p31) => {
        const e29 = new y3(p31);
        return i25.push(e29), o29.push(e29.promise), e29;
      }, c29 = (p31) => {
        const e29 = i25.at(-1);
        return e29 && e29.layerView === p31 && !a26 ? e29 : n33(p31);
      };
      for (const s31 of e28) if ("graphic" in s31) {
        c29(s31.layerView).graphics.push(s31.graphic), a26 = false;
      } else o29.push(s31.layerView.fetchPopupFeaturesAtLocation(s31.mapPoint, u17)), a26 = true;
      i25.map((p31) => p31.resolve(u17));
      const h21 = g(o29).then((p31) => p31.filter((p32) => !!p32).flat());
      return { pendingFeatures: o29, allGraphicsPromise: h21, location: p30 };
    }
    async _getPopupHits(p30, e28) {
      const { hits: t30, location: o29 } = await this.popupHitTest(p30);
      s4(e28);
      const s31 = [];
      for (const i25 of t30) if ("graphic" in i25) {
        if (this._isValidPopupGraphic(i25.graphic, e28)) {
          const p31 = this._isValidPopupGraphicsLayerView(i25.layerView) ? i25.layerView : void 0;
          s31.push({ graphic: i25.graphic, layerView: p31 });
        }
    ...
    _isValidPopupGraphic(p30, e28) {
      return p30 && !!p30.getEffectivePopupTemplate(e28 == null ? void 0 : e28.defaultPopupTemplateEnabled);
    }
  ...
  return r([m()], w10.prototype, "popup", void 0), r([m()], w10.prototype, "popupEnabled", void 0), w10 = r([a2("esri.views.PopupView")], w10), w10;
};
var y3 = class {
  constructor(p30) {
    this.layerView = p30, this._resolver = L(), this.graphics = [];
  }
  get promise() {
  ...
  resolve(p30) {
    ...
    let i25;
    return e28.fetchPopupFeaturesFromGraphics(t30, p30).catch((p31) => (i25 = p31, null)).then((p31) => {
      p31 ? o29.resolve(p31) : o29.reject(i25);
    }), o29.promise;
  }
};
var P3 = 5e3;
...
t13 = r([a2("esri.support.AnalysesCollection")], t13);
...
r([m({ constructOnly: true })], n16.prototype, "view", void 0), r([m({ readOnly: true })], n16.prototype, "baseLayerViews", void 0), r([m({ readOnly: true })], n16.prototype, "referenceLayerViews", void 0), r([m({ readOnly: true })], n16.prototype, "suspended", null), r([m({ type: Boolean, readOnly: true })], n16.prototype, "updating", null), n16 = r([a2("esri.views.BasemapView")], n16);
var p8 = n16;
...
var I3 = class extends g2 {
  constructor(e28) {
    super(e28), this._layerLayerViewInfoMap = /* @__PURE__ */ new Map(), this._recyclingInfoMap = /* @__PURE__ */ new Map(), this._watchUpdatingTracking = new h6(), this.supportsGround = true, this._preloadLayerViewModules = () => {
      ...
      const r33 = /* @__PURE__ */ new Set(), i25 = [], t30 = this.view.ready, s31 = (e30) => {
        if (null != e30) {
          for (const a26 of e30) if (a26) {
            r33.add(a26);
            const e31 = this._layerLayerViewInfoMap.get(a26);
            e31 && t30 ? e31.start() : e31 || this._recyclingInfoMap.has(a26) || i25.push(a26), "layers" in a26 && a26.layers && s31(a26.layers);
          }
        }
      };
      ...
      const a25 = [(_a = e29 == null ? void 0 : e29.ground) == null ? void 0 : _a.layers, (_b = e29 == null ? void 0 : e29.basemap) == null ? void 0 : _b.baseLayers, (_c = e29 == null ? void 0 : e29.basemap) == null ? void 0 : _c.referenceLayers, e29 == null ? void 0 : e29.layers].filter((e30) => !!e30);
      r33.forEach((e30) => "layers" in e30 && a25.push(e30.layers)), this.addHandles(a25.map((e30) => this._watchUpdatingTracking.addOnCollectionChange(() => e30, this._reschedule)), "collection-change"), this._workPromise.resolve(), this._workPromise = null;
    };
  }
  initialize() {
    this.addHandles([v(() => {
  ...
  _populateLayerViewsOwners(e28, r33, i25) {
    ...
    for (const s31 of e28) {
      ...
      const a25 = e29.layerView;
      a25.layer = s31, a25.parent = i25, r33.at(t30) !== a25 && r33.splice(t30, 0, a25), "layers" in s31 && L4(a25) && this._populateLayerViewsOwners(s31.layers, a25.layerViews, a25), t30 += 1;
    }
...
r([m()], I3.prototype, "_workPromise", void 0), r([m({ readOnly: true })], I3.prototype, "_watchUpdatingTracking", void 0), r([m({ readOnly: true })], I3.prototype, "_layersToLayerViews", null), r([m({ readOnly: true })], I3.prototype, "_rootCollectionNames", null), r([m()], I3.prototype, "layerViewImporter", void 0), r([m()], I3.prototype, "supportsGround", void 0), r([m({ readOnly: true })], I3.prototype, "updating", null), r([m({ readOnly: true })], I3.prototype, "updatingRemaining", null), r([m({ constructOnly: true })], I3.prototype, "view", void 0), I3 = r([a2("esri.views.LayerViewManager")], I3);
var j4 = I3;
function C3(e28) {
...
r([m({ type: Number })], i7.prototype, "factor", void 0), r([m({ nonNullable: true })], i7.prototype, "offset", void 0), r([m()], i7.prototype, "position", void 0), r([m({ type: Number, range: { min: 0 } })], i7.prototype, "size", void 0), r([m()], i7.prototype, "maskUrl", void 0), r([m()], i7.prototype, "maskEnabled", void 0), r([m()], i7.prototype, "overlayUrl", void 0), r([m()], i7.prototype, "overlayEnabled", void 0), r([m({ readOnly: true })], i7.prototype, "version", null), r([m({ type: Boolean })], i7.prototype, "visible", void 0), i7 = r([a2("esri.views.Magnifier")], i7);
var p9 = i7;
...
var y4 = class extends i.EventedAccessor {
  constructor(e28) {
    super(e28), this._selectionMap = new s5(), this._sources = new V(), this._trashCan = [], this._layerEditHandles = new V(), this._vizTaskId = 0, this.showHighlight = true, this.highlightName = "default";
  }
  initialize() {
    ...
    this.view.when().then(() => {
      this.view.map && (this.view.map.allLayers.flatten((e29) => "sublayers" in e29 && e29.sublayers ? e29.sublayers : null).forEach((t30) => {
        (e13(t30) && !c5(t30) || l2(t30)) && e28.add(t30);
      }), this.sources = e28);
    });
  }
  destroy() {
...
var M5 = async (e28, t30, s31 = {}) => {
  ...
  if (w5(e28)) {
    const o29 = e28;
    i25 = void 0 === o29 ? null : await o29.queryFeatures(new b3({ ...s31, objectIds: t30 })).then((t31) => ({ data: t31, layer: e28.layer }));
  } else {
    const o29 = e28;
    i25 = void 0 === o29 ? null : await o29.queryFeatures(new b3({ ...s31, objectIds: t30 })).then((e29) => ({ data: e29, layer: o29 }));
  }
  return i25;
};
var b4 = y4;
...
var p10 = class extends a3.ClonableMixin(g2) {
  constructor(o29) {
    super(o29), this.accentColor = new h4([255, 127, 0]), this.textColor = new h4([255, 255, 255]);
  }
};
r([m({ type: h4, nonNullable: true })], p10.prototype, "accentColor", void 0), r([m({ type: h4, nonNullable: true })], p10.prototype, "textColor", void 0), p10 = r([a2("esri.views.Theme")], p10);
var l7 = p10;
...
var c11 = class {
  ...
  on(e28, n33, a25, r33) {
    ...
    let c29, u17;
    Array.isArray(n33) ? u17 = n33 : (c29 = n33, u17 = []), "function" == typeof a25 ? c29 = a25 : r33 = a25, r33 = null != r33 ? r33 : _2.DEFAULT;
...
var l8 = class extends t11 {
  constructor(t30, e28, n33, a25) {
    super(true), this._latestDragStart = void 0, this.view = t30;
    for (const i25 of e28) switch (i25) {
      case "click":
        this.registerIncoming("click", n33, (e29) => a25(d6(t30, e29)));
        break;
      case "double-click":
        this.registerIncoming("double-click", n33, (e29) => a25(g9(t30, e29)));
        break;
      case "immediate-click":
        this.registerIncoming("immediate-click", n33, (e29) => a25(y5(t30, e29)));
        break;
      case "immediate-double-click":
        this.registerIncoming("immediate-double-click", n33, (e29) => a25(v6(t30, e29)));
        break;
      case "hold":
        this.registerIncoming("hold", n33, (e29) => a25(h9(t30, e29)));
        break;
      case "drag":
        ...
        break;
      case "key-down":
        this.registerIncoming("key-down", n33, (t31) => a25(f6(t31)));
        break;
      case "key-up":
        this.registerIncoming("key-up", n33, (t31) => a25(k2(t31)));
        break;
      case "pointer-down":
        this.registerIncoming("pointer-down", n33, (t31) => a25(I4(t31, "pointer-down")));
        break;
      case "pointer-move":
        this.registerIncoming("pointer-move", n33, (t31) => a25(I4(t31, "pointer-move")));
        break;
      case "pointer-up":
        this.registerIncoming("pointer-up", n33, (t31) => a25(I4(t31, "pointer-up")));
        break;
      case "pointer-drag":
        this.registerIncoming("pointer-drag", n33, (t31) => a25(D(t31)));
        break;
      case "mouse-wheel":
        this.registerIncoming("mouse-wheel", n33, (t31) => a25(P4(t31)));
        break;
      case "pointer-enter":
        this.registerIncoming("pointer-enter", n33, (t31) => a25(I4(t31, "pointer-enter")));
        break;
      case "pointer-leave":
        this.registerIncoming("pointer-leave", n33, (t31) => a25(I4(t31, "pointer-leave")));
        break;
      case "gamepad":
  ...
  _wrapDrag(t30) {
    const n33 = t30.data, { x: a25, y: i25 } = n33.center, { action: r33, pointerType: o29, button: s31 } = n33;
    if ("start" === r33 && (this._latestDragStart = n33), !this._latestDragStart) return;
    const p30 = n33.pointer.native, c29 = n33.buttons, { cancelable: l20, timestamp: u17 } = t30, m24 = { x: this._latestDragStart.center.x, y: this._latestDragStart.center.y };
    return "end" === r33 && (this._latestDragStart = void 0), { type: "drag", action: r33, x: a25, y: i25, origin: m24, pointerType: o29, button: s31, buttons: c29, radius: n33.radius, angle: M(n33.angle), native: p30, timestamp: u17, cancelable: l20, stopPropagation: () => t30.stopPropagation(), async: (e28) => t30.async(e28), preventDefault: () => t30.preventDefault() };
  }
};
function u7(t30) {
...
function d6(t30, e28) {
  const { pointerType: a25, button: i25, buttons: r33, x: o29, y: s31, native: p30, eventId: c29 } = e28.data, { cancelable: l20, timestamp: u17 } = e28;
  return { type: "click", pointerType: a25, button: i25, buttons: r33, x: o29, y: s31, native: p30, timestamp: u17, screenPoint: c4(o29, s31), mapPoint: b5(t30, o29, s31), eventId: c29, cancelable: l20, stopPropagation: () => e28.stopPropagation(), async: (t31) => e28.async(t31), preventDefault: () => e28.preventDefault() };
}
function g9(t30, e28) {
  const { pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31, eventId: p30 } = e28.data, { cancelable: c29, timestamp: l20 } = e28;
  return { type: "double-click", pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31, timestamp: l20, mapPoint: b5(t30, r33, o29), eventId: p30, cancelable: c29, stopPropagation: () => e28.stopPropagation(), async: (t31) => e28.async(t31), preventDefault: () => e28.preventDefault() };
}
function y5(t30, e28) {
  const { pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31, eventId: p30 } = e28.data, c29 = s31.pointerId, { cancelable: l20, timestamp: u17 } = e28;
  return { type: "immediate-click", pointerId: c29, pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31, timestamp: u17, mapPoint: b5(t30, r33, o29), eventId: p30, cancelable: l20, stopPropagation: () => e28.stopPropagation(), async: (t31) => e28.async(t31), preventDefault: () => e28.preventDefault() };
}
function v6(t30, e28) {
  const { pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31, eventId: p30 } = e28.data, c29 = s31.pointerId, { cancelable: l20, timestamp: u17 } = e28;
  return { type: "immediate-double-click", pointerId: c29, pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31, timestamp: u17, mapPoint: b5(t30, r33, o29), eventId: p30, cancelable: l20, stopPropagation: () => e28.stopPropagation(), async: (t31) => e28.async(t31), preventDefault: () => e28.preventDefault() };
}
function h9(t30, e28) {
  const { pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31 } = e28.data, { cancelable: p30, timestamp: c29 } = e28;
  return { type: "hold", pointerType: n33, button: a25, buttons: i25, x: r33, y: o29, native: s31, timestamp: c29, mapPoint: b5(t30, r33, o29), cancelable: p30, stopPropagation: () => e28.stopPropagation(), async: (t31) => e28.async(t31), preventDefault: () => e28.preventDefault() };
}
function b5(t30, e28, a25) {
  return t30.toMap(c4(e28, a25), { exclude: [] });
}
function f6(t30) {
  const { key: e28, repeat: n33, native: a25 } = t30.data, { cancelable: i25, timestamp: r33 } = t30;
  return { type: "key-down", key: e28, repeat: n33, native: a25, timestamp: r33, cancelable: i25, stopPropagation: () => t30.stopPropagation(), async: (e29) => t30.async(e29), preventDefault: () => t30.preventDefault() };
}
function k2(t30) {
  const { key: e28, native: n33 } = t30.data, { cancelable: a25, timestamp: i25 } = t30;
  return { type: "key-up", key: e28, native: n33, timestamp: i25, cancelable: a25, stopPropagation: () => t30.stopPropagation(), async: (e29) => t30.async(e29), preventDefault: () => t30.preventDefault() };
}
function I4(t30, e28) {
  const { x: n33, y: a25, button: i25, buttons: r33, native: o29, eventId: s31 } = t30.data, p30 = o29.pointerId, c29 = o29.pointerType, { cancelable: l20, timestamp: u17 } = t30;
  return { type: e28, x: n33, y: a25, pointerId: p30, pointerType: c29, button: i25, buttons: r33, native: o29, timestamp: u17, eventId: s31, cancelable: l20, stopPropagation: () => t30.stopPropagation(), async: (e29) => t30.async(e29), preventDefault: () => t30.preventDefault() };
}
function D(t30) {
  const { x: e28, y: n33, buttons: a25, native: i25, eventId: r33 } = t30.data.currentEvent, { button: o29 } = t30.data.startEvent, s31 = t30.data.startEvent.native.pointerId, p30 = t30.data.startEvent.native.pointerType, c29 = t30.data.action, l20 = { x: t30.data.startEvent.x, y: t30.data.startEvent.y }, { cancelable: u17, timestamp: m24 } = t30;
  return { type: "pointer-drag", x: e28, y: n33, pointerId: s31, pointerType: p30, button: o29, buttons: a25, action: c29, origin: l20, native: i25, timestamp: m24, eventId: r33, cancelable: u17, stopPropagation: () => t30.stopPropagation(), async: (e29) => t30.async(e29), preventDefault: () => t30.preventDefault() };
}
function P4(t30) {
  const { cancelable: e28, data: n33, timestamp: a25 } = t30, { x: i25, y: r33, deltaY: o29, native: s31 } = n33;
  return { type: "mouse-wheel", x: i25, y: r33, deltaY: o29, native: s31, timestamp: a25, cancelable: e28, stopPropagation: () => t30.stopPropagation(), async: (e29) => t30.async(e29), preventDefault: () => t30.preventDefault() };
}
function _5(t30) {
  const { action: e28, state: n33, device: a25 } = t30.data, { cancelable: i25, timestamp: r33 } = t30, { buttons: o29, axes: s31 } = n33;
  return { type: "gamepad", device: a25, timestamp: r33, action: e28, buttons: o29, axes: s31, cancelable: i25, stopPropagation: () => t30.stopPropagation(), async: (e29) => t30.async(e29), preventDefault: () => t30.preventDefault() };
}
...
var i9 = class {
  ...
  handleInputEvent(e28, o29) {
    const a25 = () => e28.stopPropagation();
    switch (e28.type) {
      case "pointer-move":
        l9(e28.pointerType) && this._pointerLocations.set(e28.pointerId, { x: e28.x, y: e28.y, pointerType: e28.pointerType });
        break;
      case "drag":
        this._grabbedManipulators.size > 0 ? this._stopDrag = true : "start" === e28.action ? this._externallyDragging = true : "end" === e28.action && (this._externallyDragging = false), this._stopDrag && (a25(), "end" === e28.action && (this._stopDrag = false));
        break;
      case "pointer-down": {
        if (!p12(e28)) break;
      ...
      case "pointer-drag": {
        ...
        const l20 = n14(e28);
        l20.x = r6(l20.x, 0, o29.view.width), l20.y = r6(l20.y, 0, o29.view.height);
      ...
      case "immediate-click": {
        ...
        n33.events.emit("immediate-click", { screenPoint: t30, button: e28.button, pointerType: e28.pointerType, shiftKey: p30, stopPropagation: a25 }), c12(n33, a25);
        break;
      }
      case "click": {
        ...
        n33.events.emit(e28.type, { screenPoint: t30, button: e28.button, pointerType: e28.pointerType, shiftKey: l20 }), a25();
        break;
      }
      case "double-click": {
        ...
        if (null == n33 || !n33.interactive) break;
        const l20 = e28.native.shiftKey;
        n33.events.emit("double-click", { screenPoint: t30, button: e28.button, pointerType: e28.pointerType, shiftKey: l20, stopPropagation: a25 }), c12(n33, a25);
        break;
      }
      case "immediate-double-click": {
        const t30 = n14(e28), i25 = s15(t30, e28.pointerType, o29.forEachTool), n33 = null != i25 ? i25.manipulator : null;
        if (null == n33 || !n33.interactive) break;
        const l20 = e28.native.shiftKey;
        n33.events.emit("immediate-double-click", { screenPoint: t30, button: e28.button, pointerType: e28.pointerType, shiftKey: l20, stopPropagation: a25 }), "mouse" === e28.pointerType && c12(n33, a25);
        break;
      }
    }
  ...
  _updateFocusedManipulatorTools(t30) {
    const o29 = /* @__PURE__ */ new Set(), a25 = /* @__PURE__ */ new Set();
    this._grabbedManipulators.forEach(({ tool: e28 }) => {
      o29.add(e28);
    }), this._hoveredManipulators.forEach(({ tool: e28 }) => {
      a25.add(e28);
    }), t30((t31) => {
      t31.hasGrabbedManipulators = o29.has(t31), t31.hasHoveredManipulators = a25.has(t31);
  ...
  clearPointers(e28, { forEachTool: t30, setActiveTool: o29 }, a25 = true, r33) {
    const i25 = (t31, o30) => t31 === e28 && (null == r33 || r33 === o30);
    this._grabbedManipulators.forEach(({ tool: e29, manipulator: t31, pointerType: o30 }, a26) => {
      i25(e29, t31) && (this._grabbedManipulators.delete(a26), t31.grabbing = false, t31.events.emit("grab-changed", { action: "end", screenPoint: null, pointerType: o30 }));
    ...
    }), a25 && this._hoveredManipulators.forEach(({ tool: e29, manipulator: t31 }, o30) => {
  ...
  updateHoveredStateFromKnownPointers(e28) {
    this._pointerLocations.forEach((t30, a25) => {
      this._updateHoveredStateForPointerAtScreenPosition(c4(t30.x, t30.y), a25, t30.pointerType, e28);
    });
  }
  ...
  _updateHoveredStateForPointerAtScreenPosition(e28, t30, o29, a25) {
    var _a;
    let r33 = s15(e28, o29, a25);
    const i25 = (_a = this._hoveredManipulators.get(t30)) == null ? void 0 : _a.manipulator;
    null == r33 || r33.manipulator.interactive || (r33 = null), null != r33 && i25 === r33.manipulator || (null != i25 && (i25.hovering = false), null != r33 ? (r33.manipulator.hovering = true, this._hoveredManipulators.set(t30, r33)) : this._hoveredManipulators.delete(t30), this._onFocusChange(a25));
  }
...
r([m({ nonNullable: true, readOnly: true })], n19.prototype, "nativeIndex", void 0), r([m({ type: String, readOnly: true })], n19.prototype, "deviceType", null), r([m({ type: Number, readOnly: true })], n19.prototype, "axisThreshold", null), n19 = r([a2("esri.views.input.gamepad.GamepadInputDevice")], n19);
var o14 = n19;
...
r([m({ type: V.ofType(o14), readOnly: true })], p13.prototype, "devices", void 0), r([m({ type: ["document", "view", "none"] })], p13.prototype, "enabledFocusMode", void 0), p13 = r([a2("esri.views.input.gamepad.GamepadSettings")], p13);
var i11 = p13;
...
r([m({ readOnly: true })], p14.prototype, "gamepad", void 0), p14 = r([a2("esri.views.input.Input")], p14);
var a7 = p14;

// node_modules/@arcgis/core/views/navigation/NavigationActionMap.js
var s16 = () => m({ type: ["pan", "rotate", "zoom", "none"], nonNullable: true });
var a8 = class extends g2 {
  constructor(o29) {
    super(o29), this.dragPrimary = "pan", this.dragSecondary = "rotate", this.dragTertiary = "zoom", this.mouseWheel = "zoom";
  }
};
r([s16()], a8.prototype, "dragPrimary", void 0), r([s16()], a8.prototype, "dragSecondary", void 0), r([s16()], a8.prototype, "dragTertiary", void 0), r([m({ type: ["zoom", "none"], nonNullable: true })], a8.prototype, "mouseWheel", void 0), a8 = r([a2("esri.views.navigation.NavigationActionMap")], a8);
var p15 = a8;
...
async function c13(r33) {
  s18 || (s18 = import("./geometryServiceUtils-Y7DPQOXO.js").then((e28) => n20 = e28)), await s18, s4(r33);
}
async function p16(e28, s31, a25, m24) {
  if (!e28) return null;
  const l20 = e28.spatialReference;
  return k() || L2(l20, s31) ? O2(e28, s31) : n20 ? n20.projectGeometry(e28, s31, a25, m24) : (await Promise.race([c13(m24), K(m24)]), p16(e28, s31, a25, m24));
}
...
var d7 = class extends g2 {
  ...
  get _tileInfoTask() {
    ...
    let n33;
    const a25 = this._collectLayers([{ parent: e28 == null ? void 0 : e28.basemap, layers: (_b = e28 == null ? void 0 : e28.basemap) == null ? void 0 : _b.baseLayers }, { layers: e28 == null ? void 0 : e28.layers }], (e29) => {
      var _a2;
  ...
  get _extentCandidatesTask() {
    ...
    const e28 = [], t30 = this._collectLayers(this.mapCollections, (t31) => {
      const n33 = "fullExtents" in t31 && t31.fullExtents || (null != t31.fullExtent ? [t31.fullExtent] : []), a25 = this.requiresExtentInSpatialReference ? null : n33[0], s31 = n33.find((e29) => e29.spatialReference.equals(this.spatialReference)) ?? a25;
  ...
  get _extentTask() {
    ...
    return i25.extent.equals(this._projectExtentTask.input) && r33.equals(this._projectExtentTask.spatialReference) ? { extent: this._projectExtentTask.output, updating: null != this._projectExtentTask.task && !this._projectExtentTask.task.finished } : (null != this._projectExtentTask.task && (this._projectExtentTask.task = e3(this._projectExtentTask.task)), this._projectExtentTask = { input: i25.extent.clone(), output: null, spatialReference: r33.clone(), task: d2(async (e29) => {
      try {
  ...
  _narrowDownSpatialReferenceCandidates(e28, t30) {
    ...
    const n33 = new Array();
    for (const a25 of e28) for (const e29 of t30) {
      if (!a25.spatialReference.equals(e29.spatialReference)) continue;
      const t31 = h10(a25.viewingMode, e29.viewingMode);
      if (false !== t31) {
        n33.push({ spatialReference: a25.spatialReference, viewingMode: t31 });
        break;
      }
    }
  ...
  _getSupportedSpatialReferences(e28) {
    ...
    const n33 = [];
    for (const a25 of t30) {
      const t31 = this.getSpatialReferenceSupport(a25, e28);
      if (null != t31) {
        const e29 = t31.constraints ?? [{ spatialReference: a25, viewingMode: null }];
        for (const { spatialReference: t32, viewingMode: a26 } of e29) this.requiresExtentInSpatialReference && null != this.userSpatialReference && !t32.equals(this.userSpatialReference) || n33.push({ spatialReference: t32, viewingMode: a26 });
      }
    }
    return n33;
  }
  ...
  _collectLayers(e28, t30, n33 = () => true) {
    ...
    const a25 = new f8(n33, t30);
    for (const s31 of e28) if (this._collectCollection(s31, a25), a25.done || a25.preloading === this.sourcePreloadCount) break;
    return a25.updating;
  }
...
r([m()], t15.prototype, "featureTitleFields", void 0), r([m()], t15.prototype, "utilityNetworkFields", void 0), r([m()], t15.prototype, "globalIdField", void 0), t15 = r([a2("esri.views.support.RequiredFieldsOptions")], t15);
var i14 = t15;

// node_modules/@arcgis/core/views/View.js
var $;
var B = $ = class extends i.EventedMixin(p3.EsriPromiseMixin(g2)) {
  constructor(e28) {
    super(e28), this._userSpatialReference = null, this._cursor = null, this.handles = new r4(), this.updatingHandles = new h6(), this.allLayerViews = new n8({ getCollections: () => {
      var _a, _b, _c;
  ...
  set highlights(e28) {
    this._set("highlights", n9(e28, this._get("highlights"), V.ofType(u6)));
  }
  get interacting() {
  ...
  set map(e28) {
    e28 !== this._get("map") && ((e28 == null ? void 0 : e28.destroyed) && (n.getLogger(this).warn("#map", "The provided map is already destroyed", { map: e28 }), e28 = null), m4.isLoadable(e28) && e28.load().catch(() => {
  ...
  forceReadyCycle() {
    this.ready && (p2(() => this.destroyed || false === this.preconditionsReady, () => this._readyCycleForced = false, { once: true }), this._readyCycleForced = true);
  }
...
var W = G2 = class extends S2 {
  constructor(t30) {
    super(t30), this._viewpoint2D = { center: n11(), rotation: 0, scale: 0, spatialReference: void 0 }, this.center = [0, 0], this.extent = new w2(), this.id = 0, this.inverseTransform = e10(), this.resolution = 0, this.rotation = 0, this.scale = 0, this.transform = e10(), this.transformNoRotation = e10(), this.displayMat3 = e11(), this.displayViewMat3 = e11(), this.viewMat3 = e11(), this.viewMat2d = n13(), this.worldScreenWidth = 0, this.size = [0, 0];
  }
  set pixelRatio(t30) {
  ...
  wrapMapCoordinate(t30, i25) {
    ...
    let { xmin: a25, xmax: n33 } = o29;
    if (r33.isWrappable) {
      const t31 = mt(r33) / 2;
      a25 = Math.max(a25, s31 - t31), n33 = Math.min(n33, s31 + t31);
    }
    return (e28 < a25 || e28 > n33) && (t30[0] = P2(e28, s31, r33)), t30;
  }
  ...
  _update() {
    ...
    const R = o6(this.viewMat3), _10 = t8(c29[0] / 2, c29[1] / 2), b9 = t8(-c29[0] / 2, -c29[1] / 2), z4 = u4(o29);
...
r([m({ readOnly: true })], W.prototype, "id", void 0), r([m({ value: 1, json: { write: true } })], W.prototype, "pixelRatio", null), r([m({ json: { write: true } })], W.prototype, "size", null), r([m()], W.prototype, "spatialReference", void 0), r([m({ type: m3, json: { write: true } })], W.prototype, "viewpoint", null), r([m({ readOnly: true })], W.prototype, "visibleArea", null), W = G2 = r([a2("esri.views.2d.ViewState")], W);
var L5 = W;
...
r([m()], g11.prototype, "left", void 0), r([m()], g11.prototype, "top", void 0), r([m()], g11.prototype, "right", void 0), r([m()], g11.prototype, "bottom", void 0), g11 = l11 = r([a2("esri.views.2d.PaddedViewState.Padding")], g11);
var w6 = m14 = class extends L5 {
  constructor(...t30) {
    super(...t30), this.paddedViewState = new L5(), this._updateContent = (() => {
      ...
      return () => {
        ...
        o7(t31, i25.left + i25.right, i25.top + i25.bottom), e8(t31, e28, t31), r9(o29.size, t31);
  ...
  set viewpoint(t30) {
    if (t30) {
      ...
      const { targetGeometry: o29, rotation: s31, scale: r33 } = e28, { x: p30, y: d18, spatialReference: a25 } = o29, n33 = this._viewpoint2D;
      n33.center[0] = p30, n33.center[1] = d18, n33.rotation = s31, n33.scale = r33, n33.spatialReference = a25, this._update();
    }
  }
  clone() {
...
r([m()], w6.prototype, "paddedViewState", void 0), r([m({ type: g11 })], w6.prototype, "padding", null), r([m()], w6.prototype, "viewpoint", null), w6 = m14 = r([a2("esri.views.2d.PaddedViewState")], w6);
var f9 = w6;

// node_modules/@arcgis/core/views/2d/FrameTask.js
var h11 = class {
  constructor(a25) {
    this.view = a25, this._stationaryHandle = null, this._frameTaskHandle = null, this._updateParameters = null, this._updateRequested = false, this._scheduler = I2(), this._schedulerHandle = p2(() => this._scheduler.updating, () => this.requestFrame()), this.stationary = true, this.prepare = () => {
      var _a;
      ...
      const { allLayerViews: t30, graphicsView: a26, labelManager: s31, state: { id: i25 } } = this.view;
      t30 == null ? void 0 : t30.forEach(this._updateLayerView, this), null != s31 && (s31.lastUpdateId !== i25 && (s31.viewChange(), s31.lastUpdateId = i25), s31.updateRequested && s31.processUpdate(this._updateParameters)), null != a26 && (a26.lastUpdateId !== i25 && (a26.viewChange(), a26.lastUpdateId = i25), a26.updateRequested && a26.processUpdate(this._updateParameters)), (_b = this.view.graphicsTileStore) == null ? void 0 : _b.setViewState(this._updateParameters.state), this.view.animation ? this._scheduler.state = I.ANIMATING : this.view.interacting ? this._scheduler.state = I.INTERACTING : this._scheduler.state = I.IDLE;
  ...
  _updateLayerView(e28) {
    ...
    const t30 = this.view.state, a25 = e28.lastUpdateId;
    null != a25 && (this.stationary || e28.moving) || (e28.moving = true), a25 !== t30.id && e28.viewChange(), this.stationary && e28.moving && (e28.moving = false, e28.moveEnd()), e28.lastUpdateId = t30.id, e28.updateRequested && e28.processUpdate(this._updateParameters), "layerViews" in e28 && ((_a = e28.layerViews) == null ? void 0 : _a.forEach(this._updateLayerView, this));
  }
};

// node_modules/@arcgis/core/views/ViewAnimation.js
var p17 = class extends p3 {
  constructor(t30) {
...
r([m({ readOnly: true })], p17.prototype, "done", null), r([m({ readOnly: true, type: String })], p17.prototype, "state", void 0), r([m()], p17.prototype, "target", void 0), p17 = r([a2("esri.views.ViewAnimation")], p17), function(t30) {
...
var h12 = class extends g2 {
  ...
  async goTo(t30, e28) {
    ...
    const s31 = { ...e28, animate: (e28 == null ? void 0 : e28.animate) ?? !o8(), animationMode: (e28 == null ? void 0 : e28.animationMode) ?? "auto" }, { extent: a25, spatialReference: c29, size: m24, viewpoint: h21, constraints: g16, padding: w10, allLayerViews: d18 } = this.view, u17 = Y(t30, { extent: a25, spatialReference: c29, size: m24, viewpoint: h21, constraints: g16, padding: w10, allLayerViews: d18, pickClosestTarget: (e28 == null ? void 0 : e28.pickClosestTarget) ?? true });
  ...
  _gotoImmediate(t30, o29) {
    const e28 = this._gotoTask, r33 = this.view.animation, a25 = t30.then((t31) => {
...
r([m({ constructOnly: true })], h12.prototype, "view", void 0), h12 = r([a2("esri.views.2d.GoToManager")], h12);

// node_modules/@arcgis/core/geometry/support/near.js
function r17(r33, l20) {
  const { spatialReference: s31 } = l20, a25 = [l20.x, l20.y];
  let c29, m24, x3, f17;
  const p30 = [0, 0], u17 = i15(r33);
  for (let e28 = 0; e28 < u17.length; e28++) {
    const t30 = u17[e28];
    for (let r34 = 0; r34 < t30.length - 1; r34++) {
      s9(p30, a25, t30, r34);
      const i25 = m5(a25, p30);
      (null == c29 || i25 < c29) && (c29 = i25, m24 = [...p30], x3 = e28, f17 = r34);
    }
  }
...
var l12;
var p18 = l12 = class extends n3.NumericIdentifiableMixin(g2) {
  constructor(e28) {
...
r([m({ constructOnly: true })], p18.prototype, "geometry", void 0), r([m({ readOnly: true })], p18.prototype, "normalizedGeometry", null), r([m({ constructOnly: true })], p18.prototype, "spatialReference", void 0), p18 = l12 = r([a2("esri.views.2d.constraints.GeometryConstraint")], p18);

// node_modules/@arcgis/core/views/2d/constraints/RotationConstraint.js
var i16;
var n22 = i16 = class extends n3.NumericIdentifiableMixin(g2) {
  constructor() {
...
r([m()], n22.prototype, "enabled", void 0), r([m()], n22.prototype, "rotationEnabled", void 0), n22 = i16 = r([a2("esri.views.2d.constraints.RotationConstraint")], n22);
var a10 = n22;

// node_modules/@arcgis/core/views/2d/constraints/ZoomConstraint.js
var a11;
var c14 = a11 = class extends n3.NumericIdentifiableMixin(g2) {
  constructor(e28) {
  ...
  initialize() {
    let e28, { lods: t30, minScale: o29, maxScale: s31, minZoom: i25, maxZoom: a25 } = this, c29 = -1, l20 = -1, r33 = false, n33 = false;
    ...
    -1 === i25 && (i25 = 0 === o29 ? 0 : c29), -1 === a25 && (a25 = 0 === s31 ? t30.length - 1 : l20), i25 = Math.max(i25, 0), i25 = Math.min(i25, t30.length - 1), a25 = Math.max(a25, 0), a25 = Math.min(a25, t30.length - 1), i25 > a25 && ([i25, a25] = [a25, i25]), o29 = t30[i25].scale, s31 = t30[a25].scale, t30.splice(0, i25), t30.splice(a25 - i25 + 1, t30.length), t30.forEach((e29, t31) => {
      this._lodByScale[e29.scale] = e29, this._scales[t31] = e29.scale;
    }), this._set("effectiveLODs", t30), this._set("effectiveMinZoom", i25), this._set("effectiveMaxZoom", a25), this._set("effectiveMinScale", o29), this._set("effectiveMaxScale", s31);
  }
  constrain(e28, t30) {
    if (t30 && e28.scale === t30.scale) return e28;
    const o29 = this.effectiveMinScale, s31 = this.effectiveMaxScale, i25 = e28.targetGeometry, a25 = t30 && t30.targetGeometry, c29 = 0 !== s31 && e28.scale < s31, l20 = 0 !== o29 && e28.scale > o29;
    if (c29 || l20) {
      const c30 = l20 ? o29 : s31;
      if (t30 && a25) {
        const o30 = (c30 - t30.scale) / (e28.scale - t30.scale);
        i25.x = a25.x + (i25.x - a25.x) * o30, i25.y = a25.y + (i25.y - a25.y) * o30;
      }
      e28.scale = c30;
    }
...
r([m({ readOnly: true })], c14.prototype, "effectiveLODs", void 0), r([m({ readOnly: true })], c14.prototype, "effectiveMinZoom", void 0), r([m({ readOnly: true })], c14.prototype, "effectiveMaxZoom", void 0), r([m({ readOnly: true })], c14.prototype, "effectiveMinScale", void 0), r([m({ readOnly: true })], c14.prototype, "effectiveMaxScale", void 0), r([m()], c14.prototype, "lods", void 0), r([m()], c14.prototype, "minZoom", void 0), r([m()], c14.prototype, "maxZoom", void 0), r([m()], c14.prototype, "minScale", void 0), r([m()], c14.prototype, "maxScale", void 0), r([m()], c14.prototype, "snapToZoom", void 0), c14 = a11 = r([a2("esri.views.2d.constraints.ZoomConstraint")], c14);
var l13 = c14;
...
var z2 = class extends g2 {
  ...
  set viewpoint(t30) {
    ...
    try {
      ...
      o29 = new s2("mapview:invalid-viewpoint", "could not project the value in the view's spatial reference", { error: a25 });
    }
  ...
  getUserStartupOptions(t30) {
    ...
    const { padding: e28, constraints: i25 } = this, s31 = this._get("center"), r33 = this._get("extent"), o29 = this._get("scale"), n33 = this._get("rotation"), a25 = this._get("viewpoint"), c29 = this._get("zoom"), p30 = null != c29 && null != i25 && i25.zoomToScale(c29) || void 0;
    let h21, l20, d18;
    const v10 = a25 == null ? void 0 : a25.rotation, u17 = a25 == null ? void 0 : a25.targetGeometry;
    "extent" === (u17 == null ? void 0 : u17.type) ? h21 = u17 : "point" === (u17 == null ? void 0 : u17.type) && (l20 = u17, d18 = a25 == null ? void 0 : a25.scale);
    const m24 = r33 ?? h21;
    return { center: s31 ?? l20 ?? (m24 == null ? void 0 : m24.center), rotation: n33 ?? v10, scale: (o29 ?? p30 ?? d18 ?? (m24 && H(m24, [t30[0] - e28.left - e28.right, t30[1] - e28.top - e28.bottom]))) || void 0 };
  }
  startup(t30, e28, i25, s31) {
    ...
    try {
      ...
      n.getLogger(this).warn(new s("mapview:startup-projection-error", "projection of initial viewpoint to the view's spatial reference, defaulting to the initial viewpoint.", { center: o29.toJSON(), spatialReference: i25, error: n33 })), t30.targetGeometry = s31 || new j2({ x: 0, y: 0, spatialReference: i25 });
    }
  ...
  changeSpatialReference(t30) {
    ...
    let a25 = null;
    try {
      a25 = this._project(new j2({ x: o29, y: n33, spatialReference: i25.spatialReference }), t30);
    } catch (h21) {
      r7() || n.getLogger(this).warn(new s("mapview:spatial-reference-change", "could not project the view's center to the new spatial reference", { center: a25 == null ? void 0 : a25.toJSON(), spatialReference: t30, error: h21 }));
    }
    a25 || (a25 = new j2({ x: 0, y: 0, spatialReference: t30 }));
    const p30 = xt(new m3({ targetGeometry: new j2(), scale: 0, rotation: 0 }), i25.viewpoint, a25);
    s31.viewpoint = p30;
    try {
      const e28 = 20, r33 = [i25.size[0] / 2, i25.size[1] / 2], o30 = [r33[0] + e28, r33[1]], n34 = i25.toMap([0, 0], o30), { x: a26, y: c29 } = this._project(new j2({ x: n34[0], y: n34[1], spatialReference: i25.spatialReference }), t30);
      n34[0] = a26, n34[1] = c29, s31.toScreen(n34, n34);
      const h21 = pt(r33, n34, o30), l20 = Math.hypot(n34[0] - r33[0], n34[1] - r33[1]) / e28;
      !Number.isFinite(l20) || Math.abs(l20) > 4 ? (p30.rotation = 0, p30.targetGeometry = new j2({ x: 0, y: 0, spatialReference: t30 })) : (p30.scale *= l20, p30.scale > has("mapview-srswitch-adjust-rotation-scale-threshold") ? p30.rotation = 0 : p30.rotation += Number.isFinite(h21) ? h21 : 0);
    } catch {
    }
    (_a = this._get("constraints")) == null ? void 0 : _a.constrain(p30, void 0), this._get("state").viewpoint = p30;
  }
  resize(t30, e28) {
    var _a;
  ...
  toScreen(t30, e28) {
    ...
    return false === (e28 == null ? void 0 : e28.pickClosestTarget) || this.state.paddedViewState.wrapMapCoordinate(s31, s31), this.state.toScreen(s31, s31), c4(s31[0], s31[1]);
  }
  _project(t30, e28) {
    var _a;
...
var a12 = class extends t11 {
  constructor(t30, i25) {
    super(true), this._view = t30, this.registerIncoming("double-click", i25, (t31) => this._handleDoubleClick(t31, i25));
  }
  _handleDoubleClick(t30, a25) {
    r18(t30.data, "primary") && (t30.stopPropagation(), a25 ? this._view.mapViewNavigation.zoomOut([t30.data.x, t30.data.y]) : this._view.mapViewNavigation.zoomIn([t30.data.x, t30.data.y]));
  }
};

// node_modules/@arcgis/core/views/2d/input/handlers/DoubleTapDragZoom.js
var e15 = class extends t11 {
  constructor(t30, e28, a25) {
    super(true), this.view = t30, this.pointerType = e28, this.registerIncoming("double-tap-drag", a25, (t31) => this._handleDoubleTapDrag(t31));
  }
  _handleDoubleTapDrag(t30) {
    const { data: e28 } = t30, { pointerType: a25 } = e28;
    if (a25 !== this.pointerType) return;
    t30.stopPropagation();
    ...
    switch (s31) {
      ...
      case "update": {
        ...
        const t31 = 1.015 ** i25.y, e29 = this._startScale * t31, a26 = e29 / this._currentScale;
        n33.setViewpointImmediate(a26), this._currentScale = e29;
        break;
      }
      case "end": {
        const { constraints: t31 } = r33, { effectiveLODs: e29, snapToZoom: a26 } = t31;
        if (!a26 || !e29) return void n33.end();
...
var n24 = class extends t11 {
  constructor(t30, i25, a25) {
    super(true), this.view = t30, this.pointerActions = i25, this.registerIncoming("drag", a25, (t31) => this._handleDrag(t31)), this.registerIncoming("pointer-down", () => this.stopMomentumNavigation());
  }
  onInstall(i25) {
...
var o15 = class extends t11 {
  constructor(a25, o29, r33) {
    super(true), this._view = a25, this.pointerActions = o29;
    const e28 = this._view.mapViewNavigation;
    this._dragEventSeparator = new t17({ start: (t30, a26) => {
      e28.rotate.begin(this._view, a26.data), a26.stopPropagation();
    }, update: (t30, a26) => {
      e28.rotate.update(this._view, a26.data), a26.stopPropagation();
    }, end: (t30, a26) => {
      e28.rotate.end(), a26.stopPropagation();
    }, condition: (t30, a26) => 1 === t30 && e14(a26.data, this.pointerActions) }), this.registerIncoming("drag", r33, (t30) => this._dragEventSeparator.handle(t30));
  }
};
...
function i17(a25, i25, o29) {
  const s31 = o29, e28 = a25.state, r33 = a25.device, l20 = "forward-down" === i25.tiltDirection ? 1 : -1, c29 = 1;
...
var m15 = class extends t11 {
  ...
  _handleGamePadEvent(t30) {
    ...
    e28 && t30.data.device !== e28 || this._currentDevice && this._currentDevice !== t30.data.device || ("end" === t30.data.action ? (this._currentDevice = null, a13(this._transformation)) : (this._currentDevice = t30.data.device, i17(t30.data, this._view.navigation.gamepad, this._transformation)), (_a = this._frameTask) == null ? void 0 : _a.resume());
  }
  _frameUpdate(t30) {
    var _a;
    const e28 = this._transformation;
    if (s19(e28)) return void ((_a = this._frameTask) == null ? void 0 : _a.pause());
    const i25 = this._view.viewpoint.clone(), a25 = this._view.navigation.gamepad.velocityFactor, r33 = _7 * a25 * t30;
    ...
    const p30 = this._view.constraints.constrain(i25, this._view.viewpoint);
...
var o16 = class extends t11 {
  ...
  _handleMouseWheel(e28) {
    ...
    const o29 = this._view.mapViewNavigation, { x: i25, y: n33, deltaY: s31 } = e28.data, a25 = 1 / t20 ** (1 / 60 * s31), h21 = o29.zoom(a25, [i25, n33]);
...
var a14 = class extends t11 {
  constructor(i25) {
    ...
    const a25 = this.view.mapViewNavigation;
    this._dragEventSeparator = new t17({ start: (t30, i26) => {
      a25.pinch.begin(this.view, i26.data), i26.stopPropagation();
    }, update: (t30, i26) => {
      a25.pinch.update(this.view, i26.data), i26.stopPropagation();
    }, end: (t30, i26) => {
      a25.pinch.end(this.view), i26.stopPropagation();
    }, condition: (t30) => t30 >= 2 });
  }
  _handleDrag(t30) {
...
var a15 = class {
  ...
  _readGamepadState() {
    const e28 = document.hasFocus(), t30 = this._element.contains(document.activeElement), a25 = "document" === this._input.gamepad.enabledFocusMode && !e28 || "view" === this._input.gamepad.enabledFocusMode && !t30;
    d9((e29) => {
      const t31 = this._inputDevices[e29.index];
      if (!t31) return;
      const o29 = this._latestUpdate[e29.index], d18 = t21(t31), c29 = a25 || e18(d18);
      if (o29) {
  ...
  _emitGamepadEvent(e28, t30, s31) {
    ...
    if (!i25 && !s31) return;
    const a25 = !i25 && s31 ? "start" : i25 && s31 ? "update" : "end";
    this._latestUpdate[e28.index] = { timestamp: e28.timestamp, state: t30, active: s31 }, this._callback && this._callback({ device: this._inputDevices[e28.index], state: t30, action: a25 });
  }
};
function o17(e28) {
  if (!e28) return false;
...
var l14 = class _l {
  ...
  _handleMouseWheel(e28, t30) {
    ...
    i19 ? n33 *= 0.7 : a16 || s21 ? n33 *= 0.6 : o18 && (n33 *= 1.375);
...
function o19(t30, n33) {
  ...
  let i25 = 0, a25 = 0, l20 = 0, m24 = 0, s31 = 0, x3 = 0, y11 = 0;
  for (let e28 = 0; e28 < u17.length; e28++) {
    const t31 = u17[e28], n34 = c29[e28], r34 = t31 * t31, o30 = n34 * n34;
    i25 += r34, a25 += o30, l20 += t31 * n34, m24 += r34 * t31, s31 += o30 * n34, x3 += t31 * o30, y11 += n34 * r34;
  }
  const h21 = 0.5 * (m24 + x3), D4 = 0.5 * (s31 + y11), g16 = i25 * a25 - l20 * l20, f17 = (h21 * a25 - D4 * l20) / g16, b9 = (i25 * D4 - l20 * h21) / g16, p30 = c4(f17 + r33, b9 + o29);
  return { radius: Math.sqrt(f17 * f17 + b9 * b9 + (i25 + a25) / t30.length), center: p30 };
}
function u9(e28) {
...
var u10 = class extends t11 {
  constructor(e28 = t22.maximumDoubleClickDelay, a25 = t22.maximumDoubleClickDistance, n33 = t22.maximumDoubleTouchDelay, s31 = t22.maximumDoubleTouchDistance, u17 = o3) {
    super(false), this._maximumDoubleClickDelay = e28, this._maximumDoubleClickDistance = a25, this._maximumDoubleTouchDelay = n33, this._maximumDoubleTouchDistance = s31, this._clock = u17, this._doubleTapDragReady = false, this._doubleTapDragActive = false, this._dragStartCenter = c4(0, 0), this._pointerState = /* @__PURE__ */ new Map(), this._doubleTapDrag = this.registerOutgoing("double-tap-drag"), this._dragEventSeparator = new t17({ start: (t30, e29) => this._dragStart(t30, e29), update: (t30, e29) => this._dragUpdate(e29), end: (t30, e29) => this._dragEnd(e29) }), this.registerIncoming("drag", (t30) => this._dragEventSeparator.handle(t30)), this.registerIncoming("pointer-down", (t30) => this._handlePointerDown(t30)), this.registerIncoming("pointer-up", () => this._handlePointerUp());
  }
  onUninstall() {
  ...
  _dragStart(t30, e28) {
    ...
    const { data: o29, modifiers: a25 } = e28, { center: r33 } = o29;
    this._dragStartCenter = r33;
    const n33 = d10("begin", c4(0, 0), o29);
    this._doubleTapDrag.emit(n33, void 0, a25), e28.stopPropagation();
  }
  _dragUpdate(t30) {
    if (!this._doubleTapDragActive) return;
    const { data: e28, modifiers: o29 } = t30, { center: a25 } = e28, r33 = d10("update", c4(a25.x - this._dragStartCenter.x, a25.y - this._dragStartCenter.y), e28);
    this._doubleTapDrag.emit(r33, void 0, o29), t30.stopPropagation();
  }
  _dragEnd(t30) {
    if (!this._doubleTapDragActive) return;
    const { data: e28, modifiers: o29 } = t30, { center: a25 } = e28, r33 = d10("end", c4(a25.x - this._dragStartCenter.x, a25.y - this._dragStartCenter.y), e28);
    this._doubleTapDrag.emit(r33, void 0, o29), this._doubleTapDragActive = false, t30.stopPropagation();
  }
  _handlePointerDown(t30) {
    const { data: e28 } = t30, i25 = u9(e28), o29 = this._pointerState.get(i25), { pointerType: a25 } = e28.native;
    if (o29) {
      const r33 = "touch" === a25 ? this._maximumDoubleTouchDistance : this._maximumDoubleClickDistance;
  ...
  _storePointerDown(t30) {
    const { data: e28 } = t30, { pointerType: i25 } = e28.native, o29 = u9(e28), a25 = "touch" === i25 ? this._maximumDoubleTouchDelay : this._maximumDoubleClickDelay, r33 = this._clock.setTimeout(() => this._clearPointerDown(o29), a25);
    this._pointerState.set(o29, { event: t30, doubleTapTimeout: r33 }), this.refreshHasPendingInputs();
  }
};
function d10(t30, e28, i25) {
  const { button: o29, buttons: a25, pointer: r33, pointers: n33, pointerType: s31, timestamp: u17 } = i25;
  return { action: t30, delta: e28, button: o29, buttons: a25, pointer: r33, pointers: n33, pointerType: s31, timestamp: u17 };
}

// node_modules/@arcgis/core/views/input/recognizers/Drag.js
var s22 = class extends t11 {
  constructor(t30) {
  ...
  _addPointer(t30) {
    const e28 = t30.native.pointerId, i25 = a17(this._activePointerMap).angle, n33 = { event: t30, initialAngle: 0, lastAngle: 0 };
...
var m16 = class extends t11 {
  constructor(e28 = t22.maximumDoubleClickDelay, o29 = t22.maximumDoubleClickDistance, a25 = t22.maximumDoubleTouchDelay, m24 = t22.maximumDoubleTouchDistance, n33 = o3) {
    super(false), this._maximumDoubleClickDelay = e28, this._maximumDoubleClickDistance = o29, this._maximumDoubleTouchDelay = a25, this._maximumDoubleTouchDistance = m24, this._clock = n33, this._pointerState = /* @__PURE__ */ new Map(), this._immediateDoubleClick = this.registerOutgoing("immediate-double-click"), this.registerIncoming("pointer-down", this._handlePointerDown.bind(this)), this.registerIncoming("pointer-up", this._handlePointerUp.bind(this));
  }
  onUninstall() {
    this._pointerState.forEach((t30) => {
...
var l15 = class extends t11 {
  ...
  _handleImmediateClick(e28) {
    ...
    const s31 = this._pointerState.get(o29), { data: l20, modifiers: c29 } = s31.event, a25 = "touch" === i25 ? this._maximumDoubleTouchDistance : this._maximumDoubleClickDistance;
    n27(l20, t30) > a25 ? (this._clearDoubleClickTimer(o29, true), this._startClick(e28)) : (this._clearDoubleClickTimer(o29, false), 2 === s31.pointerDownCount && this._doubleClick.emit(l20, void 0, c29));
  }
...
var k3 = class extends g2 {
  initialize() {
    ...
    this.addHandles([p2(() => !e28(), () => this._disconnect()), p2(e28, () => this._connect())]);
  }
  destroy() {
    this._disconnect();
  }
  ...
  _connect() {
    const e28 = this.view.surface, t30 = new l14(e28, this.view.input), o29 = [new m16(), new r22(), new l15(), new s22(this.view.navigation), new u10()], r33 = new d5({ eventSource: t30, recognizers: o29 }), a25 = new n24(this.view, ["primary"]), c29 = new o15(this.view, ["secondary"]);
    r33.installHandlers("prevent-context-menu", [new e19()], _2.INTERNAL), r33.installHandlers("navigation", [new a14(this.view), new m15(this.view), new o16(this.view), new a12(this.view), new a12(this.view, [C4.counter]), a25, new e16(this.view, C4.pan), new e17(this.view, C4.zoom), new t18(this.view, C4.rotate), c29, new e15(this.view, "touch")], _2.INTERNAL), this.view.viewEvents.connect(r33), this._source = t30, this._inputManager = r33, this.addHandles([d3(() => {
      var _a, _b;
      ...
      a25.pointerActions = e29, c29.pointerActions = t31;
    }, A3)], L6);
  }
  get test() {
  }
};
r([m()], k3.prototype, "view", void 0), r([m()], k3.prototype, "latestPointerType", null), r([m()], k3.prototype, "latestPointerLocation", null), r([m()], k3.prototype, "multiTouchActive", null), k3 = r([a2("esri.views.2d.input.MapViewInputManager")], k3);
var E2 = k3;
...
r([m()], i20.prototype, "_timer", void 0), r([m()], i20.prototype, "stationary", null), i20 = r([a2("esri.views.2d.support.StationaryManager")], i20);
...
var u11 = (u17) => {
  let m24 = class extends u17 {
    ...
    on(t30, e28, i25, n33) {
      const a25 = this.inputManager && this.viewEvents.on(t30, e28, i25, n33);
      return a25 || super.on(t30, e28);
    }
...
var a18 = class {
  ...
  compareTo(t30, o29) {
    ...
    i25 = i25 >= 180 ? 360 - i25 : i25, o29.rotate = s7(i25), o29.sourceZoom = this.scale, o29.targetZoom = t30.scale;
  }
  interpolate(t30, e28, i25) {
    const { pan: r33, rotate: s31, zoom: n33, zoomOffset: a25 } = i25, { center: c29 } = this;
    c29.spatialReference = t30.center.spatialReference, c29.x = o5(t30.center.x, e28.center.x, r33), c29.y = o5(t30.center.y, e28.center.y, r33), this.viewpoint.scale = o5(t30.scale, e28.scale + a25, n33);
    let p30 = t30.rotation;
    const l20 = e28.rotation;
    Math.abs(l20 - p30) >= 180 && (p30 += 360 * (p30 < l20 ? 1 : -1)), this.viewpoint.rotation = o5(p30, l20, s31);
  }
  copyFrom(t30) {
...
var a19 = (t30) => t30 * t30 * t30;
var c17 = (t30) => 1 - a19(1 - t30);
var s24 = (t30) => t30 < 0.5 ? a19(2 * t30) / 2 : (c17(2 * (t30 - 0.5)) + 1) / 2;
...
var m17 = (t30) => t30 < 0.5 ? f11(2 * t30) / 2 : (I5(2 * (t30 - 0.5)) + 1) / 2;
...
var F2 = B2(z3(4), 0);
var G3 = B2(z3(4), 0.5);
var H2 = { linear: u12, "in-quad": i21, "out-quad": o21, "in-out-quad": n28, "in-coast-quad": P5, "out-coast-quad": g12, "in-out-coast-quad": k4, "in-cubic": a19, "out-cubic": c17, "in-out-cubic": s24, "in-coast-cubic": v7, "out-coast-cubic": w7, "in-out-coast-cubic": y7, "in-quart": e21, "out-quart": q, "in-out-quart": r24, "in-coast-quart": A4, "out-coast-quart": C5, "in-out-coast-quart": D2, "in-quint": d11, "out-quint": b6, "in-out-quint": p21, "in-coast-quint": E3, "out-coast-quint": F2, "in-out-coast-quint": G3, "in-sine": h15, "out-sine": x, "in-out-sine": M6, "in-expo": f11, "out-expo": I5, "in-out-expo": m17, "in-circ": O4, "out-circ": j6, "in-out-circ": l16, ease: (u17) => t9.ease(u17), "ease-in": (u17) => t9.easeIn(u17), "ease-out": (u17) => t9.easeOut(u17), "ease-in-out": (u17) => t9.easeInOut(u17) };
...
var o22 = { desiredScreenFlow: 2, minDuration: n4(500), maxDuration: n4(8e3) };
var r25 = { ...o22, maxDuration: n4(4e3) };
...
var e22 = class {
  ...
  interpolateComponentsAt(t30, e28) {
    ...
    let o29 = 0, s31 = 0;
    const n33 = this.definition, a25 = this.segments.reduce((t31, e29) => t31 || e29.definition.hasZoom, false);
    for (let i25 = 0; i25 < this.segments.length; i25++) {
      ...
      if (t30 <= m24.time || i25 === this.segments.length - 1) {
        if (this.segmentInterpolateComponentsAt(m24, 0 === m24.time ? 0 : t30 / m24.time, e28), n33.hasPan && !isNaN(e28.pan) && isFinite(n33.compared.pan) ? e28.pan = (o29 + r33.compared.pan * e28.pan) / n33.compared.pan : e28.pan = 1, n33.hasRotate && !isNaN(e28.rotate) && isFinite(n33.compared.rotate) ? e28.rotate = (s31 + r33.compared.rotate * e28.rotate) / n33.compared.rotate : e28.rotate = 1, a25 && !isNaN(e28.zoom) && isFinite(r33.compared.targetZoom)) {
          const { sourceZoom: t31, targetZoom: o30 } = r33.compared, s32 = e28.zoom * (o30 - t31) + t31, n34 = this.segments[0].definition.compared.sourceZoom, a26 = this.segments[this.segments.length - 1].definition.compared.targetZoom, i26 = Math.abs(o30 - n34) > Math.abs(t31 - n34) ? o30 : t31;
          e28.zoomOffset = i26 - a26, e28.zoom = (s32 - n34) / (i26 - n34);
        } else e28.zoom = 1;
        return e28;
      }
...
var o23 = class {
  ...
  _updatePixelFlow() {
    ...
    let h21 = 0, a25 = 0;
    e28 && (n33 && (h21 = (o29 / t30 - 1) / (-1 / (this._zoomSign * this.definition.halfWindowSize) * Math.LN2 * this._panPixelsAtSource)), s31 && (a25 = this._zoomSign * (Math.log(t30 / o29) / Math.LN2) * this.definition.halfWindowSize / this._rotatePixels)), this._zoomPixelFlow = 0, this._panPixelFlow = 0, this._rotatePixelFlow = 0;
    const r33 = this.definition.desiredPixelFlow;
    if (e28 && n33 && s31) {
      const t31 = h21 + a25 + h21 * a25;
      this._zoomPixelFlow = h21 * a25 / t31 * r33, this._panPixelFlow = a25 / t31 * r33, this._rotatePixelFlow = h21 / t31 * r33;
    } else if (e28 && n33) {
      const t31 = 1 + h21;
      this._zoomPixelFlow = h21 / t31 * r33, this._panPixelFlow = 1 / t31 * r33;
    } else if (e28 && s31) {
      const t31 = 1 + a25;
      this._zoomPixelFlow = a25 / t31 * r33, this._rotatePixelFlow = 1 / t31 * r33;
    } else if (n33 && s31) {
...
function o24(o29, e28, a25) {
  const n33 = e28 - o29.compared.sourceZoom, t30 = o29.halfWindowPanAtZoom(n33);
  return -o29.halfWindowSize * (a25.ascensionFactor * Math.LN2 * o29.compared.pan + t30) * Math.log(o29.compared.sourceZoom / e28) / (o29.desiredPixelFlow * Math.LN2 * t30);
}
function e24(o29, e28, a25) {
  const n33 = 1 / e28, t30 = Math.log(o29.compared.sourceZoom * n33), i25 = 1 / o29.desiredPixelFlow, r33 = 1 / Math.LN2, d18 = e28 - o29.compared.sourceZoom, c29 = 1 / d18, l20 = (a25.ascensionFactor * Math.LN2 * o29.compared.pan + o29.halfWindowPanAtZoom(d18)) / o29.halfWindowPanAtZoom(1);
...
function a20(o29, e28, a25) {
  const n33 = e28 - o29.compared.sourceZoom, t30 = 1 / n33, i25 = 1 / e28, r33 = Math.log(o29.compared.sourceZoom * i25), d18 = (a25.ascensionFactor * Math.LN2 * o29.compared.pan + o29.halfWindowPanAtZoom(n33)) / o29.halfWindowPanAtZoom(1);
...
function r27(o29, e28, a25) {
  return -o29.compared.pan * o29.halfWindowSize * (a25.ascensionFactor + a25.descensionFactor - 1) / (o29.desiredPixelFlow * o29.halfWindowPanAtZoom(e28));
}
function d12(o29, e28, a25) {
  return o29.compared.pan * o29.halfWindowSize * (a25.ascensionFactor + a25.descensionFactor - 1) / (o29.desiredPixelFlow * o29.halfWindowPanAtZoom(e28 * e28));
}
function c18(o29, e28, a25) {
  return -2 * o29.compared.pan * o29.halfWindowSize * (a25.ascensionFactor + a25.descensionFactor - 1) / (o29.desiredPixelFlow * o29.halfWindowPanAtZoom(e28 * e28 * e28));
}
function l17(o29, e28, a25) {
  return o29.halfWindowSize * (-o29.halfWindowPanAtZoom(e28) - a25.descensionFactor * Math.LN2 * o29.compared.pan + o29.halfWindowPanAtZoom(o29.compared.targetZoom)) * Math.log(e28 / o29.compared.targetZoom) / (o29.desiredPixelFlow * Math.LN2 * o29.halfWindowPanAtZoom(-e28 + o29.compared.targetZoom));
}
function m18(o29, e28, a25) {
  const n33 = Math.log(e28 / o29.compared.targetZoom), t30 = 1 / o29.desiredPixelFlow, i25 = 1 / Math.LN2, r33 = -e28 + o29.compared.targetZoom, d18 = 1 / r33, c29 = (-o29.halfWindowPanAtZoom(e28) - a25.descensionFactor * Math.LN2 * o29.compared.pan + o29.halfWindowPanAtZoom(o29.compared.targetZoom)) / o29.halfWindowPanAtZoom(1);
...
function h16(o29, e28, a25) {
  const n33 = e28 - o29.compared.targetZoom, t30 = 1 / n33, i25 = 1 / e28, r33 = Math.log(e28 / o29.compared.targetZoom), d18 = (o29.halfWindowPanAtZoom(e28) + a25.descensionFactor * Math.LN2 * o29.compared.pan - o29.halfWindowPanAtZoom(o29.compared.targetZoom)) / o29.halfWindowPanAtZoom(1);
  return o29.halfWindowSize * t30 * (-2 * t30 * i25 * d18 - 2 * t30 * r33 + 2 * i25 + 2 * r33 * d18 / (n33 * n33) - d18 / (e28 * e28)) / (o29.desiredPixelFlow * Math.LN2);
}
...
function p22(o29) {
  ...
  const a25 = Math.LN2 * o29.compared.pan, n33 = e28, t30 = o29.halfWindowPanAtZoom(n33), i25 = o29.halfWindowSize * Math.log(o29.compared.sourceZoom / o29.compared.targetZoom) / (o29.desiredPixelFlow * Math.LN2 * t30);
  return o29.compared.sourceZoom <= o29.compared.targetZoom ? i25 * (a25 - t30) : i25 * (a25 + t30);
}

// node_modules/@arcgis/core/views/animation/pointToPoint/apex/planning.js
function f13(f17, Z3) {
  let b9 = D3(f17, Z3);
  const h21 = { ascensionFactor: null != Z3.ascensionFactor ? Z3.ascensionFactor : 0.5, descensionFactor: null != Z3.descensionFactor ? Z3.descensionFactor : 0.5 }, M7 = 0 === h21.ascensionFactor, P7 = 0 === h21.descensionFactor, g16 = M7 ? n29 : o24, k5 = M7 ? t25 : e24, N = M7 ? i22 : a20, j8 = P7 ? s25 : l17, w10 = P7 ? f12 : m18, z4 = P7 ? w8 : h16, A6 = (o29) => g16(f17, o29, h21) + r27(f17, o29, h21) + j8(f17, o29, h21), I6 = (o29) => k5(f17, o29, h21) + d12(f17, o29, h21) + w10(f17, o29, h21), S5 = (o29) => N(f17, o29, h21) + c18(f17, o29, h21) + z4(f17, o29, h21);
  let q2 = A6(b9);
  const v10 = p22(f17);
  let y11;
  ...
  for (y11 = 0; y11 < B4; y11++) {
    ...
    const a25 = A6(b9);
    if (Math.abs(a25 - q2) / q2 <= 5e-3) break;
    q2 = a25;
  }
  return q2 > v10 * (1 - 0.3) || b9 < f17.compared.sourceZoom || b9 < f17.compared.targetZoom ? null : b9;
}
function D3(o29, e28) {
  const n33 = Math.max(o29.compared.sourceZoom, o29.compared.targetZoom), a25 = o29.source.zoomAtPixelsPerPan(o29.desiredPixelFlow / o29.compared.pan) / 2;
  return a25 < n33 ? null != e28.maximumDistance ? n33 + (e28.maximumDistance - n33) / 2 : 1.5 * n33 : e28.maximumDistance ? Math.min(e28.maximumDistance, a25) : a25;
}
...
var s26 = class extends e22 {
  ...
  _updateWithApex(i25, n33) {
    const [e28, t30, o29] = this._preallocSegments, s31 = (n33 == null ? void 0 : n33.ascensionFactor) ?? 0.5, d18 = Math.min(1 - s31, null != (n33 == null ? void 0 : n33.ascensionFactor) && null != n33.descensionFactor ? n33.descensionFactor : 0.5), a25 = 1 - s31 - d18;
    e28.definition ? e28.definition.copyFrom(this.definition) : e28.definition = this.definition.clone(), e28.definition.compared.targetZoom = i25, e28.definition.compared.pan = this.definition.compared.pan * s31, e28.definition.compared.rotate = this.definition.compared.rotate * s31, e28.definition.segmentEnd = s31, e28.update(), this._ascensionSegment = e28, this.segments.push(e28), a25 > 0 && (t30.definition ? t30.definition.copyFrom(this.definition) : t30.definition = this.definition.clone(), t30.definition.copyFrom(this.definition), t30.definition.compared.sourceZoom = i25, t30.definition.compared.targetZoom = i25, t30.definition.compared.pan = this.definition.compared.pan * a25, t30.definition.compared.rotate = this.definition.compared.rotate * a25, t30.definition.segmentStart = e28.definition.segmentEnd, t30.definition.segmentEnd = e28.definition.segmentEnd + a25, t30.update(), this.segments.push(t30)), o29.definition ? o29.definition.copyFrom(this.definition) : o29.definition = this.definition.clone(), o29.definition.compared.sourceZoom = i25, o29.definition.compared.pan = this.definition.compared.pan * d18, o29.definition.compared.rotate = this.definition.compared.rotate * d18, o29.definition.segmentStart = s31 + a25, o29.update(), this._descensionSegment = o29, this.segments.push(o29);
  }
  _updateWithoutApex() {
...
var p23 = class {
  ...
  constructor(i25) {
    this._time = n4(0), this._easing = k4, this.definition = new r26(i25), this.path = new s26();
  }
  update(t30, a25, o29) {
    this.definition.update(t30, a25, o29), this.path.update(this.definition, o29), this._time = this._applyTimeSettings(r5(isFinite(this.path.time) ? this.path.time : t3(0)), o29), this._easing = o29.easing ?? (this._time >= 1e3 ? k4 : I5);
  }
  cameraAt(t30, i25) {
  ...
  _applyTimeSettings(i25, e28) {
    const n33 = null != e28.speedFactor ? e28.speedFactor : 1, s31 = e28.minDuration ?? o22.minDuration / n33, a25 = e28.maxDuration ?? o22.maxDuration / n33;
    return i25 = null != e28.duration ? n4(e28.duration) : n4(Math.min(Math.max(i25 / n33, s31), a25));
  }
};
...
var j7 = class {
  constructor(t30) {
    this._view = t30, this._animation = new p23(() => new a18(this._view)), this._current = new a18(this._view);
  }
  get _source() {
...
var y8 = class extends g2 {
  ...
  animate(t30, i25, e28) {
    ...
    this._transition.update(this.viewpoint, s31, { apex: { maximumDistance: Math.min(Math.min(i25.scale, s31.scale) * g13, this.view.constraints.effectiveMinScale), desiredSlope: 5e-8 }, duration: e28 == null ? void 0 : e28.duration, maxDuration: "auto" === (e28 == null ? void 0 : e28.animationMode) ? n4(1 / 0) : (e28 == null ? void 0 : e28.maxDuration) ?? r25.maxDuration, speedFactor: e28 == null ? void 0 : e28.speedFactor, easing: ("string" == typeof (e28 == null ? void 0 : e28.easing) ? H2[e28.easing] : e28 == null ? void 0 : e28.easing) || this.easing }), "auto" === (e28 == null ? void 0 : e28.animationMode) && (this._destinationViewState.copy(this.view.state), this._destinationViewState.viewpoint = s31, T3(this._transition.animation, e28, this.view.state, this._destinationViewState) || this._transition.update(this.viewpoint, s31, { duration: n4(0) }));
    const o29 = () => {
  ...
  animateContinuous(t30, i25) {
    ...
    const e28 = new a9({ target: t30.clone() }), n33 = () => {
  ...
  _postRender(t30) {
    ...
    if (i25 && i25.state !== a9.State.STOPPED) {
...
function T3(t30, i25, e28, n33) {
  ...
  const { time: s31, isLinear: a25 } = t30, r33 = (i25 == null ? void 0 : i25.speedFactor) || 1;
  if (s31 > ((i25 == null ? void 0 : i25.maxDuration) ?? r25.maxDuration / r33)) return false;
  if (a25) {
    const t31 = 1.5, i26 = n11(), a26 = c4(...n33.toScreen(i26, ...e28.center)), m24 = c4(...e28.toScreen(i26, ...n33.center)), h21 = null != m24 && m24.x > -1 * e28.size[0] && m24.x < (t31 + 0.5) * e28.size[0] && m24.y > -1 * e28.size[1] && m24.y < (t31 + 0.5) * e28.size[1], u17 = null != a26 && a26.x > -1 * n33.size[0] && a26.x < (t31 + 0.5) * n33.size[0] && a26.y > -1 * n33.size[1] && a26.y < (t31 + 0.5) * n33.size[1];
    if (s31 > f14 / r33 && !h21 && !u17) return false;
  }
  return true;
}
r([m()], y8.prototype, "easing", void 0), r([m()], y8.prototype, "view", void 0), r([m()], y8.prototype, "viewpoint", void 0), y8 = r([a2("esri.views.2d.AnimationManager")], y8);
var x2 = y8;

// node_modules/@arcgis/core/views/2d/layerViewModuleImportUtils.js
function r28() {
  return Promise.all([import("./webglDeps-YGDWH7RZ.js"), import("./mapViewDeps-GNIKCIHZ.js")]);
}
var a21 = () => r28().then(() => import("./TileLayerView2D-3NB35J25.js"));
var t26 = () => r28().then(() => import("./FeatureLayerView2D-BGOEE3RZ.js"));
var i23 = { "base-dynamic": () => r28().then(() => import("./BaseDynamicLayerView2D-QQROYIRR.js")), "base-tile": a21, "bing-maps": a21, catalog: () => r28().then(() => import("./CatalogLayerView2D-KBADSGRK.js")), "catalog-dynamic-group": () => r28().then(() => import("./CatalogDynamicGroupLayerView2D-HFBQEHKB.js")), "catalog-footprint": () => r28().then(() => import("./CatalogFootprintLayerView2D-X6J5N34E.js")), csv: t26, "geo-rss": () => r28().then(() => import("./GeoRSSLayerView2D-27WL3U3P.js")), feature: t26, geojson: t26, parquet: t26, graphics: () => r28().then(() => import("./GraphicsLayerView2D-FH7HVZAX.js")), group: () => r28().then(() => import("./GroupLayerView2D-ISJC4R4A.js")), imagery: () => r28().then(() => import("./ImageryLayerView2D-SKETLSA5.js")), "imagery-tile": () => r28().then(() => import("./ImageryTileLayerView2D-YQXEWGVC.js")), kml: () => r28().then(() => import("./KMLLayerView2D-NH2TCUHI.js")), "knowledge-graph": () => r28().then(() => import("./KnowledgeGraphLayerView2D-R327MKDF.js")), "link-chart": () => r28().then(() => import("./KnowledgeGraphLayerView2D-R327MKDF.js")), "knowledge-graph-sublayer": t26, "map-image": () => r28().then(() => import("./MapImageLayerView2D-OCHX2IUI.js")), "map-notes": () => r28().then(() => import("./MapNotesLayerView2D-QCBBQCJQ.js")), media: () => r28().then(() => import("./MediaLayerView2D-IQJDKPKN.js")), "ogc-feature": () => r28().then(() => import("./OGCFeatureLayerView2D-TISSBWHS.js")), "open-street-map": a21, "oriented-imagery": t26, route: () => r28().then(() => import("./RouteLayerView2D-2WI6ACNJ.js")), stream: () => r28().then(() => import("./StreamLayerView2D-3FIVGJM6.js")), "subtype-group": () => r28().then(() => import("./SubtypeGroupLayerView2D-GFOSRFU5.js")), tile: a21, "vector-tile": () => r28().then(() => import("./VectorTileLayerView2D-IUT4QWXV.js")), video: () => r28().then(() => import("./VideoLayerView2D-ETJ4TXBD.js")), wcs: () => r28().then(() => import("./ImageryTileLayerView2D-YQXEWGVC.js")), "web-tile": a21, wfs: t26, wms: () => r28().then(() => import("./WMSLayerView2D-VZBC6NAA.js")), wmts: () => r28().then(() => import("./WMTSLayerView2D-LLFYGJ6R.js")), "line-of-sight": null, "base-elevation": null, "building-scene": null, dimension: null, elevation: null, "integrated-mesh": null, "integrated-mesh-3dtiles": null, "point-cloud": null, viewshed: null, voxel: null, scene: null, unknown: null, unsupported: null };
function s27(r33) {
  const a25 = r33.declaredClass ? r33.declaredClass.slice(r33.declaredClass.lastIndexOf(".") + 1) : "Unknown", t30 = a25.replaceAll(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
  return new s2(`${t30}:view-not-supported`, `${a25} is not supported in 2D`);
}
...
var a22 = /* @__PURE__ */ new Set();
var c19 = new e9(0, 0, 0, 0);
function m19(e28, t30) {
  const s31 = d4(t30);
  if (!s31) return null;
...
var u13 = class extends i {
  ...
  getIntersectingTiles(e28) {
    ...
    const t30 = m19(e28, this.tileScheme.spatialReference);
  ...
  setViewState(e28) {
    ...
    for (let n33 = this.tiles.length - 1; n33 >= 0; n33--) {
      ...
      a22.has(e29.id) || (this._tiles.delete(e29.id), this.tiles.splice(n33, 1), this._index.remove(e29), d13.removed.push(e29));
    }
    (d13.added.length || d13.removed.length) && this.emit("update", d13), s11.pool.release(t30), a22.clear(), d13.added.length = 0, d13.removed.length = 0;
  }
};
...
function n30(r33, i25, t30, a25, l20, s31) {
  return (n33) => {
...
async function o26(h21, n33) {
  const o29 = await a23(h21, n33), { format: r33, quality: l20 } = c8(n33 == null ? void 0 : n33.format, n33 == null ? void 0 : n33.quality);
  return a4(o29, { format: r33, quality: l20 }, e25);
}
async function r29(t30, i25) {
  const n33 = await a23(t30, i25);
  return r12(n33, e25);
}
function a23(t30, i25) {
...
function d14(t30, i25, h21, n33) {
  ...
  let a25, l20, u17 = t30.area || { x: 0, y: 0, width: o29, height: r33 };
  if (e28) {
  ...
  return e28[0] > u17.width ? (a25 = Math.min(e28[0] / u17.width, i25), l20 = e28[0] / u17.width / a25) : (a25 = 1, l20 = e28[0] / u17.width), { cropArea: { x: Math.round((u17.x + n33.left) * a25), y: Math.round((u17.y + n33.top) * a25), width: Math.round(u17.width * a25), height: Math.round(u17.height * a25) }, outputScale: l20, resolutionScale: a25 };
}
...
var p25 = class extends g2 {
  ...
  castNode(t30) {
    var _a;
    return (_a = this.widget) == null ? void 0 : _a.destroy(), t30 ? "string" == typeof t30 || n31(t30) ? (this._set("widget", null), n7(t30)) : (d15(t30) && !t30.domNode && (t30.domNode = document.createElement("div")), this._set("widget", t30), t30.domNode) : (this._set("widget", null), null);
  }
};
r([m()], p25.prototype, "id", null), r([m()], p25.prototype, "node", null), r([s6("node")], p25.prototype, "castNode", null), r([m({ readOnly: true })], p25.prototype, "widget", void 0), p25 = r([a2("esri.views.ui.Component")], p25);
var m20 = p25;
...
var P6 = class extends i.EventedAccessor {
  constructor(t30) {
    super(t30), this._cornerNameToContainerLookup = {}, this._positionNameToContainerLookup = {}, this._components = new Array(), this._componentMap = /* @__PURE__ */ new Map(), this._removeWidgetHandleKey = Symbol("componentOnRemoveSymbol"), this._locale = r3(), this.view = null, this._applyViewPadding = () => {
  ...
  _add(t30, e28, n33, r33, s31) {
    t30 instanceof m20 || (t30 = new m20({ node: t30 }));
    const { widget: a25 } = t30;
    null != a25 && a25 instanceof g2 && a25.addHandles(e(() => {
  ...
  _find(t30) {
    return t30 ? t30 instanceof m20 ? this._findByComponent(t30) : "string" == typeof t30 ? this._findById(t30) : this._findByNode(t30.domNode || t30) : null;
  }
  _getViewPadding() {
    var _a;
  ...
  _place(t30) {
    ...
    const a25 = s31[n33];
    (_b = a25.parentNode) == null ? void 0 : _b.insertBefore(e28.node, a25);
  }
...
r([m()], P6.prototype, "_locale", void 0), r([m()], P6.prototype, "container", null), r([m()], P6.prototype, "height", null), r([m({ value: _8 })], P6.prototype, "padding", null), r([s6("padding")], P6.prototype, "castPadding", null), r([m()], P6.prototype, "view", void 0), r([m()], P6.prototype, "width", null), P6 = r([a2("esri.views.ui.UI")], P6);
var L7 = P6;
...
var _9 = class extends g2 {
  constructor(t30) {
    ...
    }, "change", (t31) => this._allLayerViewsChange(t31), { onListenerAdd: () => this._allLayerViewsChange(), onListenerRemove: this._clear }), p2(() => {
      var _a;
  ...
  _createContributionIndex(t30, e28) {
    ...
    for (let s31 = 0; s31 < i25.length; s31++) {
      ...
      for (const i26 of o29) {
        const o30 = i26.bbox, n33 = i26.zoomMin - (e28 && i26.zoomMin ? 1 : 0), a25 = i26.zoomMax - (e28 && i26.zoomMax ? 1 : 0), c29 = new w2({ xmin: o30[1], ymin: o30[0], xmax: o30[3], ymax: o30[2], spatialReference: g4.WGS84 }), u17 = { extent: j(c29), attribution: t31.attribution || "", score: null != i26.score ? i26.score : 100, id: s31 };
        for (let t32 = n33; t32 <= a25; t32++) r33[t32] ?? (r33[t32] = []), r33[t32].push(u17);
      }
    }
  ...
  _getDynamicAttribution(t30, e28, i25) {
    ...
    const n33 = t30[o29], a25 = y(r33.center.clone().normalize(), g4.WebMercator), c29 = /* @__PURE__ */ new Set();
    return n33 ? n33.filter((t31) => {
      const e29 = t31.id, i26 = !c29.has(e29) && a25 && t31.extent && t5(t31.extent, a25);
      return i26 && c29.add(e29), i26;
    }).sort((t31, e29) => e29.score - t31.score || t31.objectId - e29.objectId).map((t31) => t31.attribution).join(", ") : "";
  }
};
r([m({ readOnly: true, type: V })], _9.prototype, "items", void 0), r([m({ readOnly: true })], _9.prototype, "state", null), r([m()], _9.prototype, "view", void 0), _9 = r([a2("esri.widgets.Attribution.AttributionViewModel")], _9);
var v9 = _9;

// node_modules/@arcgis/core/widgets/Attribution.js
var c22 = "esri-attribution";
var a24 = { base: c22, poweredBy: `${c22}__powered-by`, sources: `${c22}__sources`, open: `${c22}--open`, sourcesOpen: `${c22}__sources--open`, link: `${c22}__link` };
var h18 = class extends O {
  ...
  render() {
    const e28 = { [a24.open]: this._isOpen };
    return n5("div", { bind: this, class: this.classes(a24.base, e6.widget, e28), dir: "ltr", onclick: this._toggleState, onkeydown: this._toggleState }, this._renderSourcesNode(), this._renderPoweredBy());
  }
  _renderPoweredBy() {
    return n5("div", { class: a24.poweredBy }, "Powered by", " ", n5("a", { class: a24.link, href: "https://www.esri.com/", rel: "noreferrer", target: "_blank" }, "Esri"));
  }
  _renderSourcesNode() {
    const e28 = this._isOpen, t30 = this._isInteractive, i25 = t30 ? 0 : void 0, { attributionText: r33 } = this, s31 = { [a24.sourcesOpen]: e28, [e6.interactive]: t30 };
    return n5("div", { afterCreate: this._afterSourcesNodeCreate, bind: this, class: this.classes(a24.sources, s31), innerHTML: r33, tabIndex: i25 });
  }
...
r([m()], h18.prototype, "_isOpen", void 0), r([m()], h18.prototype, "_isInteractive", null), r([m()], h18.prototype, "_attributionTextOverflowed", void 0), r([m()], h18.prototype, "_prevSourceNodeHeight", void 0), r([m({ readOnly: true, dependsOn: ["viewModel.items.length", "itemDelimiter"] })], h18.prototype, "attributionText", null), r([m()], h18.prototype, "icon", null), r([m()], h18.prototype, "itemDelimiter", void 0), r([m()], h18.prototype, "label", null), r([m(), e4("esri/widgets/Attribution/t9n/Attribution")], h18.prototype, "messages", void 0), r([m()], h18.prototype, "view", null), r([m({ type: v9 })], h18.prototype, "viewModel", void 0), r([t7()], h18.prototype, "_toggleState", null), h18 = r([a2("esri.widgets.Attribution")], h18);
var u15 = h18;
...
r([m({ readOnly: true })], h19.prototype, "canShowNorth", null), r([m({ readOnly: true })], h19.prototype, "orientation", void 0), r([m({ readOnly: true })], h19.prototype, "state", null), r([m()], h19.prototype, "view", void 0), h19 = r([a2("esri.widgets.Compass.CompassViewModel")], h19);
var p26 = h19;
...
var c23 = class extends O {
  ...
  loadDependencies() {
    return c3({ button: () => import("./calcite-button-JBDKJEJZ.js"), icon: () => import("./calcite-icon-6QWLC3AJ.js") });
  }
  get goToOverride() {
  ...
  render() {
    ...
    return n5("div", { class: this.classes(o27.base, e6.widget) }, n5("calcite-button", { class: e6.widgetButton, disabled: "disabled" === t30, kind: "neutral", label: o29.reset, onclick: this._reset, round: true, scale: "s", title: o29.reset }, n5("div", { "aria-hidden": "true", class: o27.iconContainer, title: o29.reset }, n5("calcite-icon", { icon: this.icon, styles: this._toRotationTransform(e28) }))));
  }
};
r([m()], c23.prototype, "goToOverride", null), r([m()], c23.prototype, "icon", null), r([m()], c23.prototype, "label", null), r([m(), e4("esri/widgets/Compass/t9n/Compass")], c23.prototype, "messages", void 0), r([m()], c23.prototype, "view", null), r([m({ type: p26 })], c23.prototype, "viewModel", void 0), c23 = r([a2("esri.widgets.Compass")], c23);
var d16 = c23;
...
r([m({ readOnly: true })], s29.prototype, "state", null), r([m()], s29.prototype, "_navigationMode", void 0), r([m()], s29.prototype, "view", void 0), s29 = r([a2("esri.widgets.NavigationToggle.NavigationToggleViewModel")], s29);
var r31 = s29;
...
var c24 = class extends O {
  ...
  loadDependencies() {
    return c3({ button: () => import("./calcite-button-JBDKJEJZ.js") });
  }
  get icon() {
    return "move";
  }
  ...
  render() {
    ...
    return n5("div", { class: this.classes(t28.base, e6.widget, { [t28.isLayoutHorizontal]: "horizontal" === this.layout }) }, n5("calcite-button", { afterCreate: (t31) => {
      this._panButton = t31;
    }, appearance: e28 ? "outline-fill" : "solid", class: e6.widgetButton, disabled: t30, iconStart: "move", kind: "neutral", label: o29, onclick: this._toggle, tabIndex: e28 ? void 0 : -1, title: o29 }), n5("calcite-button", { afterCreate: (t31) => {
      this._rotateButton = t31;
    }, appearance: e28 ? "solid" : "outline-fill", class: e6.widgetButton, disabled: t30, iconStart: "rotate", kind: "neutral", label: o29, onclick: this._toggle, tabIndex: e28 ? -1 : void 0, title: o29 }));
  }
};
r([m()], c24.prototype, "icon", null), r([m()], c24.prototype, "label", null), r([m({ value: "vertical" })], c24.prototype, "layout", null), r([m(), e4("esri/widgets/NavigationToggle/t9n/NavigationToggle")], c24.prototype, "messages", void 0), r([m()], c24.prototype, "view", null), r([m({ type: r31 })], c24.prototype, "viewModel", void 0), c24 = r([a2("esri.widgets.NavigationToggle")], c24);
var d17 = c24;
...
r([m({ readOnly: true })], r32.prototype, "canZoomIn", null), r([m({ readOnly: true })], r32.prototype, "canZoomOut", null), r([m()], r32.prototype, "view", void 0), r([m()], r32.prototype, "_scale", null), r32 = r([a2("esri.widgets.Zoom.ZoomConditions2D")], r32);
var c25 = r32;
...
r([m({ readOnly: true })], s30.prototype, "canZoomIn", null), r([m({ readOnly: true })], s30.prototype, "canZoomOut", null), r([m()], s30.prototype, "view", void 0), s30 = r([a2("esri.widgets.Zoom.ZoomConditions3D")], s30);
var c26 = s30;

// node_modules/@arcgis/core/widgets/Zoom/ZoomViewModel.js
var m21 = class extends g2 {
  constructor(o29) {
    super(o29);
  }
  destroy() {
...
r([m()], m21.prototype, "_zoomConditions", void 0), r([m()], m21.prototype, "canZoomIn", null), r([m()], m21.prototype, "canZoomOut", null), r([m({ readOnly: true })], m21.prototype, "state", null), r([m()], m21.prototype, "view", null), m21 = r([a2("esri.widgets.Zoom.ZoomViewModel")], m21);
var p27 = m21;
...
var c27 = class extends O {
  ...
  render() {
    const o29 = { [m22.horizontalLayout]: "horizontal" === this.layout }, { canZoomIn: t30, canZoomOut: e28 } = this.viewModel, { zoomIn: s31, zoomOut: i25 } = this.messages;
    return n5("div", { class: this.classes(m22.base, e6.widget, o29) }, n5("calcite-button", { class: e6.widgetButton, disabled: !t30, iconStart: "plus", kind: "neutral", label: s31, onclick: this.zoomIn, title: s31 }), n5("calcite-button", { class: e6.widgetButton, disabled: !e28, iconStart: "minus", kind: "neutral", label: i25, onclick: this.zoomOut, title: i25 }));
  }
};
r([m()], c27.prototype, "icon", null), r([m()], c27.prototype, "label", null), r([m({ value: "vertical" })], c27.prototype, "layout", null), r([m(), e4("esri/widgets/Zoom/t9n/Zoom")], c27.prototype, "messages", void 0), r([m()], c27.prototype, "view", null), r([m({ type: p27 })], c27.prototype, "viewModel", void 0), c27 = r([a2("esri.widgets.Zoom")], c27);
var p28 = c27;
...
var h20 = class extends L7 {
  ...
  _createComponent(t30) {
    ...
    return new m20({ id: t30, node: o29 });
  }
  _createWidget(t30) {
    const o29 = this.view;
    switch (t30) {
...
r([m()], h20.prototype, "components", void 0), h20 = r([a2("esri.views.ui.DefaultUI")], h20);
var u16 = h20;
...
r([m()], e27.prototype, "components", void 0), e27 = r([a2("esri.views.ui.2d.DefaultUI2D")], e27);
var c28 = e27;
...
var Q2;
async function X() {
  const [, { GraphicsView2D: e28, GraphicContainer: t30, LabelManager: i25, MapViewNavigation: r33, MagnifierView2D: s31, GridView2D: a25, Stage: n33 }] = await Promise.all([import("./webglDeps-YGDWH7RZ.js"), import("./mapViewDeps-GNIKCIHZ.js")]);
  H3 = e28, B3 = t30, Z2 = i25, J2 = r33, K3 = s31, Q2 = a25, F3 = n33;
}
var Y2 = class extends u11(o11(w4(C2(K2)))) {
  constructor(e28) {
    super(e28), this._magnifierView = null, this._gridView = null, this.stage = null, this._resolveWhenReady = [], this.rootLayerViews = new n8({ getCollections: () => {
      var _a, _b;
  ...
  get initialExtentRequired() {
    ...
    let a25 = this.zoom;
    return !(this.map && "initialViewProperties" in this.map && ((_a = this.map.initialViewProperties) == null ? void 0 : _a.viewpoint)) && (!s31 && ((t30 == null ? void 0 : t30.effectiveLODs) || (a25 = -1), (!i25 || 0 === e28 && -1 === a25) && (null == (r33 == null ? void 0 : r33.targetGeometry) || "extent" !== r33.targetGeometry.type && !r33.scale)));
  }
  get defaultsFromMapSettings() {
...
`);
  ...
  async popupHitTest(e28) {
    var _a;
    const t30 = this.toMap(e28), i25 = await this.hitTest(e28), r33 = this.allLayerViews.toArray().filter((i26) => i26.clips.every((i27) => m8(this, i27, e28, t30))).reverse(), s31 = new globalThis.Map(r33.map((e29) => [e29.layer.uid, e29])), a25 = [];
    let n33 = 0, o29 = 0;
    for (; n33 < i25.results.length || o29 < r33.length; ) {
      ...
      if ((!e29 || l20) && o29 < r33.length && r33.at(o29) !== l20) {
        ...
        "fetchPopupFeaturesAtLocation" in e30 && a25.push({ mapPoint: t30, layerView: e30 }), ++o29;
      } else e29 && (a25.push({ graphic: e29.graphic, layerView: l20 }), ++n33);
    }
    return { hits: a25, location: t30 };
  }
  requestUpdate() {
  ...
  _getDefaultViewpoint() {
    var _a;
    const { constraints: e28, initialExtent: i25, map: r33, padding: s31, size: a25 } = this;
    if (!e28) return null;
    const n33 = r33 && "initialViewProperties" in r33 ? r33.initialViewProperties : void 0, o29 = this.stateManager.getUserStartupOptions(this.size), l20 = n33 == null ? void 0 : n33.viewpoint, p30 = ((_a = l20 == null ? void 0 : l20.targetGeometry) == null ? void 0 : _a.extent) ?? i25, h21 = p30 == null ? void 0 : p30.center, g16 = (l20 == null ? void 0 : l20.rotation) ?? 0, d18 = (l20 == null ? void 0 : l20.scale) || p30 && H(p30, [a25[0] - s31.left - s31.right, a25[1] - s31.top - s31.bottom]), c29 = o29.center ?? h21, u17 = o29.rotation ?? g16, m24 = o29.scale ?? d18;
  ...
  _startup() {
    ...
    const a25 = this._resolveWhenReady;
    this._resolveWhenReady = [], a25.forEach((e29) => e29(this)), this.timeline.end("MapView Startup"), this.frameTask.start(), this._set("ready", true);
  }
  _teardown() {
...
Y2.type = "2d", r([m({ constructOnly: true })], Y2.prototype, "deactivatedWebGLExtensions", void 0), r([m({ constructOnly: true })], Y2.prototype, "debugWebGLExtensions", void 0), r([m({ readOnly: true })], Y2.prototype, "featuresTilingScheme", void 0), r([m({ readOnly: true })], Y2.prototype, "graphicsTileStore", null), r([m()], Y2.prototype, "graphicsView", void 0), r([m()], Y2.prototype, "constraintsInfo", null), r([m()], Y2.prototype, "initialExtentRequired", null), r([m()], Y2.prototype, "labelManager", void 0), r([m({ type: l10, nonNullable: true })], Y2.prototype, "navigation", void 0), r([m({ constructOnly: true })], Y2.prototype, "renderCanvas", void 0), r([m()], Y2.prototype, "renderingOptions", void 0), r([m({ constructOnly: true })], Y2.prototype, "supersampleScreenshotsEnabled", void 0), r([m({ readOnly: true })], Y2.prototype, "supportsGround", void 0), r([m()], Y2.prototype, "defaultsFromMapSettings", null), r([m({ readOnly: true })], Y2.prototype, "typeSpecificPreconditionsReady", null), r([m({ type: m9 })], Y2.prototype, "background", null), r([m()], Y2.prototype, "center", null), r([m({ type: V })], Y2.prototype, "floors", void 0), r([m()], Y2.prototype, "grid", void 0), r([m({ type: u6 })], Y2.prototype, "highlightOptions", null), r([m()], Y2.prototype, "map", void 0), r([m()], Y2.prototype, "padding", null), r([m({ readOnly: true })], Y2.prototype, "rendering", null), r([m({ readOnly: true })], Y2.prototype, "resolution", null), r([m()], Y2.prototype, "scale", null), r([m({ constructOnly: true })], Y2.prototype, "spatialReferenceLocked", void 0), r([m({ readOnly: true })], Y2.prototype, "tileInfo", null), r([m({ type: e12, readOnly: true })], Y2.prototype, "timeline", void 0), r([m({ readOnly: true })], Y2.prototype, "type", void 0), r([m({ readOnly: true })], Y2.prototype, "updating", null), r([m({ readOnly: true })], Y2.prototype, "view2dType", void 0), r([m({ readOnly: true })], Y2.prototype, "visibleArea", null), r([m()], Y2.prototype, "zoom", null), r([m({ readOnly: true })], Y2.prototype, "navigating", null), r([m(), s6((e28) => e28 instanceof u16 ? e28 : h(c28, e28))], Y2.prototype, "ui", void 0), Y2 = r([a2("esri.views.View2D")], Y2);
var ee = Y2;
...
r([m({ readOnly: true })], t29.prototype, "view2dType", void 0), t29 = r([a2("esri.views.MapView")], t29);
var p29 = t29;
export {
  p29 as default
};
