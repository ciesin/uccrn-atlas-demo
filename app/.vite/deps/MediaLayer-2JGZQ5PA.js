...
c5 = r([a("esri.layers.support.GeoreferenceBase")], c5);
var a3 = c5;
...
r([m()], q.prototype, "sourcePoint", void 0), r([m({ type: j })], q.prototype, "mapPoint", void 0), q = r([a("esri.layers.support.ControlPointsGeoreference.ControlPoint")], q);
var O2 = class extends S.JSONSupportMixin(a3) {
  ...
  readControlPoints(t4, o5) {
    const e4 = g.fromJSON(o5.spatialReference), r4 = t2(...o5.coefficients, 1);
    return t4.map((t5) => (o3(C, t5.x, t5.y), p6(C, C, r4), { sourcePoint: t5, mapPoint: new j({ x: C[0], y: C[1], spatialReference: e4 }) }));
  }
  ...
  set coords(t4) {
    ...
    T(p8) && T(u6) && T(m5) && T(f2) && (B(S3, p8, u6, m5, f2), this.controlPoints = this.controlPoints.map(({ sourcePoint: t5 }) => (o3(C, t5.x, t5.y), p6(C, C, S3), { sourcePoint: t5, mapPoint: new j({ x: C[0], y: C[1], spatialReference: o5 }) })));
  }
  ...
  toSource(t4) {
    ...
    const o5 = this.controlPoints[0].mapPoint.spatialReference;
    return t4 = t4.normalize(), null == (t4 = X(t4, o5).geometry) ? null : (o3(C, t4.x, t4.y), p6(C, C, this.inverseTransform), c3(C[0], C[1]));
  }
...
function A2(t4, o5, e4) {
  o3(t4, e4.sourcePoint.x, e4.sourcePoint.y), o3(o5, e4.mapPoint.x, e4.mapPoint.y);
}
...
function K(t4, o5, e4, r4) {
  const n8 = t3(0, e4), s6 = t3(0, 0), l = t3(o5, 0), c6 = t3(o5, e4);
...
var p7 = class extends a3 {
  ...
  toSourceNormalized(t4) {
    ...
    let f2 = u6.x, h3 = u6.y;
    return n8 && ([f2, h3] = x2(l.x, l.y, -n8)(f2, h3)), c3(c2(f2, s6, a4, 0, 1), c2(h3, c6, i2, 0, 1));
  }
};
...
r([m({ clonable: false })], p7.prototype, "coords", null), r([m({ type: w2 })], p7.prototype, "extent", void 0), r([m({ type: Number })], p7.prototype, "rotation", void 0), p7 = r([a("esri.layers.support.ExtentAndRotationGeoreference")], p7);
var u3 = p7;
...
var u5 = class extends n2.NumericIdentifiableMixin(S2(m3)) {
  constructor(e4) {
...
r([m(h2)], u5.prototype, "georeference", void 0), r([o("georeference")], u5.prototype, "readGeoreference", null), r([r3("georeference")], u5.prototype, "writeGeoreference", null), r([m({ json: { read: false, write: false } })], u5.prototype, "opacity", void 0), u5 = r([a("esri.layers.support.MediaElementBase")], u5);
var d4 = u5;
...
E2 = n7, r([m()], U3.prototype, "animationOptions", void 0), r([m({ readOnly: true })], U3.prototype, "content", void 0), r([m({ readOnly: true })], U3.prototype, "contentWidth", null), r([m({ readOnly: true })], U3.prototype, "contentHeight", null), r([m(w3)], U3.prototype, "image", void 0), r([o("image", ["url"])], U3.prototype, "readImage", null), r([r3("image")], U3.prototype, "writeImage", null), r([m(g2)], U3.prototype, "type", void 0), U3 = r([a("esri.layers.support.ImageElement")], U3);
var H3 = U3;
function L2(t4) {
...
function R(t4, e4) {
  const o5 = n4(), r4 = `${V("media", o5)}.${p5({ type: "blob", blob: t4 })}`;
...
var b2 = class extends d4 {
  ...
  load() {
    const e4 = this.video;
    return "string" == typeof e4 ? this.addResolvingPromise(Promise.all([this._preProcessVideoUrl(e4), import("./VideoController-THRIQXWQ.js")]).then(async ([e5, { default: t4 }]) => {
  ...
  set currentTime(e4) {
    ...
    const t4 = r2(e4, 0, this.controller.duration);
...
U4 = e3, r([m()], b2.prototype, "autoplay", void 0), r([m({ readOnly: true })], b2.prototype, "content", void 0), r([m({ readOnly: true })], b2.prototype, "contentWidth", null), r([m({ readOnly: true })], b2.prototype, "contentHeight", null), r([m()], b2.prototype, "controller", void 0), r([m({ type: Number })], b2.prototype, "currentTime", null), r([m({ type: Number })], b2.prototype, "duration", null), r([m(w3)], b2.prototype, "video", null), r([r3("video")], b2.prototype, "writeVideo", null), r([m(g2)], b2.prototype, "type", void 0), b2 = r([a("esri.layers.support.VideoElement")], b2);
var P5 = b2;
function V4(e4) {
...
var I3 = class extends m3.LoadableMixin(p2.EsriPromiseMixin(i.EventedAccessor)) {
  ...
  set elements(e4) {
    this._set("elements", n5(e4, this._get("elements"), M4));
  }
  get fullExtent() {
...
var b3 = class extends p3(t(b(j3(S2(f))))) {
  constructor(e4) {
    super(e4), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = k(async (e5, r4, o5) => {
      const { save: t4, saveAs: s6 } = await import("./mediaLayerUtils-G5G76BM3.js");
      switch (e5) {
        case A.SAVE:
          return t4(this, r4);
        case A.SAVE_AS:
...
//# sourceMappingURL=MediaLayer-2JGZQ5PA.js.map
