...
var I = class extends i2.EventedMixin(g) {
  ...
  async _createSelfSnappingEngine(e6) {
    const { SelfSnappingEngine: t } = await import("./SelfSnappingEngine-YDPTLF5C.js");
    return s2(e6), { type: "self", engine: new t({ view: this.view, options: this.options }) };
  }
  async _createGridSnappingEngine(e6) {
    const { view: t } = this;
    if ("2d" !== t.type) return;
    const { GridSnappingEngine: n7 } = await import("./GridSnappingEngine-Z3W4K6A5.js");
    return s2(e6), { type: "grid", engine: new n7({ view: t, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e6) {
    const { FeatureSnappingEngine: t } = await import("./FeatureSnappingEngine-AOZCK6H7.js");
    s2(e6);
...
var ie = class extends i2.EventedAccessor {
  constructor(e6) {
    var _a;
    super(e6), this._defaultSnappingManager = null, this._updatingHandles = new h4(), this._internalGraphicsLayer = new h3({ listMode: "hide", internal: true, title: "SVM Internal" }), this._operationHandle = null, this._viewHandlesKey = "viewHandles", this.activeFillSymbol = null, this.activeLineSymbol = null, this.activeVertexSymbol = null, this.allowDeleteKey = true, this.layer = null, this.pointSymbol = new y({ style: "circle", size: 6, color: [255, 255, 255], outline: { color: [50, 50, 50], width: 1 } }), this.polygonSymbol = new S({ color: [150, 150, 150, 0.2], outline: { color: [50, 50, 50], width: 2 } }), this.polylineSymbol = new d4({ color: [130, 130, 130, 1], width: 2 }), this.meshSymbol = new c2({ symbolLayers: new V([new h2()]) }), this.updateGraphics = new V(), this.updateOnGraphicClick = true, this.creationMode = "single", this.vertexSymbol = new y({ style: "circle", size: 6, color: [255, 255, 255], outline: { color: [50, 50, 50], width: 1 } }), this.sketchOptions = new l3(), this._moduleLoaderAbortController = null, this._viewReadyAbortController = null, this._sketchContinuationFlag = false, this._originalPopupEnabled = null, this.defaultCreateOptions = te, this.defaultUpdateOptions = oe, this.snappingOptions = ((_a = e6 == null ? void 0 : e6.snappingManager) == null ? void 0 : _a.options) ?? (e6 == null ? void 0 : e6.snappingOptions) ?? new c4();
  }
  initialize() {
    this.addHandles([v(() => {
      var _a, _b;
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e6 && (this.snappingManager || (this._defaultSnappingManager = new I({ view: e6, options: this.snappingOptions })), "2d" === e6.type ? import("./editingTools-NZA7RPWT.js") : "3d" === e6.type && (import("./editingTools-WD3TYVO3.js"), import("./GraphicsLayerView3D-PISHOFRZ.js")));
    }, A), d3(() => {
      var _a;
  ...
  async _makeDrawGraphicTool2D(e6) {
    const t = await this._requireModule(import("./editingTools-NZA7RPWT.js"));
  ...
  async _makeDrawGraphicTool3D(e6) {
    const t = await this._requireModule(import("./editingTools-WD3TYVO3.js"));
  ...
  async _setupMove3DOperation(e6, t, o3, i5, s6 = false) {
    const r11 = await this._requireModule(import("./editingTools-WD3TYVO3.js"));
  ...
  async _setupPointTransform3DOperation(e6, t, o3) {
    const i5 = "transform", { enableRotation: s6, enableScaling: r11, enableZ: n7 } = t, p9 = await this._requireModule(import("./editingTools-WD3TYVO3.js"));
    if (ue(p9)) return p9;
  ...
  async _setupPolyTransform3DOperation(e6, t, o3, i5 = false) {
    var _a, _b;
    const s6 = "transform", { enableRotation: r11, enableScaling: n7, enableZ: p9, preserveAspectRatio: l4 } = t, h6 = await this._requireModule(import("./editingTools-WD3TYVO3.js"));
    if (ue(h6)) return h6;
  ...
  async _setupReshape3DOperation(e6, t, o3, i5 = false) {
    const s6 = "reshape", r11 = await this._requireModule(import("./editingTools-WD3TYVO3.js"));
    if (ue(r11)) return r11;
  ...
  async _getGraphicMover(e6, t, o3) {
    const { enableMoveAllGraphics: i5, highlightOptions: a3 } = t, s6 = await this._requireModule(import("./GraphicMover-MTSDHXDY.js"));
  ...
  async _getBox(e6, t, o3) {
    var _a, _b;
    const { enableRotation: i5, enableScaling: a3, highlightOptions: s6, preserveAspectRatio: r11 } = t, n7 = await this._requireModule(import("./Box-JZ5U5NWX.js"));
    if (ue(n7)) return n7;
  ...
  async _getReshape(e6, t, o3) {
    var _a, _b, _c;
    const i5 = "split" === ((_a = t.reshapeOptions) == null ? void 0 : _a.edgeOperation), a3 = "move" === ((_b = t.reshapeOptions) == null ? void 0 : _b.shapeOperation), s6 = !!((_c = t.highlightOptions) == null ? void 0 : _c.enabled), r11 = await this._requireModule(import("./Reshape-QOFWBEIS.js"));
...
var _2 = class extends g {
  constructor(e6) {
    super(e6), this._createMode = null, this._graphicsLayer = new h3({ internal: true, listMode: "hide", title: "Banana" }), this._updatingHandles = new h4(), this.enabled = true, this._handleSketchViewModelEvents = async (e7) => {
      var _a, _b;
      switch (e7.type) {
        case "update":
          switch (e7.state) {
...
//# sourceMappingURL=RouteLayerInteraction-YWBQRTIW.js.map
